...
static DEVICE_ATTR(firmware_activate_result, 0400, firmware_activate_result_show,
		NULL);
...
static DEVICE_ATTR(firmware_activate, 0600, firmware_activate_show,
		firmware_activate_store);
