		...
		const void __iomem *end)
{
	...
	case NFIT_TABLE_MEM: {
		...
		pr_debug("%s: mem handle: %#x spa: %d dcr: %d\n", __func__,
	...
	case NFIT_TABLE_DCR: {
		...
		pr_debug("%s: dcr index: %d num_bdw: %d\n", __func__,
				readw(&nfit_dcr->dcr_index),
	...
	case NFIT_TABLE_BDW: {
		...
		pr_debug("%s: bdw dcr: %d num_bdw: %d\n", __func__,
