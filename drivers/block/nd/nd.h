...
typedef void (*ndio_notify_remove_fn)(struct nd_io *ndio);
 ...
 * @devname: whole disk block device for the namespace
 ...
 * @notify_remove: ndio is going away, release resource
 */
struct nd_io {
