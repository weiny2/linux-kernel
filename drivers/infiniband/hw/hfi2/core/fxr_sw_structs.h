...
union opcode_low {
        union {
                ...
                uint64_t        response_op                 : 5;        /* [4:0] See Table 10-21 */
                uint64_t        e2e_ctrl_op                 : 5;        /* [4:0] See Table 10-22 */
...
union md_options {
        struct {
                ...
                uint64_t        ct_ack                      : 1;        /* [4:4] Count the arrival of Portals acknowledgementsacknowledgments on this MD */
                ...
                uint64_t        iovec                       : 1;        /* [6:6] Reserved: used by PTL_IOVEC, which must also work for MDs. PTL_IOVEC mayis only allowedbe set for DMA operations. It is irrelevant for Buffered operations. and Setting PTL_IOVEC may notcause erroneous behavior if it isbe set for PIO operations. This option also applies for GENERAL_DMA command variants (including MGMT_DMA). This option does not apply to OFED/Verbs or KDETH command variants at this time. */
                uint64_t        nonptl_sc4                  : 1;        /* [7:7] SC[4] for 9B Generic DMA commands to be passed in the sideband within FXR and be added to the start byte of a 9B packet. This bit only applies to Generic DMA and Management DMA. */
                } __attribute__ ((__packed__));
        uint64_t val;
};
...
union tx_cq_p {
        struct {
                ...
                uint64_t        sub_op                      : 5;        /* [47:43] 0: PSM Expected DMA1: Verbs TID RDMA Read2: Verbs TID RDMA Write */
...
union base_iovec {
        struct {
                ...
                struct {
                        ...
                        uint64_t        sp                          : 1;        /* [126:126] Start of packet: a new packet is started with this entry. Only used for NonPortals (Generic DMA) operations. */
...
union ptentry_fp0 {
        struct {
                struct {
                        ...
                        uint64_t        enable                      : 1;        /* [55:55] This Portal Table Entry is enabled (fast path entries are inherently enabled) */
...
union ptl_ct_event {
        struct {
                ...
                struct {
                        ...
                        uint64_t        reserved_239_226            : 14;        /* [239:226] Reserved */
...
union eqd {
        struct {
                ...
                struct {
                        ...
                        uint64_t        reserved_126_126            : 1;        /* [126:126]  */
...
union rhf {
        struct {
                uint64_t        pktlen                      : 12;        /* [11:0] Packet length */
                ...
                uint64_t        reserved_23_23              : 1;        /* [23:23]  */
                ...
                uint64_t        pt                          : 1;        /* [41:41] Port the packet was received on */
                uint64_t        rterr                       : 3;        /* [44:42] RcvTypeErr, as defined in Table 19-143 */
...
union tx_cq_b1_omb {
        struct {
                ...
                uint64_t        retransmit_disable          : 1;        /* [48:48] Retransmit disable */
...
union omb_h1 {
        struct {
                ...
                uint64_t        reserved_33_32              : 2;        /* [33:32]  */
...
union omb_h2 {
        struct {
                ...
                uint64_t        reserved_27_27              : 1;        /* [27:27]  */
                uint64_t        send_status                 : 6;        /* [33:28] Status of this operation, including capturing error conditions associated with the local operation. Used as part of the event posting (accumulates errors for later event posting). Associated with the SEND events. */
                uint64_t        data_ptr                    : 16;        /* [49:34] Pointer to the second OMB entry that is part of this operation. */
                uint64_t        status                      : 6;        /* [55:50] Status of this entry */
                uint64_t        v                           : 1;        /* [56:56] Indicates if this entry is valid */
                uint64_t        t                           : 1;        /* [57:57] Type of the entry */
                uint64_t        c                           : 1;        /* [58:58] Cancelled: indicates if the message associated with this entry has been canceled. */
                uint64_t        reserved_60_59              : 2;        /* [60:59] Reserved */
...
union omb_h4 {
        struct {
                uint64_t        reserved_33_0               : 34;        /* [33:0] Reserved */
                uint64_t        data_ptr                    : 16;        /* [49:34] Pointer to the second OMB entry that is part of this operation. */
                uint64_t        status                      : 6;        /* [55:50] Status of this operation, including capturing error conditions received from the target. Used as part of the event posting (accumulates errors for later event posting). Associated with the ACK or REPLY events */
                uint64_t        v                           : 1;        /* [56:56] Indicates if this entry is valid */
                uint64_t        t                           : 1;        /* [57:57] Type of the entry */
...
union opb {
        struct {
                ...
                struct {
                        uint64_t        start                       : 51;        /* [114:64] Base address for this packet. Note that tis is the address for delivering the reply (for a Get or a two operand atomic) The address must be sign extended to maintain canonical form when used for 57 bit internal fields. */
                        uint64_t        pkey_idx                    : 6;        /* [120:115] Local index of the PKEY used for this entry. Used to implement the required tuple check. */
                ...
                struct {
                        ...
                        uint64_t        pt                          : 1;        /* [179:179] Outgoing Port that was used. DEPRECATED */
...
union otr_frag_credit {
        struct {
                uint64_t        credits                     : 3;        /* [2:0] Post frag credit count */
                uint64_t        unused_63_3                 : 61;        /* [63:3]  */
        };
        uint64_t val;
};
...
union otr_buff_credit {
        struct {
                uint64_t        credits                     : 3;        /* [2:0] Output credit count */
                uint64_t        unused_63_3                 : 61;        /* [63:3]  */
        };
        uint64_t val;
};
...
/*
* Structure from Table titled: Receive HI Arbitrator(RX HIARB)#%%#Cache Address Structures#%%#PTE Cache Address (Struct - pte_cache_addr_t) - 22 bits
*                  from File : 380_Block_Interfaces
*/
union pte_cache_addr {
        struct {
                uint64_t        tpid                           : 12;        /* [11:0] target process ID/ */
                uint64_t        ptindex                        : 8;        /* [19:12] Portals Table Index */
                uint64_t        ni                             : 2;        /* [21:20] network interface */
                } __attribute__ ((__packed__));
        uint64_t val;
};

/*
* Structure from Table titled: PSC Cache Address (Struct - psc_cache_addr_t) - 29 bits
*                  from File : 380_Block_Interfaces
*/
union psc_cache_addr {
        struct {
                uint64_t        handle                         : 16;        /* [15:0] list pointer */
                uint64_t        pid                            : 12;        /* [27:16] process id */
                uint64_t        unexpected                     : 1;        /* [28:28] expected/unexpected */
                } __attribute__ ((__packed__));
        uint64_t val;
};

/*
* Structure from Table titled: Packet Sequence Number Cache Address (Struct - psn_cache_addr_t) - 29 bits
*                  from File : 380_Block_Interfaces
*/
union psn_cache_addr {
        struct {
                uint64_t        lid                            : 24;        /* [23:0] local id (dlid for otr, slid for e2e) */
                uint64_t        this_end_lid                   : 2;        /* [25:24] slid[1:0] for otr, dlid[1:0] for e2e */
                uint64_t        tc                             : 2;        /* [27:26] traffic class */
                uint64_t        pkey_idx                       : 6;        /* [33:28] pkey index */
                } __attribute__ ((__packed__));
        uint64_t val;
};

/*
* Structure from Table titled: Triggered Op Cache Address (Struct - trig_op_cache_addr_t) - 28 bits
*                  from File : 380_Block_Interfaces
*/
union trig_op_cache_addr {
        struct {
                uint64_t        trig_handle                    : 16;        /* [15:0] trigger handle */
                uint64_t        pid                            : 12;        /* [27:16] process ID */
                } __attribute__ ((__packed__));
        uint64_t val;
};
...
/*
* Structure from Table titled: Event Queue Cache Address (Struct - eq_cache_addr_t) - 25 bits
*                  from File : 380_Block_Interfaces
*/
union eq_cache_addr {
        struct {
                uint64_t        eqh                            : 11;        /* [10:0] EQ Handle */
                uint64_t        ni                             : 2;        /* [12:11] network interface */
                uint64_t        pid                            : 12;        /* [24:13] process ID */
                } __attribute__ ((__packed__));
        uint64_t val;
};
