...
union rx_d6 {
        struct {
                uint64_t        logical_base_35_0           : 36;        /* [35:0]  */
                uint64_t        ct_handle                   : 11;        /* [46:36] Counting event (CT) handle to use for posting the event */
                uint64_t        ncc                         : 1;        /* [47:47] 1: do not generate a command complete event0: allow command complete event (where applicable) */
                uint64_t        command                     : 12;        /* [59:48] Receive command */
                uint64_t        reserved_61_60              : 2;        /* [61:60] Reserved */
...
union rx_e7 {
        struct {
                ...
                uint64_t        cmd_pid                     : 12;        /* [23:12] PID to be used for this operation (context to give the LIST_HANDLE meaning) */
                uint64_t        list_handle                 : 16;        /* [39:24] List entry to be used in an operation */
                uint64_t        logical_base_56_36          : 21;        /* [60:40] Pointer to the root of the receive queue that this is to be appended to. */
...
union rx_j {
        struct {
                ...
                uint64_t        f                           : 1;        /* [60:60] In a Portals entry: This item needs to be freed when it is no longer in use.In a Native Verbs entry: Item is free and should not match. */
...
union ptentry_verbs {
        struct {
                struct {
                        ...
                        uint64_t        enable                      : 1;        /* [57:57] This Portal Table Entry is enabled (fast path entries are inherently enabled) */
                        uint64_t        fc                          : 1;        /* [58:58] Indicates that his Portal Table Entry is currently in flow control */
                ...
                struct {
                        uint64_t        user_id                     : 32;        /* [159:128] USER_ID that must match the incoming packet exactly */
                        uint64_t        qkey                        : 32;        /* [191:160] QKey for UD Queue Pairs (used for authentication for UD only. */
                };
                struct {
                        uint64_t        reserved_255_192            : 64;        /* [255:192] Reserved */
                };
...
union eqd {
        struct {
                struct {
                        ...
                        uint64_t        i                           : 1;        /* [62:62] Indicates this EQ should generate an interrupt when an event is delivered. If I is set, an interrupt is generated for every packet. */
...
union rhf {
        struct {
                ...
                uint64_t        rterr                       : 3;        /* [44:42] RcvTypeErr, as defined in Table 19-153 */
...
union qp_cache_addr {
        struct {
                uint64_t        qp_num                           : 24;        /* [23:0] QP Number */
		uint64_t	qp_tag			       : 1;
                } __attribute__ ((__packed__));
        uint64_t val;
};
