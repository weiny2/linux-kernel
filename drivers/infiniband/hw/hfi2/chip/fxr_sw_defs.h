...
*  /p/hdk/rtl/proj_tools/sl2_tools/sl2_tools-srvr10nm-18ww32a/scripts/i_csrs/i_csrs.pl -C -RVREGS -ST fxr_sw -o /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/fxr /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml_33c/020_TOC.xml /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml_33c/110_Link_Fabric_Sublayer.xml /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml_33c/131_Portals_Transport_Layer.xml /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml_33c/200_Software_Interfaces.xml /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml_33c/140_OutstandingRequest_and_Reliability.xml /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml_33c/163_Programmable_Engine.xml /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml_33c/260_PerfCounters.xml
*------------------------------------------------------------------------------
*/
...
enum perf_counter {
                     ...
                     txci_hcq_nonfull_slot_write = 8,           /* A slot in the TX Command queue was partially written (less than 64B written is a single transaction, regardless of whether it fills a slot or not). */
                        ...
                        txci_stall_otr_credits_z = 12,          
                         ...
                         otr_stall_omb_entries_x = 15,          /* The OTR is stalled waiting for OMB entries. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 33.8.9.1, 'Stall OMB Entries X Performance CSR'Cross Reference to Y: Section 33.8.9.2, 'Stall OMB Entries Y Performance CSR' */
                         otr_stall_omb_entries_y = 16,          
                       otr_stall_rxdma_credits_x = 17,          /* The OTR is stalled waiting for credits to the RXDMA block. The TC for this counter is selected in the OTR block.Cross Reference to X: Section 33.8.9.3, 'Stall RXDMA Credits X Performance CSR'Cross Reference to Y: Section 33.8.9.4, 'Stall RXDMA Credits Y Performance CSR' */
                       otr_stall_rxdma_credits_y = 18,          
                                   otr_stall_cts = 19,          /* The CTS queue within OTR has stalled for lack of credits. */
                      otr_m_to_p_stall_credits_x = 20,          /* The OMB to OPB queues are stalled waiting on credits. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 33.8.9.5, 'Stall Message Partition to Packet Partition Credits X Performance CSR'Cross Reference to Y: Section 33.8.9.6, 'Stall Message Partition to Packet Partition Credits Y Performance CSR' */
                      otr_m_to_p_stall_credits_y = 21,          
                     otr_prefrag_stall_credits_x = 22,          /* The pre-fragmentation queue is stalled waiting for access to the fragmentation PE. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 33.8.9.7, 'Stall Pre-Fragmentation Credits X Performance CSR'Cross Reference to Y: Section 33.8.9.8, 'Stall Pre-Fragmentation Credits Y Performance CSR' */
                     otr_prefrag_stall_credits_y = 23,          
                                   otr_stall_bpe = 24,          /* Stall due to BPE receiving too many CTS from MSG */
                           ...
                           otr_messages_closed_x = 26,          /* Total number of messages completed by OTR. This reflects the number of OMB entries closed. The TC/MC is selected in the OTR block.Cross Reference to X: */
                                 otr_stall_rx_rd = 27,          /* OTR stalled due to OTR_MSG RX path not being able to access read path of the OMB */
                                 otr_stall_rx_wr = 28,          /* OTR stalled due to OTR_MSG RX path not being able to access write path of the OMB */
                        otr_stall_final_ects_ack = 29,          /* OTR stalled due to Final ECTS ACK requiring REvent command to be generated. */
                           otr_stall_omb_reorder = 30,          /* OTR stalled due to OMB reads needing to be reordered, usually for a Reply or final ACK for Rendezvous interaction requiring RTS entry to be read. */
                               otr_stall_for_rts = 31,          /* OTR stalled for a rendezvous interaction which needs to read both OMB entries. This should regularly go high for several cycles after each REPLY or final ACK for a rendezvous. */
                             otr_stall_max_2_req = 32,          /* OTR stalled due to too many RX packets in the event generation pipeline. This should happen for back to back RX packets to Fetching Atomic commands. */
                            otr_stall_same_msgid = 33,          /* OTR stalled due to multiple RX packets to the same msgid back to back. This should happen rarely, and only for mutli-packet commands. */
                               otr_stall_b2b_pkt = 34,          /* OTR stalled due for one cycle on packets in the RX pipeline that are back to back. This should happen regularly when the RX FIFOs are non-empty. */
                         otr_stall_refcount_fifo = 35,          /* OTR stalled because the refcount decrement FIFO to RXHP is full. */
                            otr_stall_rxdma_fifo = 36,          /* OTR stalled because the FIFO to RXDMA is full. */
                             otr_stall_rxet_fifo = 37,          /* OTR stalled because the FIFO to RXET is full. */
                      otr_stall_ordering_portals = 38,          /* OTR stalled for ordering requirement on Portals packets */
                otr_stalling_ordering_nonportals = 39,          /* OTR stalled for ordering requirement on non-Portals packets. */
                              otr_msg_reserved_a = 40,          /* Reserved */
                              otr_msg_reserved_b = 41,          /* Reserved */
                              otr_msg_reserved_c = 42,          /* Reserved */
                              otr_msg_reserved_d = 43,          /* Reserved */
                              otr_msg_reserved_e = 44,          /* Reserved */
                              otr_msg_reserved_f = 45,          /* Reserved */
                              otr_msg_reserved_g = 46,          /* Reserved */
                              otr_msg_reserved_h = 47,          /* Reserved */
                            otr_rsp_special_acks = 48,          /* This counter counts the special ACKs received by the OTR on any TC */
                         otr_stall_opb_entries_x = 49,          /* The OTR is stalled waiting for OPB entries. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 29.7.3.152, 'Stall OPB Entries X Performance CSR'Cross Reference to Y: Section 33.7.9.2, 'Stall OMB Entries Y Performance CSR' */
                         otr_stall_opb_entries_y = 50,          
                       otr_stall_txdma_credits_x = 51,          /* The OTR is stalled waiting for credits to the TXDMA block. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 33.7.9.3, 'Stall TXDMA Credits X Performance CSR'Cross Reference to Y: Section 33.7.9.4, 'Stall TXDMA Credits Y Performance CSR' */
                       otr_stall_txdma_credits_y = 52,          
                       otr_opb_stall_mem_credits = 53,          /* The OTR/OPB engine has stalled due to not having credits available for requests to memory. */
                    otr_opb_stall_mem_rsp_events = 54,          /* The OTR/OPB engine is waiting on memory responses and has no other work to do. */
                    otr_opb_stall_mem_rsp_cycles = 55,          /* The OTR/OPB engine is waiting on memory responses and has no other work to do. */
                        otr_opb_stall_at_credits = 56,          /* The OTR/OPB engine has stalled due to a lack of available AT credits */
                     otr_opb_stall_at_rsp_events = 57,          /* The OTR/OPB engine is waiting on AT responses and had no other work to do. */
                     otr_opb_stall_at_rsp_cycles = 58,          /* The OTR/OPB engine is waiting on AT responses and had no other work to do. */
                      otr_p_to_m_stall_credits_x = 59,          /* The OPB to OMB queues are stalled waiting on credits. The TC for this counter is selected in the OTR block.Cross Reference to X: Section 33.7.9.5, 'Stall Packet Partition to Message Partition Credits X Performance CSR'Cross Reference to Y: Section 33.7.9.6, 'Stall Packet Partition to Message Partition Credits Y Performance CSR' */
                      otr_p_to_m_stall_credits_y = 60,          
                  otr_pktid_list_conflict_replay = 61,          /* A PKTID update conflict caused a Tx command to be replayed through the pipeline. */
                          otr_psn_distance_stall = 62,          /* The OTR is stalled to enforce PSN distance */
                                otr_fastpath_req = 63,          /* Number of requests generated into the fastpath in OTR. */
                                  otr_fragpe_req = 64,          /* Number of requests generated into the fragmentation path in OTR. */
                                  otr_txdma_cmds = 65,          /* The number of commands issued from OTR to TXDMA. This may be more than one command per packet. */
                            otr_packets_opened_x = 66,          /* Total number of packets generated by OTR. Total packets is the sum of the fastpath packets and the fragmentation PE packets. This reflects the number of OPB entries allocated. The TC/MC is selected in the OTR block.Cross Reference to X: */
                            otr_packets_closed_x = 67,          /* Total number of packets completed by OTR. Total packets is the sum of the fastpath packets and the fragmentation PE packets. This represents the number of OPB entries closed. The TC/MC is selected in the OTR block.Cross Reference to X: */
                             otr_packets_retrans = 68,          /* Total number of retransmitted packets. Included NACK-based retransmit, timeout-based retransmit, and retransmits internally scheduled due to max sequence distance violations. */
                                 otr_latency_0_a = 69,          /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was A or less.Note: granularity of the time is likely to be at least 1 millisecond.Cross Reference to A: Section 33.7.9.7, 'Latency Performance CSR' */
                                 otr_latency_a_b = 70,          /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than A and less than or equal to B.Cross Reference to B: Section 33.7.9.7, 'Latency Performance CSR' */
                                 otr_latency_b_c = 71,          /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than B and less than or equal to C.Cross Reference to C: Section 33.7.9.7, 'Latency Performance CSR' */
                                 otr_latency_c_d = 72,          /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than C and less than or equal to D.Cross Reference to D: Section 33.7.9.7, 'Latency Performance CSR' */
                               otr_latency_d_max = 73,          /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than D. */
                        otr_retrans_limit_rchd_x = 74,          /* Retransmit Limit reached. This counter increments only once after the retransmission limit is reached for that TC. The TC for this counter is selected in the OTR block.Cross Reference to X: xref */
                          otr_cleanup_cmd_detect = 75,          /* Increments the counter when an cleanup command is detected in the OTR */
                           otr_local_seq_stall_x = 76,          /* Indicates that a local sequence has stalled due to the maximum distance between the oldest outstanding local packet sequence number and the next available local packet sequence number exceeding half of the sequence number space. This counter increments once when this condition is detected. The MC/TC for this counter is selected in the OTR block.Cross Reference to X: xref */
                                      txpsn_hits = 77,          /* Number of hits in the TXPSN cache */
                                      txpsn_miss = 78,          /* Number of misses in the TXPSN cache */
                                txpsn_fill_stall = 79,          /* Number of stall cycles due to the fill FIFO in the TXPSN cache being full */
                               txpsn_evict_stall = 80,          /* Number of stall cycles due to the evict FIFO in the TXPSN cache being full */
                                    txpsn_evicts = 81,          /* Number of TXPSN cache evictions (capacity only, not CSR-based evictions) */
                              txpsn_membus_stall = 82,          /* Number of stall cycles due to the memory access port in the TXPSN cache being busy */
                              otr_pkt_reserved_a = 83,          /* Reserved */
                              otr_pkt_reserved_b = 84,          /* Reserved */
                              otr_pkt_reserved_c = 85,          /* Reserved */
                              otr_pkt_reserved_d = 86,          /* Reserved */
                                  txdma_tx_reads = 87,          /* Total read accesses done over the TX interface to memory. */
                         txdma_mc1_packet_match0 = 88,          /* A packet ,match triggered on MC1 */
                         txdma_mc1_packet_match1 = 89,          /* A packet match triggered on MC1 */
                           txdma_tx_flits_tcmc_w = 90,          /* Total flits transmitted by TXDMA on a TC/MC as selected in the TXDMA block.Cross Reference to W: xrefCross Reference to X: xrefCross Reference to Y: xrefCross Reference to Z: xref */
                           txdma_tx_flits_tcmc_x = 91,          
                           txdma_tx_flits_tcmc_y = 92,          
                           txdma_tx_flits_tcmc_z = 93,          
                         txdma_stall_mem_credits = 94,          /* The TX DMA engine has stalled due to not having outstanding credits to memory available for use. */
                      txdma_stall_mem_rsp_events = 95,          /* The TX DMA engine is waiting on memory responses and has no other work to do. */
                      txdma_stall_mem_rsp_cycles = 96,          /* The TX DMA engine is waiting on memory responses and has no other work to do. */
                          txdma_stall_at_credits = 97,          /* The TX DMA engine has stalled due to a lack of available AT credits */
                       txdma_stall_at_rsp_events = 98,          /* The TX DMA engine is waiting on AT responses and had no other work to do. */
                       txdma_stall_at_rsp_cycles = 99,          /* The TX DMA engine is waiting on AT responses and had no other work to do. */
                      txdma_stall_empty_events_x = 100,         /* Transmit DMA is stalled because there is nothing in the request pipeline. Event is counted once per event (i.e. input was not empty and then was empty). The TC/MC for this counter is selected in the TXDMA block.Cross Reference to X: xrefCross Reference to Y: xref */
                      txdma_stall_empty_events_y = 101,         
                           txdma_stall_credits_x = 102,         /* Transmit DMA is stalled because it has no credits for the Link Mux. The TC/MC for this counter is selected in the TXDMA block.Cross Reference to X: xrefCross Reference to Y: xref */
                           txdma_stall_credits_y = 103,         
                         txdma_mc0_packet_match0 = 104,         /* A generic packet header match triggered (matching logic TBD) */
                         txdma_mc0_packet_match1 = 105,         
                         txdma_mc0_packet_match2 = 106,         
                         txdma_mc0_packet_match3 = 107,         
                                txdma_reserved_a = 108,         /* Reserved */
                                txdma_reserved_b = 109,         /* Reserved */
                                txdma_reserved_c = 110,         /* Reserved */
                                txdma_reserved_d = 111,         /* Reserved */
                                lm_fecn_rcvd_pt0 = 112,         /* Count of the number of packets received on port 0 that are marked with FECN. */
                                lm_becn_rcvd_pt0 = 113,         /* Count of the number of packets received on port 0 that are marked with BECN. */
                                lm_pkts_sent_pt0 = 114,         /* Count of the number of packets sent on port 0 */
                                lm_pkts_rcvd_pt0 = 115,         /* Count of the number of packets received on port 0 */
                            lm_stall_rm_fifo_pt0 = 116,         /* Number of cycles stalled because the rate matching FIFO on Port 0 is full */
                                    lm_byp_pkt_x = 117,         /* MCTC counter increment signal for the bypass send to self packets Cross Reference to X: xrefCross Reference to Y: yrefCross Reference to z: zref */
                                    lm_byp_pkt_y = 118,         
                                    lm_byp_pkt_z = 119,         
                                  lm_byp_qflit_x = 120,         /* MCTC counter increment signal for the bypass send to self qflitsCross Reference to X: xrefCross Reference to Y: yrefCross Reference to z: zref */
                                  lm_byp_qflit_y = 121,         
                                  lm_byp_qflit_z = 122,         
                                   lm_byp_wait_x = 123,         /* MCTC counter increment signal for the bypass send to self, the MCTC data available but fifo is full.Cross Reference to X: xrefCross Reference to Y: yrefCross Reference to z: zref */
                                   lm_byp_wait_y = 124,         
                                   lm_byp_wait_z = 125,         
                               lm_xmit_multicast = 126,         /* Count the Multicast Packets being transmitted. */
                                   lm_reserved_a = 127,         /* Reserved */
                                   lm_reserved_b = 128,         /* Reserved */
                                   lm_reserved_c = 129,         /* Reserved */
                                   lm_reserved_d = 130,         /* Reserved */
                                   lm_reserved_e = 131,         /* Reserved */
                                   lm_reserved_f = 132,         /* Reserved */
                                   lm_reserved_g = 133,         /* Reserved */
                                   lm_reserved_h = 134,         /* Reserved */
                      rxci_stall_cq_empty_events = 135,         /* User receive command queues are stalled because all command queues are empty. Event is counted once per event (i.e. CQs were not empty and then were empty). */
                              rxci_slots_written = 136,         /* Total Number of slots written into the Rx Command queue (either in full 64B writes or by partial writes). */
                         rxci_nonfull_slot_write = 137,         /* A slot in the RX Command queue was partially written (less than 64B written is a single transaction. */
                         rxci_stall_rxhp_credits = 138,         /* Receive command queues are stalled because no credits are available in the downstream interface (RXHP). Commands must be available for this event to be counted. */
                                       rxci_cmds = 139,         /* Number of commands processed by the RXCI interface */
                                 rxci_reserved_a = 140,         /* Reserved */
                                 rxci_reserved_b = 141,         /* Reserved */
                                 rxci_reserved_c = 142,         /* Reserved */
                                 rxci_reserved_d = 143,         /* Reserved */
                         rxe2e_no_big_scoreboard = 144,         /* Number of unordered packets wanting a big scoreboard, but unable to obtain one */
                         rxe2e_beyond_scoreboard = 145,         /* Number of unordered packets that arrived with a packet sequence number (PSN) that could not be scored in either a small scoreboard or a big scoreboard */
                             rxe2e_psn_dist_0_31 = 146,         /* Number of unordered packets that arrived with a PSN distance from expected psn of 0-31 */
                            rxe2e_psn_dist_32_63 = 147,         /* Number of unordered packets that arrived with a PSN distance from expected psn of 32-63. */
                           rxe2e_psn_dist_64_127 = 148,         /* Number of unordered packets that arrived with a PSN distance from expected psn of 64-127 */
                          rxe2e_psn_dist_128_255 = 149,         /* Number of unordered packets that arrived with a PSN distance from expected psn of 128-255 */
                          rxe2e_psn_dist_256_511 = 150,         /* Number of unordered packets that arrived with a PSN distance from expected psn of 256-511 */
                          rxe2e_psn_dist_512_767 = 151,         /* Number of unordered packets that arrived with a PSN distance from expected psn of 512-767 */
                         rxe2e_psn_dist_768_plus = 152,         /* Number of unordered packets that arrived with a PSN that exceeds the expected sequence number by 768 or more */
                         rxe2e_mc0_packet_match0 = 153,         /* A generic MC0 packet header match triggered (matching logic TBD) */
                         rxe2e_mc0_packet_match1 = 154,         /* A generic MC0 packet header match triggered (matching logic TBD) */
                         rxe2e_mc0_packet_match2 = 155,         /* A generic MC0 packet header match triggered (matching logic TBD) */
                         rxe2e_mc0_packet_match3 = 156,         /* A generic MC0 packet header match triggered (matching logic TBD) */
                         rxe2e_mc1_packet_match0 = 157,         /* A generic MC1 packet header match triggered (matching logic TBD) */
                         rxe2e_mc1_packet_match1 = 158,         /* A generic MC1 packet header match triggered (matching logic TBD) */
                                      rxpsn_hits = 159,         /* Number of hits in the RXPSN cache */
                                      rxpsn_miss = 160,         /* Number of misses in the RXPSN cache */
                                rxpsn_fill_stall = 161,         /* Number of stall cycles due to the fill FIFO in the RXPSN cache being full */
                               rxpsn_evict_stall = 162,         /* Number of stall cycles due to the evict FIFO in the RXPSN cache being full */
                                    rxpsn_evicts = 163,         /* Number of RXPSN cache evictions (capacity only, not CSR-based evictions) */
                              rxpsn_membus_stall = 164,         /* Number of stall cycles due to the memory access port in the RXPSN cache being busy */
                                rxe2e_reserved_a = 165,         /* Reserved */
                                rxe2e_reserved_b = 166,         /* Reserved */
                                rxe2e_reserved_c = 167,         /* Reserved */
                                rxe2e_reserved_d = 168,         /* Reserved */
                                rxe2e_reserved_e = 169,         /* Reserved */
                                rxe2e_reserved_f = 170,         /* Reserved */
                                rxe2e_reserved_g = 171,         /* Reserved */
                                rxe2e_reserved_h = 172,         /* Reserved */
                                rxe2e_reserved_i = 173,         /* Reserved */
                                rxe2e_reserved_j = 174,         /* Reserved */
                                rxe2e_reserved_k = 175,         /* Reserved */
                                   rxhp_fastpath = 176,         /* Number of requests entering the RXHP fastpath */
                                    rxhp_rpc0_t0 = 177,         /* Number of requests utilizing RPC0 thread 0 */
                                    rxhp_rpc0_t1 = 178,         /* Number of requests utilizing RPC0 thread 1 */
                                    rxhp_rpc0_t2 = 179,         /* Number of requests utilizing RPC0 thread 2 */
                                    rxhp_rpc0_t3 = 180,         /* Number of requests utilizing RPC0 thread 3 */
                                    rxhp_rpc1_t0 = 181,         /* Number of requests utilizing RPC1 thread 0 */
                                    rxhp_rpc1_t1 = 182,         /* Number of requests utilizing RPC1 thread 1 */
                                    rxhp_rpc1_t2 = 183,         /* Number of requests utilizing RPC1 thread 2 */
                                    rxhp_rpc1_t3 = 184,         /* Number of requests utilizing RPC1 thread 3 */
                                        rxhp_pe0 = 185,         /* Number of requests for the RXHP PE0 pipeline */
                                        rxhp_pe1 = 186,         /* Number of requests for the RXHP PE1 pipeline */
                                        rxhp_pe2 = 187,         /* Number of requests for the RXHP PE2 pipeline */
                                        rxhp_pe3 = 188,         /* Number of requests for the RXHP PE3 pipeline */
                                        rxhp_put = 189,         /* Number of Put operations handled by RXHP */
                                        rxhp_get = 190,         /* Number of Get operations handled by RXHP (fetchingoperations also increment the Get count) */
                                     rxhp_atomic = 191,         /* Number of Atomic operations handled by RXHP. Vector atomics increment this once permessage. */
                                        rxhp_vop = 192,         /* Number of Verbs over Portals operations handled by RXHP */
                                       rxhp_gen1 = 193,         /* Number of PSM/OFED operations handled by RXHP */
                                         rxhp_to = 194,         /* Number of triggered operations handled by the RXHP */
                                        rxhp_rts = 195,         /* Number of Request-to-send operations handled by the RXHP */
                      rxhp_stall_rxdma_credits_x = 196,         /* Header processing stalls due to insufficient credits toissue RXDMA commands. The TC is selected in RXHP.Cross Reference to X: xref */
                      rxhp_stall_rxdma_credits_y = 197,         /* Cross Reference to Y: xref */
                             rxhp_et_resrv_stall = 198,         /* Number of cycles an input into RXHP arbiter was stalled due to an ET reservation stall condition */
                         rxhp_pid_conflict_stall = 199,         /* Header processing pipeline is stalled due to PID conflicts.This event only counts if the next packet is able to issuebased on RXDMA credits. */
                              rxhp_pe_busy_stall = 200,         /* Header processing pipeline is stalled due to all PEs beingbusy. This event only counts if the next packet is able toissue (no RXDMA credit stalls, no PID conflicts) */
                       rxhp_pkt_status_rpc_stall = 201,         /* RPC pipeline is stalled due a lack of status good from RXE2E */
                        rxhp_pkt_status_fp_stall = 202,         /* FP pipeline is stalled due a lack of status good from RXE2E */
                             rxhp_rpc_busy_stall = 203,         /* RPC pipeline is stalled due to all RPCs beingbusy. This event only counts if the next packet is able toissue (no RXDMA credit stalls, no PID conflicts) */
                              rxhp_psc_req_stall = 204,         /* More than one request is arbitrating for PSC pipeline.This event counts how many total cycles the conflictingrequests are delayed. */
                              rxhp_psc_rsp_stall = 205,         /* More than one response is arbitrating from the PSC pipeline.This event counts how many total cycles the conflictingrequests are delayed. */
                                  pte_cache_hits = 206,         /* Number of hits in the PTE cache */
                                  pte_cache_miss = 207,         /* Number of misses in the PTE cache */
                            pte_cache_fill_stall = 208,         /* Number of stall cycles due to the fill FIFO in the PortalTable Entry (PTE) cache being full */
                           pte_cache_evict_stall = 209,         /* Number of stall cycles due to the evict FIFO in the PortalTable Entry (PTE) cache being full */
                                pte_cache_evicts = 210,         /* Number of Portal Table Entry (PTE) cache evictions(capacity only, not CSR-based evictions) */
                          pte_cache_membus_stall = 211,         /* Number of stall cycles due to the memory access port inthe Portal Table Entry (PTE) cache being busy */
                                  psc_cache_hits = 212,         /* Number of hits in the Portals State Cache (PSC) per bank path (prim and sec) */
                                  psc_cache_miss = 213,         /* Number of misses in the Portals State Cache (PSC) per bank path (prim and sec) */
                            psc_cache_fill_stall = 214,         /* Number of stall cycles due to the fill FIFO in the PortalsState Cache (PSC) being full */
                           psc_cache_evict_stall = 215,         /* Number of stall cycles due to the evict FIFO in the PortalsState Cache (PSC) being full */
                                psc_cache_evicts = 216,         /* Number of Portals State Cache (PSC) evictions(capacity only, not CSR-based evictions) */
                          psc_cache_membus_stall = 217,         /* Number of stall cycles due to the memory access port inthe Portals State Cache (PSC) being busy */
                           psc_cache_cmd_port0_x = 218,         /* Count of PSC cache commands by command type X on port 0.  Cross Reference to X: xref */
                           psc_cache_cmd_port1_x = 219,         /* Count of PSC cache commands by command type X on port 1. Cross Reference to X: xref */
                           psc_cache_cmd_bank0_x = 220,         /* Count of PSC cache commands by command type X on bank 0. Cross Reference to X: xref */
                           psc_cache_cmd_bank1_x = 221,         /* Count of PSC cache commands by command type X on bank 1. Cross Reference to X: xref */
                       rxhp_digest_matches_port0 = 222,         /* Number of times the digest filter was not sufficient (hence it matches) to allow the walker to skip reading the full entry on port 0 */
                       rxhp_digest_matches_port1 = 223,         /* Number of times the digest filter was not sufficient (hence it matches) to allow the walker to skip reading the full entry on port 1 */
                                rxhp_cmd_q_empty = 224,         /* Number of cycles the command queue into the RXHP arbiter is empty */
                              rxhp_req_q_empty_x = 225,         /* Number of cycles the X TC request queue into the RXHP arbiter is empty. Cross Reference to X: xref */
                              rxhp_mem_lat_count = 226,         /* Number of memory requests that we have tracked latency for.  (Divide RXHP_MEM_LAT_CYCLES by this counter to get average round trip memory latency for the caches). */
                             rxhp_mem_lat_cycles = 227,         /* Number of cycles all tracked memory requests from PSC or PTE spent outstanding */
                                 rxhp_reserved_a = 228,         /* Reserved */
                                 rxhp_reserved_b = 229,         /* Reserved */
                                 rxhp_reserved_c = 230,         /* Reserved */
                                 rxhp_reserved_d = 231,         /* Reserved */
                                 rxhp_reserved_e = 232,         /* Reserved */
                                 rxhp_reserved_f = 233,         /* Reserved */
                                 rxhp_reserved_g = 234,         /* Reserved */
                                 rxhp_reserved_h = 235,         /* Reserved */
                                 rxhp_reserved_i = 236,         /* Reserved */
                                 rxhp_reserved_j = 237,         /* Reserved */
                                 rxhp_reserved_k = 238,         /* Reserved */
                                 rxhp_reserved_l = 239,         /* Reserved */
                                 rxdma_rx_writes = 240,         /* Total write accesses done over the RX interface to HIARB. An atomic counts as a write. A fetching atomic counts as a write and a read. This includes event writes. */
                                  rxdma_rx_reads = 241,         /* Total read accesses done over the RX interface to HIARB. A fetching atomic counts as a write and a read. */
                           rxdma_rx_flits_tcmc_x = 242,         /* Total flits received by RXDMA on a TC/MC as selected in the RXDMA block.Appendix , 'rx_flits_mctc_x'Appendix , 'rx_flits_mctc_y' */
                           rxdma_rx_flits_tcmc_y = 243,         
                  rxdma_stall_mem_credits_cycles = 244,         /* The RX DMA engine has stalled due to not having available outstanding credits to memory. Total stalled cycles are counted. */
                      rxdma_stall_mem_rsp_events = 245,         /* The RX DMA engine is waiting on memory responses and has no other work to do. Stalls are counted once per event. */
                      rxdma_stall_mem_rsp_cycles = 246,         /* The RX DMA engine is waiting on memory responses and has no other work to do. Total stalled cycles are counted. */
                      rxdma_stall_empty_events_x = 247,         /* Receive DMA is stalled because there is nothing in the request pipeline. Event is counted once per event (i.e. input was not empty and then was empty). The TC/MC for this counter is selected in the RXDMA block.Appendix , 'no_cmd_mctc_x'Appendix , 'no_cmd_mctc_y' */
                      rxdma_stall_empty_events_y = 248,         
                           rxdma_stall_credits_x = 249,         /* Receive DMA is stalled because it has no credits for the HI ARB. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'no_credits_mctc_x'Appendix , 'no_credits_mctc_y' */
                           rxdma_stall_credits_y = 250,         
                            rxdma_stall_no_cmd_x = 251,         /* Receive DMA is stalled because it has data, but does not have a command. The MC/TC is selected by a CSR in the RXDMA block.Appendix , 'no_cmd_mctc_x'Appendix , 'no_cmd_mctc_y' */
                            rxdma_stall_no_cmd_y = 252,         
                      rxdma_stall_no_txci_cred_x = 253,         /* Receive DMA is stalled because it does not have credits to the TX command interface to generate the ACK/Reply to the TxCI. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'tx_ci_mctc_x'Appendix , 'tx_ci_mctc_y' */
                      rxdma_stall_no_txci_cred_y = 254,         
                     rxdma_stall_no_txdma_cred_x = 255,         /* Receive DMA is stalled because it does not have credits to the TX command interface to generate the ACK/Reply to the TxDMA. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'tx_dma_mctc_x'Appendix , 'tx_dma_mctc_y' */
                     rxdma_stall_no_txdma_cred_y = 256,         
                           rxdma_stall_to_cred_x = 257,         /* Receive DMA is stalled because it does not have credits to the Triggered Op Request logic to request TOs for processing. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'to_mctc_x'Appendix , 'to_mctc_y' */
                           rxdma_stall_to_cred_y = 258,         
                          rxdma_stall_tid_full_x = 259,         /* RXDMA TID buffer is full and stalling future gets. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'tid_mctc_x'Appendix , 'tid_mctc_y' */
                          rxdma_stall_tid_full_y = 260,         
                          rxdma_stall_ack_full_x = 261,         /* RXDMA Acknowledgment buffers is full and stalling future gets. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'ack_mctc_x'Appendix , 'ack_mctc_y' */
                          rxdma_stall_ack_full_y = 262,         
                          rxdma_stall_war_full_x = 263,         /* RXDMA WAR buffer is full and stalling future gets. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'war_mctc_x'Appendix , 'war_mctc_y' */
                          rxdma_stall_war_full_y = 264,         
                           rxdma_trig_op_issue_x = 265,         /* RXDMA successfully issued a Triggered Op to the TxCI. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'to_issue_mctc_x'Appendix , 'to_issue_mctc_y' */
                           rxdma_trig_op_issue_y = 266,         
                           rxdma_trig_op_queue_x = 267,         /* RXDMA sent a Cache Line of Triggered Op Pointers to user memory. A Cache Line contains 16 pointers. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'to_queue_mctc_x'Appendix , 'to_queue_mctc_y' */
                           rxdma_trig_op_queue_y = 268,         
                            rxdma_trig_op_append = 269,         /* A Triggered Op Append command completed with the CT Update in the RxDMA. */
                                rxdma_reserved_a = 270,         /* Reserved */
                                rxdma_reserved_b = 271,         /* Reserved */
                                   ct_cache_hits = 272,         /* Number of hits in the CT cache */
                                   ct_cache_miss = 273,         /* Number of misses in the CT cache */
                           ct_cache_writethrough = 274,         /* Number of write-through writes from CT cache */
                             ct_cache_fill_stall = 275,         /* Number of stall cycles due to the fill FIFO in the CT cache being full */
                            ct_cache_evict_stall = 276,         /* Number of stall cycles due to the evict FIFO in the CT cache being full */
                                 ct_cache_evicts = 277,         /* Number of CT cache evictions (capacity only, not CSR-based evictions) */
                           ct_cache_membus_stall = 278,         /* Number of stall cycles due to the memory access port in the CT cache being busy */
                                  eqd_cache_hits = 279,         /* Number of hits in the EQ descriptor cache */
                                  eqd_cache_miss = 280,         /* Number of misses in the EQ descriptor cache */
                            eqd_cache_fill_stall = 281,         /* Number of stall cycles due to the fill FIFO in the EQ descriptor cache being full */
                           eqd_cache_evict_stall = 282,         /* Number of stall cycles due to the evict FIFO in the EQ descriptor cache being full */
                                eqd_cache_evicts = 283,         /* Number of EQ descriptor cache evictions (capacity only, not CSR-based evictions) */
                          eqd_cache_membus_stall = 284,         /* Number of stall cycles due to the memory access port in the EQ descriptor cache being busy */
                              trig_op_cache_hits = 285,         /* Number of hits in the Triggered Operation cache */
                              trig_op_cache_miss = 286,         /* Number of misses in the Triggered Operation cache */
                        trig_op_cache_fill_stall = 287,         /* Number of stall cycles due to the fill FIFO in the Triggered Operation cache being full */
                       trig_op_cache_evict_stall = 288,         /* Number of stall cycles due to the evict FIFO in the Triggered Operation cache being full */
                            trig_op_cache_evicts = 289,         /* Number of Triggered Operation cache evictions (capacity only, not CSR-based evictions) */
                      trig_op_cache_membus_stall = 290,         /* Number of stall cycles due to the memory access port in the Triggered Operation cache being busy */
                                 rxet_reserved_a = 291,         /* Reserved */
                                 rxet_reserved_b = 292,         /* Reserved */
                                 rxet_reserved_c = 293,         /* Reserved */
                                 rxet_reserved_d = 294,         /* Reserved */
                                 rxet_reserved_e = 295,         /* Reserved */
                                 rxet_reserved_f = 296,         /* Reserved */
                                 rxet_reserved_g = 297,         /* Reserved */
                                 rxet_reserved_h = 298,         /* Reserved */
                                 rxet_reserved_i = 299,         /* Reserved */
                                 rxet_reserved_j = 300,         /* Reserved */
                                 rxet_reserved_k = 301,         /* Reserved */
                                 rxet_reserved_l = 302,         /* Reserved */
                                 rxet_reserved_m = 303,         /* Reserved */
                                 at_tlb_accesses = 304,         /* Number of total translation requests */
                                     at_tlb_miss = 305,         /* Number of Misses in the TLB cache */
                                      at_tlb_hit = 306,         /* Number of Hits in the TLB cache */
                                   at_tlb_evicts = 307,         /* Number of TLB cache evictions */
                                  at_tlb_hits_4k = 308,         /* Number of hits in the TLB cache for 4K page entries */
                                  at_tlb_hits_2m = 309,         /* Number of hits in the TLB cache for 2M page entries */
                                  at_tlb_hits_1g = 310,         /* Number of hits in the TLB cache for 1G page entries */
                                at_tlb_evicts_4k = 311,         /* Number of TLB cache evictions for 4K page entries */
                                at_tlb_evicts_2m = 312,         /* Number of TLB cache evictions for 2M page entries */
                                at_tlb_evicts_1g = 313,         /* Number of TLB cache evictions for 1G page entries */
                                at_tlb_req_stall = 314,         /* Number of stalls due to the request FIFO to the IOMMU being full */
                               at_tlb_shootdowns = 315,         /* Number of shutdowns received from software */
                                   at_reserved_a = 316,         /* Reserved */
                                   at_reserved_b = 317,         /* Reserved */
                                   at_reserved_c = 318,         /* Reserved */
                                   at_reserved_d = 319,         /* Reserved */
                         ...
                         rxhiarb_stall_hq_cycles = 343,         /* The RX HIARB input queues are stalled waiting on holding queue entries to become free. */
                           ...
                           rxhiarb_mrd_match_dly = 347,         /* Total number of clock cycles for 'matching' read requests to have their response payload returned. The matching criteria and sampling control can be found in the TBD CSRs described in the HIARB's CSR section. */
                              ...
                              rxhiarb_reserved_d = 351,         /* Reserved */
                                pcim_hpi_req_cnt = 352,         /* Command Queue Request Count */
                            pcim_p2sb_np_req_cnt = 353,         /* IOSF Sideband Non-posted request count */
                            pcim_p2sb_pc_req_cnt = 354,         /* IOSF Sideband Posted (and Completion) Req Count */
                              pcim_iommu_req_cnt = 355,         /* IOSF Sideband IOMMU Request Count */
                                 pcim_ur_req_cnt = 356,         /* IOSF Sideband Unsupported Request Count */
                           pcim_hpi_splt_req_cnt = 357,         /* Unconnected */
                          pcim_p2sb_splt_req_cnt = 358,         /* Unconnected */
                                 pcim_hpi_fc_cnt = 359,         /* Command Queue Request Flow Control Cycle Count */
                                pcim_p2sb_fc_cnt = 360,         /* Command IOSF Sideband Flow Control Cycle Count */
                              pcim_marb_p_fc_cnt = 361,         /* PCIe Posted Flow Control Cycle Count */
                             pcim_marb_np_fc_cnt = 362,         /* PCIe Non-Posted Flow Control Cycle Count */
                            pcim_marb_cpl_fc_cnt = 363,         /* PCIe Completion Flow Control Cycle Count */
                             pcim_marb_p_req_cnt = 364,         /* PCIe Posted Flow Control Request Count */
                            pcim_marb_np_req_cnt = 365,         /* PCIe Non-Posted Flow Control Request Count */
                           pcim_marb_cpl_req_cnt = 366,         /* PCIe Completion Flow Control Request Count */
                            pcim_io2p_np_req_cnt = 367,         /* Unconnected */
                             pcim_sb2p_p_req_cnt = 368,         /* IOSF Sideband to PCIe Posted Request Count */
                            pcim_sb2p_np_req_cnt = 369,         /* IOSF Sideband to PCIe Posted Request Count */
                           pcim_sb2p_cpl_req_cnt = 370,         /* IOSF Sideband to PCIe Posted Request Count */
                             pcim_init_p_req_cnt = 371,         /* Unconnected */
                            pcim_hpi_cpl_req_cnt = 372,         /* Command Queue Completion Count */
...
#define                  otr_stall_omb_entries_x   15           /* The OTR is stalled waiting for OMB entries. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 33.8.9.1, 'Stall OMB Entries X Performance CSR'Cross Reference to Y: Section 33.8.9.2, 'Stall OMB Entries Y Performance CSR' */
#define                  otr_stall_omb_entries_y   16           
#define                otr_stall_rxdma_credits_x   17           /* The OTR is stalled waiting for credits to the RXDMA block. The TC for this counter is selected in the OTR block.Cross Reference to X: Section 33.8.9.3, 'Stall RXDMA Credits X Performance CSR'Cross Reference to Y: Section 33.8.9.4, 'Stall RXDMA Credits Y Performance CSR' */
#define                otr_stall_rxdma_credits_y   18           
#define                            otr_stall_cts   19           /* The CTS queue within OTR has stalled for lack of credits. */
#define               otr_m_to_p_stall_credits_x   20           /* The OMB to OPB queues are stalled waiting on credits. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 33.8.9.5, 'Stall Message Partition to Packet Partition Credits X Performance CSR'Cross Reference to Y: Section 33.8.9.6, 'Stall Message Partition to Packet Partition Credits Y Performance CSR' */
...
#define                            otr_stall_bpe   24           /* Stall due to BPE receiving too many CTS from MSG */
...
#define                          otr_stall_rx_rd   27           /* OTR stalled due to OTR_MSG RX path not being able to access read path of the OMB */
#define                          otr_stall_rx_wr   28           /* OTR stalled due to OTR_MSG RX path not being able to access write path of the OMB */
#define                 otr_stall_final_ects_ack   29           /* OTR stalled due to Final ECTS ACK requiring REvent command to be generated. */
#define                    otr_stall_omb_reorder   30           /* OTR stalled due to OMB reads needing to be reordered, usually for a Reply or final ACK for Rendezvous interaction requiring RTS entry to be read. */
#define                        otr_stall_for_rts   31           /* OTR stalled for a rendezvous interaction which needs to read both OMB entries. This should regularly go high for several cycles after each REPLY or final ACK for a rendezvous. */
#define                      otr_stall_max_2_req   32           /* OTR stalled due to too many RX packets in the event generation pipeline. This should happen for back to back RX packets to Fetching Atomic commands. */
#define                     otr_stall_same_msgid   33           /* OTR stalled due to multiple RX packets to the same msgid back to back. This should happen rarely, and only for mutli-packet commands. */
#define                        otr_stall_b2b_pkt   34           /* OTR stalled due for one cycle on packets in the RX pipeline that are back to back. This should happen regularly when the RX FIFOs are non-empty. */
#define                  otr_stall_refcount_fifo   35           /* OTR stalled because the refcount decrement FIFO to RXHP is full. */
#define                     otr_stall_rxdma_fifo   36           /* OTR stalled because the FIFO to RXDMA is full. */
#define                      otr_stall_rxet_fifo   37           /* OTR stalled because the FIFO to RXET is full. */
#define               otr_stall_ordering_portals   38           /* OTR stalled for ordering requirement on Portals packets */
#define         otr_stalling_ordering_nonportals   39           /* OTR stalled for ordering requirement on non-Portals packets. */
#define                       otr_msg_reserved_a   40           /* Reserved */
#define                       otr_msg_reserved_b   41           /* Reserved */
#define                       otr_msg_reserved_c   42           /* Reserved */
#define                       otr_msg_reserved_d   43           /* Reserved */
#define                       otr_msg_reserved_e   44           /* Reserved */
#define                       otr_msg_reserved_f   45           /* Reserved */
#define                       otr_msg_reserved_g   46           /* Reserved */
#define                       otr_msg_reserved_h   47           /* Reserved */
#define                     otr_rsp_special_acks   48           /* This counter counts the special ACKs received by the OTR on any TC */
#define                  otr_stall_opb_entries_x   49           /* The OTR is stalled waiting for OPB entries. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 29.7.3.152, 'Stall OPB Entries X Performance CSR'Cross Reference to Y: Section 33.7.9.2, 'Stall OMB Entries Y Performance CSR' */
#define                  otr_stall_opb_entries_y   50           
#define                otr_stall_txdma_credits_x   51           /* The OTR is stalled waiting for credits to the TXDMA block. The TC/MC for this counter is selected in the OTR block.Cross Reference to X: Section 33.7.9.3, 'Stall TXDMA Credits X Performance CSR'Cross Reference to Y: Section 33.7.9.4, 'Stall TXDMA Credits Y Performance CSR' */
#define                otr_stall_txdma_credits_y   52           
#define                otr_opb_stall_mem_credits   53           /* The OTR/OPB engine has stalled due to not having credits available for requests to memory. */
#define             otr_opb_stall_mem_rsp_events   54           /* The OTR/OPB engine is waiting on memory responses and has no other work to do. */
#define             otr_opb_stall_mem_rsp_cycles   55           /* The OTR/OPB engine is waiting on memory responses and has no other work to do. */
#define                 otr_opb_stall_at_credits   56           /* The OTR/OPB engine has stalled due to a lack of available AT credits */
#define              otr_opb_stall_at_rsp_events   57           /* The OTR/OPB engine is waiting on AT responses and had no other work to do. */
#define              otr_opb_stall_at_rsp_cycles   58           /* The OTR/OPB engine is waiting on AT responses and had no other work to do. */
#define               otr_p_to_m_stall_credits_x   59           /* The OPB to OMB queues are stalled waiting on credits. The TC for this counter is selected in the OTR block.Cross Reference to X: Section 33.7.9.5, 'Stall Packet Partition to Message Partition Credits X Performance CSR'Cross Reference to Y: Section 33.7.9.6, 'Stall Packet Partition to Message Partition Credits Y Performance CSR' */
#define               otr_p_to_m_stall_credits_y   60           
#define           otr_pktid_list_conflict_replay   61           /* A PKTID update conflict caused a Tx command to be replayed through the pipeline. */
#define                   otr_psn_distance_stall   62           /* The OTR is stalled to enforce PSN distance */
#define                         otr_fastpath_req   63           /* Number of requests generated into the fastpath in OTR. */
#define                           otr_fragpe_req   64           /* Number of requests generated into the fragmentation path in OTR. */
#define                           otr_txdma_cmds   65           /* The number of commands issued from OTR to TXDMA. This may be more than one command per packet. */
#define                     otr_packets_opened_x   66           /* Total number of packets generated by OTR. Total packets is the sum of the fastpath packets and the fragmentation PE packets. This reflects the number of OPB entries allocated. The TC/MC is selected in the OTR block.Cross Reference to X: */
#define                     otr_packets_closed_x   67           /* Total number of packets completed by OTR. Total packets is the sum of the fastpath packets and the fragmentation PE packets. This represents the number of OPB entries closed. The TC/MC is selected in the OTR block.Cross Reference to X: */
#define                      otr_packets_retrans   68           /* Total number of retransmitted packets. Included NACK-based retransmit, timeout-based retransmit, and retransmits internally scheduled due to max sequence distance violations. */
#define                          otr_latency_0_a   69           /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was A or less.Note: granularity of the time is likely to be at least 1 millisecond.Cross Reference to A: Section 33.7.9.7, 'Latency Performance CSR' */
#define                          otr_latency_a_b   70           /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than A and less than or equal to B.Cross Reference to B: Section 33.7.9.7, 'Latency Performance CSR' */
#define                          otr_latency_b_c   71           /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than B and less than or equal to C.Cross Reference to C: Section 33.7.9.7, 'Latency Performance CSR' */
#define                          otr_latency_c_d   72           /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than C and less than or equal to D.Cross Reference to D: Section 33.7.9.7, 'Latency Performance CSR' */
#define                        otr_latency_d_max   73           /* Number of packets where the acknowledgement was received when the difference between the timestamp in the OPB and the current timestamp was greater than D. */
#define                 otr_retrans_limit_rchd_x   74           /* Retransmit Limit reached. This counter increments only once after the retransmission limit is reached for that TC. The TC for this counter is selected in the OTR block.Cross Reference to X: xref */
#define                   otr_cleanup_cmd_detect   75           /* Increments the counter when an cleanup command is detected in the OTR */
#define                    otr_local_seq_stall_x   76           /* Indicates that a local sequence has stalled due to the maximum distance between the oldest outstanding local packet sequence number and the next available local packet sequence number exceeding half of the sequence number space. This counter increments once when this condition is detected. The MC/TC for this counter is selected in the OTR block.Cross Reference to X: xref */
#define                               txpsn_hits   77           /* Number of hits in the TXPSN cache */
#define                               txpsn_miss   78           /* Number of misses in the TXPSN cache */
#define                         txpsn_fill_stall   79           /* Number of stall cycles due to the fill FIFO in the TXPSN cache being full */
#define                        txpsn_evict_stall   80           /* Number of stall cycles due to the evict FIFO in the TXPSN cache being full */
#define                             txpsn_evicts   81           /* Number of TXPSN cache evictions (capacity only, not CSR-based evictions) */
#define                       txpsn_membus_stall   82           /* Number of stall cycles due to the memory access port in the TXPSN cache being busy */
#define                       otr_pkt_reserved_a   83           /* Reserved */
#define                       otr_pkt_reserved_b   84           /* Reserved */
#define                       otr_pkt_reserved_c   85           /* Reserved */
#define                       otr_pkt_reserved_d   86           /* Reserved */
#define                           txdma_tx_reads   87           /* Total read accesses done over the TX interface to memory. */
#define                  txdma_mc1_packet_match0   88           /* A packet ,match triggered on MC1 */
#define                  txdma_mc1_packet_match1   89           /* A packet match triggered on MC1 */
#define                    txdma_tx_flits_tcmc_w   90           /* Total flits transmitted by TXDMA on a TC/MC as selected in the TXDMA block.Cross Reference to W: xrefCross Reference to X: xrefCross Reference to Y: xrefCross Reference to Z: xref */
#define                    txdma_tx_flits_tcmc_x   91           
#define                    txdma_tx_flits_tcmc_y   92           
#define                    txdma_tx_flits_tcmc_z   93           
#define                  txdma_stall_mem_credits   94           /* The TX DMA engine has stalled due to not having outstanding credits to memory available for use. */
#define               txdma_stall_mem_rsp_events   95           /* The TX DMA engine is waiting on memory responses and has no other work to do. */
#define               txdma_stall_mem_rsp_cycles   96           /* The TX DMA engine is waiting on memory responses and has no other work to do. */
#define                   txdma_stall_at_credits   97           /* The TX DMA engine has stalled due to a lack of available AT credits */
#define                txdma_stall_at_rsp_events   98           /* The TX DMA engine is waiting on AT responses and had no other work to do. */
#define                txdma_stall_at_rsp_cycles   99           /* The TX DMA engine is waiting on AT responses and had no other work to do. */
#define               txdma_stall_empty_events_x   100          /* Transmit DMA is stalled because there is nothing in the request pipeline. Event is counted once per event (i.e. input was not empty and then was empty). The TC/MC for this counter is selected in the TXDMA block.Cross Reference to X: xrefCross Reference to Y: xref */
#define               txdma_stall_empty_events_y   101          
#define                    txdma_stall_credits_x   102          /* Transmit DMA is stalled because it has no credits for the Link Mux. The TC/MC for this counter is selected in the TXDMA block.Cross Reference to X: xrefCross Reference to Y: xref */
#define                    txdma_stall_credits_y   103          
#define                  txdma_mc0_packet_match0   104          /* A generic packet header match triggered (matching logic TBD) */
#define                  txdma_mc0_packet_match1   105          
#define                  txdma_mc0_packet_match2   106          
#define                  txdma_mc0_packet_match3   107          
#define                         txdma_reserved_a   108          /* Reserved */
#define                         txdma_reserved_b   109          /* Reserved */
#define                         txdma_reserved_c   110          /* Reserved */
#define                         txdma_reserved_d   111          /* Reserved */
#define                         lm_fecn_rcvd_pt0   112          /* Count of the number of packets received on port 0 that are marked with FECN. */
#define                         lm_becn_rcvd_pt0   113          /* Count of the number of packets received on port 0 that are marked with BECN. */
#define                         lm_pkts_sent_pt0   114          /* Count of the number of packets sent on port 0 */
#define                         lm_pkts_rcvd_pt0   115          /* Count of the number of packets received on port 0 */
#define                     lm_stall_rm_fifo_pt0   116          /* Number of cycles stalled because the rate matching FIFO on Port 0 is full */
#define                             lm_byp_pkt_x   117          /* MCTC counter increment signal for the bypass send to self packets Cross Reference to X: xrefCross Reference to Y: yrefCross Reference to z: zref */
#define                             lm_byp_pkt_y   118          
#define                             lm_byp_pkt_z   119          
#define                           lm_byp_qflit_x   120          /* MCTC counter increment signal for the bypass send to self qflitsCross Reference to X: xrefCross Reference to Y: yrefCross Reference to z: zref */
#define                           lm_byp_qflit_y   121          
#define                           lm_byp_qflit_z   122          
#define                            lm_byp_wait_x   123          /* MCTC counter increment signal for the bypass send to self, the MCTC data available but fifo is full.Cross Reference to X: xrefCross Reference to Y: yrefCross Reference to z: zref */
#define                            lm_byp_wait_y   124          
#define                            lm_byp_wait_z   125          
#define                        lm_xmit_multicast   126          /* Count the Multicast Packets being transmitted. */
#define                            lm_reserved_a   127          /* Reserved */
#define                            lm_reserved_b   128          /* Reserved */
#define                            lm_reserved_c   129          /* Reserved */
#define                            lm_reserved_d   130          /* Reserved */
#define                            lm_reserved_e   131          /* Reserved */
#define                            lm_reserved_f   132          /* Reserved */
#define                            lm_reserved_g   133          /* Reserved */
#define                            lm_reserved_h   134          /* Reserved */
#define               rxci_stall_cq_empty_events   135          /* User receive command queues are stalled because all command queues are empty. Event is counted once per event (i.e. CQs were not empty and then were empty). */
#define                       rxci_slots_written   136          /* Total Number of slots written into the Rx Command queue (either in full 64B writes or by partial writes). */
#define                  rxci_nonfull_slot_write   137          /* A slot in the RX Command queue was partially written (less than 64B written is a single transaction. */
#define                  rxci_stall_rxhp_credits   138          /* Receive command queues are stalled because no credits are available in the downstream interface (RXHP). Commands must be available for this event to be counted. */
#define                                rxci_cmds   139          /* Number of commands processed by the RXCI interface */
#define                          rxci_reserved_a   140          /* Reserved */
#define                          rxci_reserved_b   141          /* Reserved */
#define                          rxci_reserved_c   142          /* Reserved */
#define                          rxci_reserved_d   143          /* Reserved */
#define                  rxe2e_no_big_scoreboard   144          /* Number of unordered packets wanting a big scoreboard, but unable to obtain one */
#define                  rxe2e_beyond_scoreboard   145          /* Number of unordered packets that arrived with a packet sequence number (PSN) that could not be scored in either a small scoreboard or a big scoreboard */
#define                      rxe2e_psn_dist_0_31   146          /* Number of unordered packets that arrived with a PSN distance from expected psn of 0-31 */
#define                     rxe2e_psn_dist_32_63   147          /* Number of unordered packets that arrived with a PSN distance from expected psn of 32-63. */
#define                    rxe2e_psn_dist_64_127   148          /* Number of unordered packets that arrived with a PSN distance from expected psn of 64-127 */
#define                   rxe2e_psn_dist_128_255   149          /* Number of unordered packets that arrived with a PSN distance from expected psn of 128-255 */
#define                   rxe2e_psn_dist_256_511   150          /* Number of unordered packets that arrived with a PSN distance from expected psn of 256-511 */
#define                   rxe2e_psn_dist_512_767   151          /* Number of unordered packets that arrived with a PSN distance from expected psn of 512-767 */
#define                  rxe2e_psn_dist_768_plus   152          /* Number of unordered packets that arrived with a PSN that exceeds the expected sequence number by 768 or more */
#define                  rxe2e_mc0_packet_match0   153          /* A generic MC0 packet header match triggered (matching logic TBD) */
#define                  rxe2e_mc0_packet_match1   154          /* A generic MC0 packet header match triggered (matching logic TBD) */
#define                  rxe2e_mc0_packet_match2   155          /* A generic MC0 packet header match triggered (matching logic TBD) */
#define                  rxe2e_mc0_packet_match3   156          /* A generic MC0 packet header match triggered (matching logic TBD) */
#define                  rxe2e_mc1_packet_match0   157          /* A generic MC1 packet header match triggered (matching logic TBD) */
#define                  rxe2e_mc1_packet_match1   158          /* A generic MC1 packet header match triggered (matching logic TBD) */
#define                               rxpsn_hits   159          /* Number of hits in the RXPSN cache */
#define                               rxpsn_miss   160          /* Number of misses in the RXPSN cache */
#define                         rxpsn_fill_stall   161          /* Number of stall cycles due to the fill FIFO in the RXPSN cache being full */
#define                        rxpsn_evict_stall   162          /* Number of stall cycles due to the evict FIFO in the RXPSN cache being full */
#define                             rxpsn_evicts   163          /* Number of RXPSN cache evictions (capacity only, not CSR-based evictions) */
#define                       rxpsn_membus_stall   164          /* Number of stall cycles due to the memory access port in the RXPSN cache being busy */
#define                         rxe2e_reserved_a   165          /* Reserved */
#define                         rxe2e_reserved_b   166          /* Reserved */
#define                         rxe2e_reserved_c   167          /* Reserved */
#define                         rxe2e_reserved_d   168          /* Reserved */
#define                         rxe2e_reserved_e   169          /* Reserved */
#define                         rxe2e_reserved_f   170          /* Reserved */
#define                         rxe2e_reserved_g   171          /* Reserved */
#define                         rxe2e_reserved_h   172          /* Reserved */
#define                         rxe2e_reserved_i   173          /* Reserved */
#define                         rxe2e_reserved_j   174          /* Reserved */
#define                         rxe2e_reserved_k   175          /* Reserved */
#define                            rxhp_fastpath   176          /* Number of requests entering the RXHP fastpath */
#define                             rxhp_rpc0_t0   177          /* Number of requests utilizing RPC0 thread 0 */
#define                             rxhp_rpc0_t1   178          /* Number of requests utilizing RPC0 thread 1 */
#define                             rxhp_rpc0_t2   179          /* Number of requests utilizing RPC0 thread 2 */
#define                             rxhp_rpc0_t3   180          /* Number of requests utilizing RPC0 thread 3 */
#define                             rxhp_rpc1_t0   181          /* Number of requests utilizing RPC1 thread 0 */
#define                             rxhp_rpc1_t1   182          /* Number of requests utilizing RPC1 thread 1 */
#define                             rxhp_rpc1_t2   183          /* Number of requests utilizing RPC1 thread 2 */
#define                             rxhp_rpc1_t3   184          /* Number of requests utilizing RPC1 thread 3 */
#define                                 rxhp_pe0   185          /* Number of requests for the RXHP PE0 pipeline */
#define                                 rxhp_pe1   186          /* Number of requests for the RXHP PE1 pipeline */
#define                                 rxhp_pe2   187          /* Number of requests for the RXHP PE2 pipeline */
#define                                 rxhp_pe3   188          /* Number of requests for the RXHP PE3 pipeline */
#define                                 rxhp_put   189          /* Number of Put operations handled by RXHP */
#define                                 rxhp_get   190          /* Number of Get operations handled by RXHP (fetchingoperations also increment the Get count) */
#define                              rxhp_atomic   191          /* Number of Atomic operations handled by RXHP. Vector atomics increment this once permessage. */
#define                                 rxhp_vop   192          /* Number of Verbs over Portals operations handled by RXHP */
#define                                rxhp_gen1   193          /* Number of PSM/OFED operations handled by RXHP */
#define                                  rxhp_to   194          /* Number of triggered operations handled by the RXHP */
#define                                 rxhp_rts   195          /* Number of Request-to-send operations handled by the RXHP */
#define               rxhp_stall_rxdma_credits_x   196          /* Header processing stalls due to insufficient credits toissue RXDMA commands. The TC is selected in RXHP.Cross Reference to X: xref */
#define               rxhp_stall_rxdma_credits_y   197          /* Cross Reference to Y: xref */
#define                      rxhp_et_resrv_stall   198          /* Number of cycles an input into RXHP arbiter was stalled due to an ET reservation stall condition */
#define                  rxhp_pid_conflict_stall   199          /* Header processing pipeline is stalled due to PID conflicts.This event only counts if the next packet is able to issuebased on RXDMA credits. */
#define                       rxhp_pe_busy_stall   200          /* Header processing pipeline is stalled due to all PEs beingbusy. This event only counts if the next packet is able toissue (no RXDMA credit stalls, no PID conflicts) */
#define                rxhp_pkt_status_rpc_stall   201          /* RPC pipeline is stalled due a lack of status good from RXE2E */
#define                 rxhp_pkt_status_fp_stall   202          /* FP pipeline is stalled due a lack of status good from RXE2E */
#define                      rxhp_rpc_busy_stall   203          /* RPC pipeline is stalled due to all RPCs beingbusy. This event only counts if the next packet is able toissue (no RXDMA credit stalls, no PID conflicts) */
#define                       rxhp_psc_req_stall   204          /* More than one request is arbitrating for PSC pipeline.This event counts how many total cycles the conflictingrequests are delayed. */
#define                       rxhp_psc_rsp_stall   205          /* More than one response is arbitrating from the PSC pipeline.This event counts how many total cycles the conflictingrequests are delayed. */
#define                           pte_cache_hits   206          /* Number of hits in the PTE cache */
#define                           pte_cache_miss   207          /* Number of misses in the PTE cache */
#define                     pte_cache_fill_stall   208          /* Number of stall cycles due to the fill FIFO in the PortalTable Entry (PTE) cache being full */
#define                    pte_cache_evict_stall   209          /* Number of stall cycles due to the evict FIFO in the PortalTable Entry (PTE) cache being full */
#define                         pte_cache_evicts   210          /* Number of Portal Table Entry (PTE) cache evictions(capacity only, not CSR-based evictions) */
#define                   pte_cache_membus_stall   211          /* Number of stall cycles due to the memory access port inthe Portal Table Entry (PTE) cache being busy */
#define                           psc_cache_hits   212          /* Number of hits in the Portals State Cache (PSC) per bank path (prim and sec) */
#define                           psc_cache_miss   213          /* Number of misses in the Portals State Cache (PSC) per bank path (prim and sec) */
#define                     psc_cache_fill_stall   214          /* Number of stall cycles due to the fill FIFO in the PortalsState Cache (PSC) being full */
#define                    psc_cache_evict_stall   215          /* Number of stall cycles due to the evict FIFO in the PortalsState Cache (PSC) being full */
#define                         psc_cache_evicts   216          /* Number of Portals State Cache (PSC) evictions(capacity only, not CSR-based evictions) */
#define                   psc_cache_membus_stall   217          /* Number of stall cycles due to the memory access port inthe Portals State Cache (PSC) being busy */
#define                    psc_cache_cmd_port0_x   218          /* Count of PSC cache commands by command type X on port 0.  Cross Reference to X: xref */
#define                    psc_cache_cmd_port1_x   219          /* Count of PSC cache commands by command type X on port 1. Cross Reference to X: xref */
#define                    psc_cache_cmd_bank0_x   220          /* Count of PSC cache commands by command type X on bank 0. Cross Reference to X: xref */
#define                    psc_cache_cmd_bank1_x   221          /* Count of PSC cache commands by command type X on bank 1. Cross Reference to X: xref */
#define                rxhp_digest_matches_port0   222          /* Number of times the digest filter was not sufficient (hence it matches) to allow the walker to skip reading the full entry on port 0 */
#define                rxhp_digest_matches_port1   223          /* Number of times the digest filter was not sufficient (hence it matches) to allow the walker to skip reading the full entry on port 1 */
#define                         rxhp_cmd_q_empty   224          /* Number of cycles the command queue into the RXHP arbiter is empty */
#define                       rxhp_req_q_empty_x   225          /* Number of cycles the X TC request queue into the RXHP arbiter is empty. Cross Reference to X: xref */
#define                       rxhp_mem_lat_count   226          /* Number of memory requests that we have tracked latency for.  (Divide RXHP_MEM_LAT_CYCLES by this counter to get average round trip memory latency for the caches). */
#define                      rxhp_mem_lat_cycles   227          /* Number of cycles all tracked memory requests from PSC or PTE spent outstanding */
#define                          rxhp_reserved_a   228          /* Reserved */
#define                          rxhp_reserved_b   229          /* Reserved */
#define                          rxhp_reserved_c   230          /* Reserved */
#define                          rxhp_reserved_d   231          /* Reserved */
#define                          rxhp_reserved_e   232          /* Reserved */
#define                          rxhp_reserved_f   233          /* Reserved */
#define                          rxhp_reserved_g   234          /* Reserved */
#define                          rxhp_reserved_h   235          /* Reserved */
#define                          rxhp_reserved_i   236          /* Reserved */
#define                          rxhp_reserved_j   237          /* Reserved */
#define                          rxhp_reserved_k   238          /* Reserved */
#define                          rxhp_reserved_l   239          /* Reserved */
#define                          rxdma_rx_writes   240          /* Total write accesses done over the RX interface to HIARB. An atomic counts as a write. A fetching atomic counts as a write and a read. This includes event writes. */
#define                           rxdma_rx_reads   241          /* Total read accesses done over the RX interface to HIARB. A fetching atomic counts as a write and a read. */
#define                    rxdma_rx_flits_tcmc_x   242          /* Total flits received by RXDMA on a TC/MC as selected in the RXDMA block.Appendix , 'rx_flits_mctc_x'Appendix , 'rx_flits_mctc_y' */
#define                    rxdma_rx_flits_tcmc_y   243          
#define           rxdma_stall_mem_credits_cycles   244          /* The RX DMA engine has stalled due to not having available outstanding credits to memory. Total stalled cycles are counted. */
#define               rxdma_stall_mem_rsp_events   245          /* The RX DMA engine is waiting on memory responses and has no other work to do. Stalls are counted once per event. */
#define               rxdma_stall_mem_rsp_cycles   246          /* The RX DMA engine is waiting on memory responses and has no other work to do. Total stalled cycles are counted. */
#define               rxdma_stall_empty_events_x   247          /* Receive DMA is stalled because there is nothing in the request pipeline. Event is counted once per event (i.e. input was not empty and then was empty). The TC/MC for this counter is selected in the RXDMA block.Appendix , 'no_cmd_mctc_x'Appendix , 'no_cmd_mctc_y' */
#define               rxdma_stall_empty_events_y   248          
#define                    rxdma_stall_credits_x   249          /* Receive DMA is stalled because it has no credits for the HI ARB. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'no_credits_mctc_x'Appendix , 'no_credits_mctc_y' */
#define                    rxdma_stall_credits_y   250          
#define                     rxdma_stall_no_cmd_x   251          /* Receive DMA is stalled because it has data, but does not have a command. The MC/TC is selected by a CSR in the RXDMA block.Appendix , 'no_cmd_mctc_x'Appendix , 'no_cmd_mctc_y' */
#define                     rxdma_stall_no_cmd_y   252          
#define               rxdma_stall_no_txci_cred_x   253          /* Receive DMA is stalled because it does not have credits to the TX command interface to generate the ACK/Reply to the TxCI. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'tx_ci_mctc_x'Appendix , 'tx_ci_mctc_y' */
#define               rxdma_stall_no_txci_cred_y   254          
#define              rxdma_stall_no_txdma_cred_x   255          /* Receive DMA is stalled because it does not have credits to the TX command interface to generate the ACK/Reply to the TxDMA. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'tx_dma_mctc_x'Appendix , 'tx_dma_mctc_y' */
#define              rxdma_stall_no_txdma_cred_y   256          
#define                    rxdma_stall_to_cred_x   257          /* Receive DMA is stalled because it does not have credits to the Triggered Op Request logic to request TOs for processing. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'to_mctc_x'Appendix , 'to_mctc_y' */
#define                    rxdma_stall_to_cred_y   258          
#define                   rxdma_stall_tid_full_x   259          /* RXDMA TID buffer is full and stalling future gets. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'tid_mctc_x'Appendix , 'tid_mctc_y' */
#define                   rxdma_stall_tid_full_y   260          
#define                   rxdma_stall_ack_full_x   261          /* RXDMA Acknowledgment buffers is full and stalling future gets. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'ack_mctc_x'Appendix , 'ack_mctc_y' */
#define                   rxdma_stall_ack_full_y   262          
#define                   rxdma_stall_war_full_x   263          /* RXDMA WAR buffer is full and stalling future gets. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'war_mctc_x'Appendix , 'war_mctc_y' */
#define                   rxdma_stall_war_full_y   264          
#define                    rxdma_trig_op_issue_x   265          /* RXDMA successfully issued a Triggered Op to the TxCI. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'to_issue_mctc_x'Appendix , 'to_issue_mctc_y' */
#define                    rxdma_trig_op_issue_y   266          
#define                    rxdma_trig_op_queue_x   267          /* RXDMA sent a Cache Line of Triggered Op Pointers to user memory. A Cache Line contains 16 pointers. The TC/MC for this counter is selected in the RXDMA block.Appendix , 'to_queue_mctc_x'Appendix , 'to_queue_mctc_y' */
#define                    rxdma_trig_op_queue_y   268          
#define                     rxdma_trig_op_append   269          /* A Triggered Op Append command completed with the CT Update in the RxDMA. */
#define                         rxdma_reserved_a   270          /* Reserved */
#define                         rxdma_reserved_b   271          /* Reserved */
#define                            ct_cache_hits   272          /* Number of hits in the CT cache */
#define                            ct_cache_miss   273          /* Number of misses in the CT cache */
#define                    ct_cache_writethrough   274          /* Number of write-through writes from CT cache */
#define                      ct_cache_fill_stall   275          /* Number of stall cycles due to the fill FIFO in the CT cache being full */
#define                     ct_cache_evict_stall   276          /* Number of stall cycles due to the evict FIFO in the CT cache being full */
#define                          ct_cache_evicts   277          /* Number of CT cache evictions (capacity only, not CSR-based evictions) */
#define                    ct_cache_membus_stall   278          /* Number of stall cycles due to the memory access port in the CT cache being busy */
#define                           eqd_cache_hits   279          /* Number of hits in the EQ descriptor cache */
#define                           eqd_cache_miss   280          /* Number of misses in the EQ descriptor cache */
#define                     eqd_cache_fill_stall   281          /* Number of stall cycles due to the fill FIFO in the EQ descriptor cache being full */
#define                    eqd_cache_evict_stall   282          /* Number of stall cycles due to the evict FIFO in the EQ descriptor cache being full */
#define                         eqd_cache_evicts   283          /* Number of EQ descriptor cache evictions (capacity only, not CSR-based evictions) */
#define                   eqd_cache_membus_stall   284          /* Number of stall cycles due to the memory access port in the EQ descriptor cache being busy */
#define                       trig_op_cache_hits   285          /* Number of hits in the Triggered Operation cache */
#define                       trig_op_cache_miss   286          /* Number of misses in the Triggered Operation cache */
#define                 trig_op_cache_fill_stall   287          /* Number of stall cycles due to the fill FIFO in the Triggered Operation cache being full */
#define                trig_op_cache_evict_stall   288          /* Number of stall cycles due to the evict FIFO in the Triggered Operation cache being full */
#define                     trig_op_cache_evicts   289          /* Number of Triggered Operation cache evictions (capacity only, not CSR-based evictions) */
#define               trig_op_cache_membus_stall   290          /* Number of stall cycles due to the memory access port in the Triggered Operation cache being busy */
#define                          rxet_reserved_a   291          /* Reserved */
#define                          rxet_reserved_b   292          /* Reserved */
#define                          rxet_reserved_c   293          /* Reserved */
#define                          rxet_reserved_d   294          /* Reserved */
#define                          rxet_reserved_e   295          /* Reserved */
#define                          rxet_reserved_f   296          /* Reserved */
#define                          rxet_reserved_g   297          /* Reserved */
#define                          rxet_reserved_h   298          /* Reserved */
#define                          rxet_reserved_i   299          /* Reserved */
#define                          rxet_reserved_j   300          /* Reserved */
#define                          rxet_reserved_k   301          /* Reserved */
#define                          rxet_reserved_l   302          /* Reserved */
#define                          rxet_reserved_m   303          /* Reserved */
#define                          at_tlb_accesses   304          /* Number of total translation requests */
#define                              at_tlb_miss   305          /* Number of Misses in the TLB cache */
#define                               at_tlb_hit   306          /* Number of Hits in the TLB cache */
#define                            at_tlb_evicts   307          /* Number of TLB cache evictions */
#define                           at_tlb_hits_4k   308          /* Number of hits in the TLB cache for 4K page entries */
#define                           at_tlb_hits_2m   309          /* Number of hits in the TLB cache for 2M page entries */
#define                           at_tlb_hits_1g   310          /* Number of hits in the TLB cache for 1G page entries */
#define                         at_tlb_evicts_4k   311          /* Number of TLB cache evictions for 4K page entries */
#define                         at_tlb_evicts_2m   312          /* Number of TLB cache evictions for 2M page entries */
#define                         at_tlb_evicts_1g   313          /* Number of TLB cache evictions for 1G page entries */
#define                         at_tlb_req_stall   314          /* Number of stalls due to the request FIFO to the IOMMU being full */
#define                        at_tlb_shootdowns   315          /* Number of shutdowns received from software */
#define                            at_reserved_a   316          /* Reserved */
#define                            at_reserved_b   317          /* Reserved */
#define                            at_reserved_c   318          /* Reserved */
#define                            at_reserved_d   319          /* Reserved */
...
#define                         pcim_hpi_req_cnt   352          /* Command Queue Request Count */
#define                     pcim_p2sb_np_req_cnt   353          /* IOSF Sideband Non-posted request count */
#define                     pcim_p2sb_pc_req_cnt   354          /* IOSF Sideband Posted (and Completion) Req Count */
#define                       pcim_iommu_req_cnt   355          /* IOSF Sideband IOMMU Request Count */
#define                          pcim_ur_req_cnt   356          /* IOSF Sideband Unsupported Request Count */
#define                    pcim_hpi_splt_req_cnt   357          /* Unconnected */
#define                   pcim_p2sb_splt_req_cnt   358          /* Unconnected */
#define                          pcim_hpi_fc_cnt   359          /* Command Queue Request Flow Control Cycle Count */
#define                         pcim_p2sb_fc_cnt   360          /* Command IOSF Sideband Flow Control Cycle Count */
#define                       pcim_marb_p_fc_cnt   361          /* PCIe Posted Flow Control Cycle Count */
#define                      pcim_marb_np_fc_cnt   362          /* PCIe Non-Posted Flow Control Cycle Count */
#define                     pcim_marb_cpl_fc_cnt   363          /* PCIe Completion Flow Control Cycle Count */
#define                      pcim_marb_p_req_cnt   364          /* PCIe Posted Flow Control Request Count */
#define                     pcim_marb_np_req_cnt   365          /* PCIe Non-Posted Flow Control Request Count */
#define                    pcim_marb_cpl_req_cnt   366          /* PCIe Completion Flow Control Request Count */
#define                     pcim_io2p_np_req_cnt   367          /* Unconnected */
#define                      pcim_sb2p_p_req_cnt   368          /* IOSF Sideband to PCIe Posted Request Count */
#define                     pcim_sb2p_np_req_cnt   369          /* IOSF Sideband to PCIe Posted Request Count */
#define                    pcim_sb2p_cpl_req_cnt   370          /* IOSF Sideband to PCIe Posted Request Count */
#define                      pcim_init_p_req_cnt   371          /* Unconnected */
#define                     pcim_hpi_cpl_req_cnt   372          /* Command Queue Completion Count */
