...
// SNP_UPSTRM_CFG_BCC_MODE desc:
typedef union {
    struct {
        uint64_t                  VAL  :  1; // Set this to put the LCB into BCC support mode
        uint64_t           Unused_3_1  :  3; // Unused
        uint64_t             RESET_TX  :  1; // Set then Clear this to reset the Tx FIFO pointers using SNP_UPSTRM_CFG_BCC_MODE TX_FIFOS_RADR
        uint64_t           Unused_7_5  :  3; // Unused
        uint64_t             RESET_RX  :  1; // Set then Clear this to reset the Rx FIFO pointers using SNP_UPSTRM_CFG_FIFOS_RADR
        uint64_t          Unused_11_9  :  3; // Unused
        uint64_t        TX_FIFOS_RADR  :  3; // 
        uint64_t            Unused_15  :  1; // Unused
        uint64_t       DISABLE_TX_CLK  :  1; // Set this to turn off the chopped Tx clocks delivered to the BCC
        uint64_t         Unused_19_17  :  3; // Unused
        uint64_t       DISABLE_RX_CLK  :  1; // Set this to turn off the chopped Rx clocks delivered to the BCC
        uint64_t         Unused_63_21  : 43; // Unused
    } field;
    uint64_t val;
} SNP_UPSTRM_CFG_BCC_MODE_t;

// SNP_UPSTRM_CFG_REPLAY_PROTOCOL desc:
typedef union {
    struct {
        uint64_t                 GEN2  :  1; // 
        uint64_t           Unused_3_1  :  3; // Unused
    ...
    uint64_t val;
} SNP_UPSTRM_CFG_REPLAY_PROTOCOL_t;

// SNP_UPSTRM_CFG_FEC_MODE desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_CFG_FEC_MODE_t;

// SNP_UPSTRM_CFG_CLK_DURING_RESET desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_CFG_CLK_DURING_RESET_t;

// SNP_UPSTRM_CFG_FEC_INTERRUPT desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_CFG_FEC_INTERRUPT_t;

// SNP_UPSTRM_CFG_LINK_PARTNER_GEN desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_CFG_LINK_PARTNER_GEN_t;

// SNP_UPSTRM_CFG_LM_MUXSEL desc:
typedef union {
    struct {
        uint64_t         SNPUP_SELECT  :  4; // Logic monitor Mux select for upstream snooper modules 15: TBD ... 0:TBD
        uint64_t           BLK_SELECT  :  3; // Logic monitor Mux select for OC modules 5: 8051_1 4: 8051_0 3: BCC_1 2: BCC_0 1: SNPDWN 0: SNPUP
        uint64_t          BCC_SELECT0  :  3; // Logic monitor Mux select for individual BCC 7: TBD 6: TBD 5: TBD 4: TBD 3: TBD 2: TBD 1: TBD 0: TBD
        uint64_t     BCC_INST_SELECT0  :  2; // Logic monitor Mux select for BCC instance. Select which BCC instance (0-3) to monitor. 3: BCC3 2: BCC2 1: BCC1 0: BCC0
        uint64_t          BCC_SELECT1  :  3; // Logic monitor Mux select for individual BCC 7: TBD 6: TBD 5: TBD 4: TBD 3: TBD 2: TBD 1: TBD 0: TBD
        uint64_t     BCC_INST_SELECT1  :  2; // Logic monitor Mux select for BCC instance. Select which BCC instance (0-3) to monitor. 3: BCC3 2: BCC2 1: BCC1 0: BCC0
        uint64_t      CRK8051_SELECT0  :  3; // Logic monitor Mux select for 8051 7: TBD 6: TBD 5: TBD 4: TBD 3: TBD 2: TBD 1: TBD 0: TBD
        uint64_t      CRK8051_SELECT1  :  3; // Logic monitor Mux select for 8051 7: TBD 6: TBD 5: TBD 4: TBD 3: TBD 2: TBD 1: TBD 0: TBD
        uint64_t         Unused_63_23  : 41; // Unused
    } field;
    uint64_t val;
} SNP_UPSTRM_CFG_LM_MUXSEL_t;

// SNP_UPSTRM_CFG_MISCA desc:
typedef union {
    struct {
...
// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_1 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_1_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_2 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_2_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_3 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_3_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_4 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_4_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_5 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_5_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_6 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_6_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_7 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_7_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_8 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_CNT_8_t;

// SNP_UPSTRM_ERR_INFO_FEC_UERR_CNT desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_UERR_CNT_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_0 desc:
typedef union {
    struct {
        uint64_t                 DATA  : 64; // Bits [63:0] of the error correction vector.
    } field;
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_0_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_1 desc:
typedef union {
    struct {
        uint64_t                 DATA  : 64; // Bits [127:64] of the error correction vector.
    } field;
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_1_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_2 desc:
typedef union {
    struct {
        uint64_t                 DATA  : 64; // Bits [191:128] of the error correction vector.
    } field;
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_2_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_3 desc:
typedef union {
    struct {
        uint64_t                 DATA  : 64; // Bits [255:192] of the error correction vector.
    } field;
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_3_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_4 desc:
typedef union {
    struct {
        uint64_t                 DATA  : 64; // Bits [319:256] of the error correction vector.
    } field;
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_4_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_VLD desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_VLD_t;

// SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_MISS_CNT desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_CERR_MASK_MISS_CNT_t;

// SNP_UPSTRM_ERR_INFO_FEC_ERR_LN0 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_ERR_LN0_t;

// SNP_UPSTRM_ERR_INFO_FEC_ERR_LN1 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_ERR_LN1_t;

// SNP_UPSTRM_ERR_INFO_FEC_ERR_LN2 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_ERR_LN2_t;

// SNP_UPSTRM_ERR_INFO_FEC_ERR_LN3 desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_ERR_INFO_FEC_ERR_LN3_t;

// SNP_UPSTRM_PRF_GOOD_LTP_CNT desc:
typedef union {
    struct {
        uint64_t                  VAL  : 64; // Counts LTPs with a good CRC, rx_ltp_mode only. Cleared with CLR_CRC_ERR_CNTRS.
    } field;
    uint64_t val;
} SNP_UPSTRM_PRF_GOOD_LTP_CNT_t;

// SNP_UPSTRM_PRF_ACCEPTED_LTP_CNT desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_UPSTRM_PRF_ACCEPTED_LTP_CNT_t;

// SNP_UPSTRM_PRF_GOOD_FECCW_CNT desc:
typedef union {
    struct {
        uint64_t                  CNT  : 64; // The number of received code words without errors.
    } field;
    uint64_t val;
} SNP_UPSTRM_PRF_GOOD_FECCW_CNT_t;
...
// SNP_UPSTRM_STS_RX_CRC_FEC_MODE desc:
typedef union {
    struct {
        uint64_t             CRC_MODE  :  2; // 
        uint64_t           Unused_3_2  :  2; // Unused
    ...
    uint64_t val;
} SNP_UPSTRM_STS_RX_CRC_FEC_MODE_t;
