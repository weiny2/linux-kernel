...
typedef union {
    struct {
        uint64_t                   AU  :  3; // The value is written by firmware with the allocation unit (vAU) received from a remote device 0 = 8 Bytes 1 = 16 Bytes 2 = 32 Bytes 3 = 64 Bytes 4 = 128 Bytes 5 = 256 Bytes 6 = 512 Bytes 7 = 1k Bytes
        uint64_t             UNUSED_3  :  1; // 
