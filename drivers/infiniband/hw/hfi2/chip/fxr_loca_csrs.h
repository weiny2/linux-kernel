...
// Created on: Tue May 30 22:20:23 2017
//
...
typedef union {
    struct {
        ...
        uint64_t         VAHIT_THRESH  :  4; // Vector Atomic request cache Hit Threshold. This threshold setting defines number of consecutive VA cache hits needed to define a VA hit trend. PARB uses this trend information to optimize VA request scheduling in the pipeline.
        uint64_t        VAMISS_THRESH  :  4; // Vector Atomic request cache Miss Threshold. This threshold setting defines number of consecutive VA cache misses needed to define a VA miss trend. PARB uses VA trend information to optimize VA request scheduling in the pipeline.
