...
static struct cpuidle_state icl_cstates[] = {
	{
		.name = "C1",
		.desc = "MWAIT 0x00",
		.flags = MWAIT2flg(0x00),
...
static struct cpuidle_state tgl_cstates[] = {
	{
		.name = "C1",
		.desc = "MWAIT 0x00",
		.flags = MWAIT2flg(0x00),
...
static const struct idle_cpu idle_cpu_tgl = {
...
static const struct idle_cpu idle_cpu_icl = {
