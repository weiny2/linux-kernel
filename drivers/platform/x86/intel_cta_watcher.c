...
static int
cta_watcher_start(struct watcher_endpoint *ep)
{
	u32 control;
	 ...
	 */
	control = cta_watcher_get_ctrl_reg(ep);
...
cta_watcher_create_endpoint(struct cta_watcher_priv *priv)
{
	...
	ep->config.control = cta_watcher_get_ctrl_reg(ep);
	cta_watcher_read_period(ep);
