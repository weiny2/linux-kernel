...
#define MXLK_FRAGMENT_SIZE (128 * 1024)
...
struct mxlk_mmio {
	...
	uint8_t htod_phy_id_doorbell_status;
	uint32_t cap_offset;
} __packed;
...
#define MXLK_MMIO_HTOD_PHY_ID_DOORBELL_STATUS \
	        (offsetof(struct mxlk_mmio, htod_phy_id_doorbell_status))
