...
/**
 * dlb2_cq_depth() - query a CQ's depth
 * @hw: dlb2_hw handle for a particular device.
 * @port_id: port ID
...
/**
 * dlb2_write_smon() - write SMON
 * @hw: dlb2_hw handle for a particular device.
 * @args: SMON configuration arguments.
 * @resp: response structure.
 *
 * Configure an SMON for device monitoring.
 */
...
/**
 * dlb2_read_smon() - read SMON
 * @hw: dlb2_hw handle for a particular device.
 * @args: SMON configuration arguments.
 * @resp: response structure.
 *
 * Read an SMON. The user should first configure the SMON using
 * dlb2_write_smon().
 */
...
/**
 * dlb2_hw_disable_sparse_ldb_cq_mode() - disable sparse mode for load-balanced
 *	ports.
 * @hw: dlb2_hw handle for a particular device.
 *
 * This function must be called prior to configuring scheduling domains.
...
/**
 * dlb2_hw_disable_sparse_dir_cq_mode() - disable sparse mode for directed
 *	ports.
 * @hw: dlb2_hw handle for a particular device.
 *
 * This function must be called prior to configuring scheduling domains.
