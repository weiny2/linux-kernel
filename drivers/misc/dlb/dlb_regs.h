...
#define DLB_SYS_SMON_COMP_MASK1 0x3024
#define DLB_SYS_SMON_COMP_MASK1_RST 0xffffffff
union dlb_sys_smon_comp_mask1 {
	struct {
		u32 comp_mask1 : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_COMP_MASK0 0x3020
#define DLB_SYS_SMON_COMP_MASK0_RST 0xffffffff
union dlb_sys_smon_comp_mask0 {
	struct {
		u32 comp_mask0 : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_MAX_TMR 0x301c
#define DLB_SYS_SMON_MAX_TMR_RST 0x0
union dlb_sys_smon_max_tmr {
	struct {
		u32 maxvalue : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_TMR 0x3018
#define DLB_SYS_SMON_TMR_RST 0x0
union dlb_sys_smon_tmr {
	struct {
		u32 timer_val : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_ACTIVITYCNTR1 0x3014
#define DLB_SYS_SMON_ACTIVITYCNTR1_RST 0x0
union dlb_sys_smon_activitycntr1 {
	struct {
		u32 counter1 : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_ACTIVITYCNTR0 0x3010
#define DLB_SYS_SMON_ACTIVITYCNTR0_RST 0x0
union dlb_sys_smon_activitycntr0 {
	struct {
		u32 counter0 : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_COMPARE1 0x300c
#define DLB_SYS_SMON_COMPARE1_RST 0x0
union dlb_sys_smon_compare1 {
	struct {
		u32 compare1 : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_COMPARE0 0x3008
#define DLB_SYS_SMON_COMPARE0_RST 0x0
union dlb_sys_smon_compare0 {
	struct {
		u32 compare0 : 32;
	} field;
	u32 val;
...
#define DLB_SYS_SMON_CFG1 0x3004
#define DLB_SYS_SMON_CFG1_RST 0x0
union dlb_sys_smon_cfg1 {
	struct {
		u32 mode0 : 8;
		u32 mode1 : 8;
		u32 rsvd : 16;
...
#define DLB_SYS_SMON_CFG0 0x3000
#define DLB_SYS_SMON_CFG0_RST 0x40000000
union dlb_sys_smon_cfg0 {
	struct {
		u32 smon_enable : 1;
		u32 rsvd2 : 3;
...
#define DLB_CHP_SMON_MAX_TMR 0xa8000150
#define DLB_CHP_SMON_MAX_TMR_RST 0x0
union dlb_chp_smon_max_tmr {
	struct {
		u32 maxvalue : 32;
	} field;
	u32 val;
...
#define DLB_CHP_SMON_TMR 0xa800014c
#define DLB_CHP_SMON_TMR_RST 0x0
union dlb_chp_smon_tmr {
	struct {
		u32 timer : 32;
	} field;
	u32 val;
...
#define DLB_CHP_SMON_CNTR1 0xa8000148
#define DLB_CHP_SMON_CNTR1_RST 0x0
union dlb_chp_smon_cntr1 {
	struct {
		u32 counter1 : 32;
	} field;
	u32 val;
...
#define DLB_CHP_SMON_CNTR0 0xa8000144
#define DLB_CHP_SMON_CNTR0_RST 0x0
union dlb_chp_smon_cntr0 {
	struct {
		u32 counter0 : 32;
	} field;
	u32 val;
...
#define DLB_CHP_SMON_COMPARE1 0xa8000140
#define DLB_CHP_SMON_COMPARE1_RST 0x0
union dlb_chp_smon_compare1 {
	struct {
		u32 compare1 : 32;
	} field;
	u32 val;
...
#define DLB_CHP_SMON_COMPARE0 0xa800013c
#define DLB_CHP_SMON_COMPARE0_RST 0x0
union dlb_chp_smon_compare0 {
	struct {
		u32 compare0 : 32;
	} field;
	u32 val;
...
#define DLB_CHP_SMON_CFG1 0xa8000138
#define DLB_CHP_SMON_CFG1_RST 0x0
union dlb_chp_smon_cfg1 {
	struct {
		u32 mode0 : 8;
		u32 mode1 : 8;
		u32 spare0 : 16;
...
#define DLB_CHP_SMON_CFG0 0xa8000134
#define DLB_CHP_SMON_CFG0_RST 0x40000000
union dlb_chp_smon_cfg0 {
	struct {
		u32 smon_enable : 1;
