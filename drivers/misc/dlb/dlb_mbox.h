...
struct dlb_mbox_init_cq_sched_count_measure_cmd_req {
	struct dlb_mbox_req_hdr hdr;
	u32 duration_us;
};

struct dlb_mbox_init_cq_sched_count_measure_cmd_resp {
	struct dlb_mbox_resp_hdr hdr;
	u32 error_code;
};

struct dlb_mbox_collect_cq_sched_count_cmd_req {
	struct dlb_mbox_req_hdr hdr;
	u16 cq_id;
	u16 is_ldb;
};

struct dlb_mbox_collect_cq_sched_count_cmd_resp {
	struct dlb_mbox_resp_hdr hdr;
	u32 error_code;
	u32 elapsed;
	u32 padding;
