...
static const struct pinctrl_pin_desc ebg_pins[] = {
	...
	PINCTRL_PIN(102, "ADR_TRIGGER"),
	PINCTRL_PIN(103, "MPCH_SYNC"),
	...
	/* GPP_E */
	PINCTRL_PIN(112, "SATA2_XPCIE_0"),
	PINCTRL_PIN(113, "SATA2_XPCIE_1"),
	PINCTRL_PIN(114, "SATA2_XPCIE_2"),
	PINCTRL_PIN(115, "SATA2_XPCIE_3"),
	PINCTRL_PIN(116, "SATA1_XPCIE_2"),
	PINCTRL_PIN(117, "SATA1_XPCIE_3"),
	PINCTRL_PIN(118, "SATA1_USB3_XPCIE_0"),
	PINCTRL_PIN(119, "SATA1_USB3_XPCIE_1"),
	PINCTRL_PIN(120, "SATA1_SCLOCK"),
	PINCTRL_PIN(121, "SATA1_SLOAD"),
	PINCTRL_PIN(122, "SATA1_SDATAOUT"),
	PINCTRL_PIN(123, "SATA2_SCLOCK"),
	PINCTRL_PIN(124, "SATA2_SLOAD"),
	PINCTRL_PIN(125, "SATA2_SDATAOUT"),
	PINCTRL_PIN(126, "SATA3_SCLOCK"),
	PINCTRL_PIN(127, "SATA3_SLOAD"),
	PINCTRL_PIN(128, "SATA3_SDATAOUT"),
	...
	PINCTRL_PIN(211, "PM_SYNC_1"),
	PINCTRL_PIN(212, "PM_DOWN_1"),
	PINCTRL_PIN(213, "PM_SYNC_CLK_1"),
	PINCTRL_PIN(214, "PM_SYNC_2"),
	PINCTRL_PIN(215, "PM_DOWN_2"),
	PINCTRL_PIN(216, "PM_SYNC_CLK_2"),
	...
	/* GPP_M */
	PINCTRL_PIN(226, "PM_SYNC_3"),
	PINCTRL_PIN(227, "PM_DOWN_3"),
	PINCTRL_PIN(228, "PM_SYNC_CLK_3"),
	PINCTRL_PIN(229, "PM_SYNC_4"),
	PINCTRL_PIN(230, "PM_DOWN_4"),
	PINCTRL_PIN(231, "PM_SYNC_CLK_4"),
	PINCTRL_PIN(232, "PM_SYNC_5"),
	PINCTRL_PIN(233, "PM_DOWN_5"),
	PINCTRL_PIN(234, "PM_SYNC_CLK_5"),
	...
	/* GPP_N */
	PINCTRL_PIN(244, "PM_SYNC_6"),
	PINCTRL_PIN(245, "PM_DOWN_6"),
	PINCTRL_PIN(246, "PM_SYNC_CLK_6"),
	PINCTRL_PIN(247, "PM_SYNC_7"),
	PINCTRL_PIN(248, "PM_DOWN_7"),
	PINCTRL_PIN(249, "PM_SYNC_CLK_7"),
...
static const struct intel_pingroup ebg_groups[] = {
	/* PLACE HOLDER */
};

static const struct intel_function ebg_functions[] = {
	/* PLACE HOLDER */
};
...
static const struct intel_pinctrl_soc_data ebg_soc_data = {
	...
	.groups = ebg_groups,
	.ngroups = ARRAY_SIZE(ebg_groups),
	.functions = ebg_functions,
	.nfunctions = ARRAY_SIZE(ebg_functions),
