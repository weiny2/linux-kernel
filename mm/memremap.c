...
static int __init __dev_page_protection_init(void)
{
	...
	/* start out protected */
	update_local_sup_key(pkey, PKEY_DISABLE_ACCESS | PKEY_DISABLE_WRITE);
	dev_page_pkey = pkey;

	return 0;
}
late_initcall(__dev_page_protection_init);
