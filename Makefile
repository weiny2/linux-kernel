...
hfi-y := cq.o diag.o dma.o driver.o file_ops.o firmware.o fs.o init.o intr.o \
	...
	user_sdma.o verbs_mcast.o verbs.o wfr.o device.o trace.o
...
HDRS= common.h hfi.h mad.h qsfp.h user_sdma.h verbs.h trace.h

SRCS= cq.c diag.c dma.c driver.c file_ops.c fs.c init.c intr.c keys.c mad.c mmap.c mr.c pcie.c pio.c pio_copy.c qp.c qsfp.c rc.c ruc.c sdma.c srq.c sysfs.c twsi.c tx.c uc.c ud.c user_pages.c user_sdma.c verbs.c verbs_mcast.c wc_ppc64.c wc_x86_64.c wfr.c trace.c
