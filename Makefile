...
hfi-$(CONFIG_PCI_MSI) += qib_iba6120.o
...
HDRS= qib_6120_regs.h qib_7220.h qib_7220_regs.h qib_7322_regs.h qib_common.h qib.h qib_mad.h qib_qsfp.h qib_user_sdma.h qib_verbs.h 

SRCS= qib_cq.c qib_diag.c qib_dma.c qib_driver.c qib_eeprom.c qib_file_ops.c qib_fs.c qib_iba6120.c qib_iba7220.c qib_iba7322.c qib_init.c qib_intr.c qib_keys.c qib_mad.c qib_mmap.c qib_mr.c qib_pcie.c qib_pio_copy.c qib_qp.c qib_qsfp.c qib_rc.c qib_ruc.c qib_sd7220.c qib_sdma.c qib_srq.c qib_sysfs.c qib_twsi.c qib_tx.c qib_uc.c qib_ud.c qib_user_pages.c qib_user_sdma.c qib_verbs.c qib_verbs_mcast.c qib_wc_ppc64.c qib_wc_x86_64.c
