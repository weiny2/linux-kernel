...
#define SECONDARY_EXEC_NO_COMMIT_EXITING	VMCS_CONTROL_BIT(NO_COMMIT_EXITING)
...
enum vmcs_field {
	...
	NO_COMMIT_THRESHOLD             = 0x00004024,
...
/*
 * Exit Qualifications for No Commit
 */
#define NO_COMMIT_VM_CONTEXT_VALID     BIT(0)
