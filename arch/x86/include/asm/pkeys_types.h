...
/*
 * Make the default PKRS value for INIT_THREAD or init MSR:
 ...
 */
#define init_pkrs_value (PKRU_AD_KEY(1) | PKRU_AD_KEY(2) | PKRU_AD_KEY(3) |    \
...
#define INIT_THREAD_PKRS	.pkrs = init_pkrs_value,
#else
