 ...
 * handlers use those interfaces for memory access.  Start off the exception
 * handler ref count to 0 and ensure it is 0 when the exception is done.  Then
 * restore it for the interrupted task.
 */
