...
* --   /p/slx/pvesv/wfr_autogen/utils/scripts/i_csrs/i_csrs.pl -C -output=/p/slx/pvesv/wfr_autogen/wfr -l=0 /p/slx/pvesv/wfr_autogen/SL1_fixed_xml/WFR/231_ASIC_Registers.xml /p/slx/pvesv/wfr_autogen/SL1_fixed_xml/WFR_DBG/730_ASIC_Debug_Registers.xml  
* --------------------------------------------------------------------
*/
...
#define ASIC_DEBUG_OFFSET								0X0080000
/*
* Table #5 of 231_ASIC_Registers.xml - ASIC_CFG_SBUS_REQUEST
...
/*
* Table #6 of 231_ASIC_Registers.xml - ASIC_CFG_SBUS_EXECUTE
...
/*
* Table #7 of 231_ASIC_Registers.xml - ASIC_STS_SBUS_RESULT
...
/*
* Table #8 of 231_ASIC_Registers.xml - ASIC_STS_SBUS_COUNTERS
...
/*
* Table #9 of 231_ASIC_Registers.xml - ASIC_CFG_SCRATCH
...
/*
* Table #10 of 231_ASIC_Registers.xml - ASIC_CFG_MUTEX
...
/*
* Table #12 of 231_ASIC_Registers.xml - ASIC_CFG_DRV_STR
* The fields in this CSR correspond to bits [33:0] of EfuseDrvStr in #%%#Section 
* 18.1, #%%#'EFUSE'#%%# and #%%#Section 15.8.3.64, #%%#'ASIC_WFR_EFUSE_REGS11'#%%#. 
...
/*
* Table #13 of 231_ASIC_Registers.xml - ASIC_CFG_THERM_POLL_EN
...
/*
* Table #14 of 231_ASIC_Registers.xml - ASIC_STS_THERM
...
/*
* Table #15 of 231_ASIC_Registers.xml - ASIC_CFG_RESET
...
/*
* Table #24 of 231_ASIC_Registers.xml - ASIC_PCIE_SD_INTRPT_LIST
...
/*
* Table #25 of 231_ASIC_Registers.xml - ASIC_GPIO_IN
...
/*
* Table #26 of 231_ASIC_Registers.xml - ASIC_GPIO_OE
...
/*
* Table #27 of 231_ASIC_Registers.xml - ASIC_GPIO_INVERT
...
/*
* Table #28 of 231_ASIC_Registers.xml - ASIC_GPIO_OUT
...
/*
* Table #29 of 231_ASIC_Registers.xml - ASIC_GPIO_MASK
...
/*
* Table #30 of 231_ASIC_Registers.xml - ASIC_GPIO_STATUS
...
/*
* Table #31 of 231_ASIC_Registers.xml - ASIC_GPIO_CLEAR
...
/*
* Table #32 of 231_ASIC_Registers.xml - ASIC_GPIO_FORCE
...
/*
* Table #33 of 231_ASIC_Registers.xml - ASIC_QSFP1_IN
...
/*
* Table #34 of 231_ASIC_Registers.xml - ASIC_QSFP1_OE
...
/*
* Table #35 of 231_ASIC_Registers.xml - ASIC_QSFP1_INVERT
...
/*
* Table #36 of 231_ASIC_Registers.xml - ASIC_QSFP1_OUT
...
/*
* Table #37 of 231_ASIC_Registers.xml - ASIC_QSFP1_MASK
...
/*
* Table #38 of 231_ASIC_Registers.xml - ASIC_QSFP1_STATUS
...
/*
* Table #39 of 231_ASIC_Registers.xml - ASIC_QSFP1_CLEAR
...
/*
* Table #40 of 231_ASIC_Registers.xml - ASIC_QSFP1_FORCE
...
/*
* Table #41 of 231_ASIC_Registers.xml - ASIC_QSFP2_IN
...
/*
* Table #42 of 231_ASIC_Registers.xml - ASIC_QSFP2_OE
...
/*
* Table #43 of 231_ASIC_Registers.xml - ASIC_QSFP2_INVERT
...
/*
* Table #44 of 231_ASIC_Registers.xml - ASIC_QSFP2_OUT
...
/*
* Table #45 of 231_ASIC_Registers.xml - ASIC_QSFP2_MASK
...
/*
* Table #46 of 231_ASIC_Registers.xml - ASIC_QSFP2_STATUS
...
/*
* Table #47 of 231_ASIC_Registers.xml - ASIC_QSFP2_CLEAR
...
/*
* Table #48 of 231_ASIC_Registers.xml - ASIC_QSFP2_FORCE
...
/*
* Table #49 of 231_ASIC_Registers.xml - ASIC_EEP_CTL_STAT
* This CSR is the control and status register for the EEPROM/FLASH interface 
* (see also #%%#Section 16.1.3.84, #%%#'PcieEepCtlStat'#%%#).
*/
...
/*
* Table #50 of 231_ASIC_Registers.xml - ASIC_EEP_ADDR_CMD
* This CSR is the address and command register for the EEPROM/FLASH interface 
* (see also #%%#Section 16.1.3.85, #%%#'PcieEepAddrCmd'#%%#).
*/
...
/*
* Table #51 of 231_ASIC_Registers.xml - ASIC_EEP_DATA
* This CSR is the read/write data register for the EEPROM/FLASH interface (see 
* also #%%#Section 16.1.3.86, #%%#'PcieEepData'#%%#). The 32-bit read/write 
...
/*
* Table #52 of 231_ASIC_Registers.xml - ASIC_MAN_EFUSE0
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to the 4 kilobit MAN_EFUSE array using 64 x 64-bit CSRs. The first 4 
* CSRs are specified at the field level, and the remaining 60 CSRs are specified 
* as an array since the fields are reserved by the manufacturing partner. More 
* information is provided in #%%#Section 18.1, #%%#'EFUSE'#%%#.
*/
...
/*
* Table #53 of 231_ASIC_Registers.xml - ASIC_MAN_EFUSE1
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to the 4 kilobit MAN_EFUSE array using 64 x 64-bit CSRs. The first 4 
* CSRs are specified at the field level, and the remaining 60 CSRs are specified 
* as an array since the fields are reserved by the manufacturing partner. More 
...
#define WFR_ASIC_MAN_EFUSE1_EFUSE_DISABLE_PLL_TIMEOUT_SHIFT				49
#define WFR_ASIC_MAN_EFUSE1_EFUSE_DISABLE_PLL_TIMEOUT_MASK				0x1ull
#define WFR_ASIC_MAN_EFUSE1_EFUSE_DISABLE_PLL_TIMEOUT_SMASK				0x2000000000000ull
...
/*
* Table #54 of 231_ASIC_Registers.xml - ASIC_MAN_EFUSE2
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to the 4 kilobit MAN_EFUSE array using 64 x 64-bit CSRs. The first 4 
* CSRs are specified at the field level, and the remaining 60 CSRs are specified 
* as an array since the fields are reserved by the manufacturing partner. More 
...
/*
* Table #55 of 231_ASIC_Registers.xml - ASIC_MAN_EFUSE3
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to the 4 kilobit MAN_EFUSE array using 64 x 64-bit CSRs. The first 4 
* CSRs are specified at the field level, and the remaining 60 CSRs are specified 
* as an array since the fields are reserved by the manufacturing partner. More 
...
#define WFR_ASIC_MAN_EFUSE3_EFUSE_DFD_LOCK_ENABLE_SHIFT					47
#define WFR_ASIC_MAN_EFUSE3_EFUSE_DFD_LOCK_ENABLE_MASK					0x1ull
#define WFR_ASIC_MAN_EFUSE3_EFUSE_DFD_LOCK_ENABLE_SMASK					0x800000000000ull
...
/*
* Table #56 of 231_ASIC_Registers.xml - ASIC_MAN_EFUSE4TO63
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to the 4 kilobit MAN_EFUSE array using 64 x 64-bit CSRs. The first 4 
* CSRs are specified at the field level, and the remaining 60 CSRs are specified 
* as an array since the fields are reserved by the manufacturing partner. More 
...
/*
* Table #57 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to the 4 kilobit WFR_EFUSE array using 64 x 64-bit CSRs. The first 1 
* kilobit of this array has the same structure as the 16 WFR_EFUSE_REGS CSRs but 
* contains the EFUSE values prior to application of patches and overrides. Note 
* that the reset value of 0x0 corresponds to no fuses blown. The interpretation 
* of the EFUSE values is described in #%%#Section 18.1, #%%#'EFUSE'#%%#.
*/
...
/*
* Table #58 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS0
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
*/
...
/*
* Table #59 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS1
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
#define WFR_ASIC_WFR_EFUSE_REGS1_EFUSE_XMT_MARGIN_GEN1_GEN2_SHIFT			13
#define WFR_ASIC_WFR_EFUSE_REGS1_EFUSE_XMT_MARGIN_GEN1_GEN2_MASK			0x7ull
#define WFR_ASIC_WFR_EFUSE_REGS1_EFUSE_XMT_MARGIN_GEN1_GEN2_SMASK			0xE000ull
#define WFR_ASIC_WFR_EFUSE_REGS1_EFUSE_XMT_MARGIN_GEN1_GEN2_OVERWRITE_ENABLE_SHIFT	12
#define WFR_ASIC_WFR_EFUSE_REGS1_EFUSE_XMT_MARGIN_GEN1_GEN2_OVERWRITE_ENABLE_MASK	0x1ull
#define WFR_ASIC_WFR_EFUSE_REGS1_EFUSE_XMT_MARGIN_GEN1_GEN2_OVERWRITE_ENABLE_SMASK	0x1000ull
...
/*
* Table #60 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS2
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #61 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS3
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #62 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS4
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #63 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS5
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #64 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS6
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #65 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS7
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #66 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS8
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #67 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS9
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #68 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS10
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
#define WFR_ASIC_WFR_EFUSE_REGS10_PCIE_LANE_DELAY_SHIFT					60
#define WFR_ASIC_WFR_EFUSE_REGS10_PCIE_LANE_DELAY_MASK					0xFull
#define WFR_ASIC_WFR_EFUSE_REGS10_PCIE_LANE_DELAY_SMASK					0xF000000000000000ull
...
#define WFR_ASIC_WFR_EFUSE_REGS10_PCIE_LANE_BUNDLE_SHIFT				38
#define WFR_ASIC_WFR_EFUSE_REGS10_PCIE_LANE_BUNDLE_MASK					0x3ull
#define WFR_ASIC_WFR_EFUSE_REGS10_PCIE_LANE_BUNDLE_SMASK				0xC000000000ull
...
/*
* Table #69 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS11
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown. The intention is 
* that the reserved EFUSE bits are set aside for any additional programmable 
* drive strengths that might be added later.
*/
...
/*
* Table #70 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS12
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #71 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS13
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
#define WFR_ASIC_WFR_EFUSE_REGS13_EFUSE_PCIE_SD_INTRPT1_SHIFT				32
#define WFR_ASIC_WFR_EFUSE_REGS13_EFUSE_PCIE_SD_INTRPT1_MASK				0xFFFFFFFFull
#define WFR_ASIC_WFR_EFUSE_REGS13_EFUSE_PCIE_SD_INTRPT1_SMASK				0xFFFFFFFF00000000ull
#define WFR_ASIC_WFR_EFUSE_REGS13_EFUSE_PCIE_SD_INTRPT0_SHIFT				0
#define WFR_ASIC_WFR_EFUSE_REGS13_EFUSE_PCIE_SD_INTRPT0_MASK				0xFFFFFFFFull
#define WFR_ASIC_WFR_EFUSE_REGS13_EFUSE_PCIE_SD_INTRPT0_SMASK				0xFFFFFFFFull
/*
* Table #72 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS14
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #73 of 231_ASIC_Registers.xml - ASIC_WFR_EFUSE_REGS15
* EFUSE information must not be disclosed beyond Intel.#%%#This CSR provides RO 
* access to 64 bits of the 1 kilobit registers called WFR_EFUSE_REGS. These are 
* the WFR_EFUSE values after patching and over-rides have been applied. Note 
* that the reset value of 0x0 corresponds to no fuses blown.
...
/*
* Table #76 of 730_ASIC_Debug_Registers.xml - ASIC_DBG_RSVD1
* This CSR is used as template.
*/
#define WFR_ASIC_DBG_RSVD1								(WFR_ASIC + 0x000000080000)
#define WFR_ASIC_DBG_RSVD1_RESETCSR							0x0000000000000000ull
/*
* Table #77 of 730_ASIC_Debug_Registers.xml - ASIC_DBG_RSVD2
* This CSR is used as template.
*/
#define WFR_ASIC_DBG_RSVD2								(WFR_ASIC + 0x000000080008)
#define WFR_ASIC_DBG_RSVD2_RESETCSR							0x0000000000000000ull
