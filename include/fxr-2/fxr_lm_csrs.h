...
// File:       fxr_lm_csrs.h                                                   
// Creator:    pvesvslx                                                        
// Time:       Friday Aug 1, 2014 [11:06:08 am]                                
//                                                                             
...
//                                                                             
// Sources:    /tmp/pvesvslx/nebulon_run/30229/fxr_lm.rdlh                     
//             /tmp/pvesvslx/nebulon_run/30229/lib_udp.rdl                     
//             /tmp/pvesvslx/nebulon_run/30229/fxr_lm.rdl                      
...
// LM_PKEY_ARRAY_PORT1 desc:  This array consists of a 64 entry CAM, with each entry having a bit
// to indicate if it is a full or limited member of the partition. A
// parity bit is also stored to cover the CAM entry, and the parity of
// the low 15 bits of the incoming PKEY is checked before allowing a
// match. CAM entries that are invalid will contain 0x0000 in the low
...
typedef struct {
    ...
    LM_PKEY_ARRAY_PORT0_t      LM_PKEY_ARRAY_PORT0[64]; // offset 16'h9000, width 64
    ...
    LM_PKEY_ARRAY_PORT1_t      LM_PKEY_ARRAY_PORT1[64]; // offset 20'h11000, width 64
} fxr_lm_csrs_t;                                 // size:  20'h11200
