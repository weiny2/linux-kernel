...
#define WFR_PCIE_CFG_REG_PL67_RESETCSR					0x0001100Full
...
#define WFR_PCIE_CFG_REG_PL67_AUTO_LANE_FLIP_CTRL_EN_SHIFT		16
#define WFR_PCIE_CFG_REG_PL67_AUTO_LANE_FLIP_CTRL_EN_MASK		0x1ull
#define WFR_PCIE_CFG_REG_PL67_AUTO_LANE_FLIP_CTRL_EN_SMASK		0x10000ull
#define WFR_PCIE_CFG_REG_PL67_PRE_DET_LANE_SHIFT			13
#define WFR_PCIE_CFG_REG_PL67_PRE_DET_LANE_MASK				0x7ull
#define WFR_PCIE_CFG_REG_PL67_PRE_DET_LANE_SMASK			0xE000ull
#define WFR_PCIE_CFG_REG_PL67_NUM_OF_LANES_SHIFT			8
#define WFR_PCIE_CFG_REG_PL67_NUM_OF_LANES_MASK				0x1Full
#define WFR_PCIE_CFG_REG_PL67_NUM_OF_LANES_SMASK			0x1F00ull
...
* PCI configuration register for port logic, number 69 (PHY Status). More detail 
* for this CSR can be found in the WFR MAS.
*/
...
* PCI configuration register for port logic, number 70 (PHY Control). More 
* detail for this CSR can be found in the WFR MAS.
*/
...
* PCI configuration register for port logic, number 100 (PCIe Gen3 Control 
* Register).
*/
...
* PCI configuration register for port logic, number 101 (PCIe Gen3 Equalization 
* FS and LF Register).
*/
...
* PCI configuration register for port logic, number 102 (PCIe Gen3 Equalization 
...
* PcieCfgRegPl103. All 11 preset values are persistent (i.e. /P 
* behavior).
*/
#define WFR_PCIE_CFG_REG_PL102						(WFR_PCIE + 0x000000000898)
#define WFR_PCIE_CFG_REG_PL102_RESETCSR					0x0000C800ull
...
* PCI configuration register for port logic, number 103 (PCIe Gen3 Equalization 
...
* PCI configuration register for port logic, number 105 (PCIe Gen3 Equalization 
...
* PCI configuration register for port logic, number 106 (PCIe Gen3 Equalization 
* Control Register).
*/
...
* This bit can be used to enable/disable the DBI/DBI2 mechanism.#%%#Recommend 
* dropping description of the DBI/DBI2 mechanism before disclosure beyond 
* Intel.#%%#PCI configuration register for port logic, number 111 (Misc Control 
* 1 Register).
*/
...
* (see also #%%#Section 14.9.3.44, #%%#'ASIC_EEP_CTL_STAT'#%%#).
*/
...
* (see also #%%#Section 14.9.3.45, #%%#'ASIC_EEP_ADDR_CMD'#%%#).
*/
...
* also #%%#Section 14.9.3.46, #%%#'ASIC_EEP_DATA'#%%#). The 32-bit read/write 
