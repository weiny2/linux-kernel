...
* --   /p/slx/pvesv/wfr_autogen/utils/scripts/i_csrs/i_csrs.pl -C -output=/p/slx/pvesv/wfr_autogen/wfr -l=0 /p/slx/pvesv/wfr_autogen/SL1_fixed_xml/WFR/231_ASIC_Registers.xml  
* --------------------------------------------------------------------
*/
...
* (see also #%%#Section 15.1.3.84, #%%#'PcieEepCtlStat'#%%#).
*/
...
* (see also #%%#Section 15.1.3.85, #%%#'PcieEepAddrCmd'#%%#).
*/
...
* also #%%#Section 15.1.3.86, #%%#'PcieEepData'#%%#). The 32-bit read/write 
