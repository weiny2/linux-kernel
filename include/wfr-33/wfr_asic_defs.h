...
* 18.1, #%%#'EFUSE'#%%# and #%%#Section 15.8.3.63, #%%#'ASIC_WFR_EFUSE_REGS11'#%%#. 
...
/*
* Table #16 of 231_ASIC_Registers.xml - ASIC_CFG_RESET
...
/*
* Table #17 of 231_ASIC_Registers.xml - ASIC_PCIE_SD_HOST_CMD
...
/*
* Table #18 of 231_ASIC_Registers.xml - ASIC_PCIE_SD_HOST_STATUS
...
/*
* Table #19 of 231_ASIC_Registers.xml - ASIC_PCIE_SD_INTRPT_DATA_CODE
...
/*
* Table #20 of 231_ASIC_Registers.xml - ASIC_PCIE_SD_INTRPT_ENABLE
...
/*
* Table #21 of 231_ASIC_Registers.xml - ASIC_PCIE_SD_INTRPT_PROGRESS
...
/*
* Table #22 of 231_ASIC_Registers.xml - ASIC_PCIE_SD_INTRPT_STATUS
...
/*
* Table #23 of 231_ASIC_Registers.xml - ASIC_HFI0_PCIE_SD_INTRPT_RSPD_DATA
...
/*
* Table #24 of 231_ASIC_Registers.xml - ASIC_HFI1_PCIE_SD_INTRPT_RSPD_DATA
...
* (see also #%%#Section 16.1.3.86, #%%#'PcieEepCtlStat'#%%#).
*/
...
* (see also #%%#Section 16.1.3.87, #%%#'PcieEepAddrCmd'#%%#).
*/
...
* also #%%#Section 16.1.3.88, #%%#'PcieEepData'#%%#).
*/
