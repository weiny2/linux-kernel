...
/*
* Table #101 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaSendBuffer
* This is read only memory for SDMA Send Buffer.
*/
#define WFR_SEND_DMA_SEND_BUFFER								(WFR_TXE + 0x000000300000)
#define WFR_SEND_DMA_SEND_BUFFER_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_SEND_BUFFER_DATA_SHIFT							0
#define WFR_SEND_DMA_SEND_BUFFER_DATA_MASK							0xFFFFFFFFFFFFFFFFull
#define WFR_SEND_DMA_SEND_BUFFER_DATA_SMASK							0xFFFFFFFFFFFFFFFFull
/*
* Table #103 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgCredits
* This CSR is used to specify the number of credits available for both the PCIe 
* interface and the header update interface. These values are not expected to be 
* changed and configuration access is only provided to allow these to be set 
* lower in the event of a logic bug.
*/
#define WFR_SEND_DMA_DBG_CREDITS								(WFR_TXE + 0x000000380000)
#define WFR_SEND_DMA_DBG_CREDITS_RESETCSR							0x0000000000000048ull
#define WFR_SEND_DMA_DBG_CREDITS_HEADER_CREDITS_SHIFT						4
#define WFR_SEND_DMA_DBG_CREDITS_HEADER_CREDITS_MASK						0x7ull
#define WFR_SEND_DMA_DBG_CREDITS_HEADER_CREDITS_SMASK						0x70ull
#define WFR_SEND_DMA_DBG_CREDITS_PCIE_CREDITS_SHIFT						0
#define WFR_SEND_DMA_DBG_CREDITS_PCIE_CREDITS_MASK						0xFull
#define WFR_SEND_DMA_DBG_CREDITS_PCIE_CREDITS_SMASK						0xFull
/*
* Table #104 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgRpyTag
* This CSR is used to log error information in the event of a reply tag error. 
...
*/
#define WFR_SEND_DMA_DBG_RPY_TAG								(WFR_TXE + 0x000000380008)
#define WFR_SEND_DMA_DBG_RPY_TAG_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_RPY_TAG_TIMEOUT_TAG_SHIFT						24
#define WFR_SEND_DMA_DBG_RPY_TAG_TIMEOUT_TAG_MASK						0xFFull
#define WFR_SEND_DMA_DBG_RPY_TAG_TIMEOUT_TAG_SMASK						0xFF000000ull
#define WFR_SEND_DMA_DBG_RPY_TAG_UNEXP_TIMEOUT_TAG_SHIFT					16
#define WFR_SEND_DMA_DBG_RPY_TAG_UNEXP_TIMEOUT_TAG_MASK						0x1ull
#define WFR_SEND_DMA_DBG_RPY_TAG_UNEXP_TIMEOUT_TAG_SMASK					0x10000ull
#define WFR_SEND_DMA_DBG_RPY_TAG_HV_TAG_SHIFT							8
#define WFR_SEND_DMA_DBG_RPY_TAG_HV_TAG_MASK							0xFFull
#define WFR_SEND_DMA_DBG_RPY_TAG_HV_TAG_SMASK							0xFF00ull
#define WFR_SEND_DMA_DBG_RPY_TAG_UNEXP_HV_TAG_SHIFT						0
#define WFR_SEND_DMA_DBG_RPY_TAG_UNEXP_HV_TAG_MASK						0x1ull
#define WFR_SEND_DMA_DBG_RPY_TAG_UNEXP_HV_TAG_SMASK						0x1ull
/*
* Table #105 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgCsrInfo
* This CSR is used to log error information in the event of a CSR parity error. 
* This information is only captured when the corresponding error status bit 
* transitions from a 0 to a 1, if the error status bit was already set the 
* information in this CSR is not updated.
*/
#define WFR_SEND_DMA_DBG_CSR_INFO								(WFR_TXE + 0x000000380010)
#define WFR_SEND_DMA_DBG_CSR_INFO_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_CSR_INFO_DATA_PARITY_SHIFT						32
#define WFR_SEND_DMA_DBG_CSR_INFO_DATA_PARITY_MASK						0x3ull
#define WFR_SEND_DMA_DBG_CSR_INFO_DATA_PARITY_SMASK						0x300000000ull
#define WFR_SEND_DMA_DBG_CSR_INFO_ADDRESS_PARITY_SHIFT						30
#define WFR_SEND_DMA_DBG_CSR_INFO_ADDRESS_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_CSR_INFO_ADDRESS_PARITY_SMASK						0x40000000ull
#define WFR_SEND_DMA_DBG_CSR_INFO_ADDRESS_SHIFT							4
#define WFR_SEND_DMA_DBG_CSR_INFO_ADDRESS_MASK							0x3FFFFFFull
#define WFR_SEND_DMA_DBG_CSR_INFO_ADDRESS_SMASK							0x3FFFFFF0ull
#define WFR_SEND_DMA_DBG_CSR_INFO_DATA_ERR_SHIFT						3
#define WFR_SEND_DMA_DBG_CSR_INFO_DATA_ERR_MASK							0x1ull
#define WFR_SEND_DMA_DBG_CSR_INFO_DATA_ERR_SMASK						0x8ull
#define WFR_SEND_DMA_DBG_CSR_INFO_WRITE_BUS_DATA_ERR_SHIFT					2
#define WFR_SEND_DMA_DBG_CSR_INFO_WRITE_BUS_DATA_ERR_MASK					0x1ull
#define WFR_SEND_DMA_DBG_CSR_INFO_WRITE_BUS_DATA_ERR_SMASK					0x4ull
#define WFR_SEND_DMA_DBG_CSR_INFO_WRITE_BUS_ADD_ERR_SHIFT					1
#define WFR_SEND_DMA_DBG_CSR_INFO_WRITE_BUS_ADD_ERR_MASK					0x1ull
#define WFR_SEND_DMA_DBG_CSR_INFO_WRITE_BUS_ADD_ERR_SMASK					0x2ull
#define WFR_SEND_DMA_DBG_CSR_INFO_READ_BUS_ADD_ERR_SHIFT					0
#define WFR_SEND_DMA_DBG_CSR_INFO_READ_BUS_ADD_ERR_MASK						0x1ull
#define WFR_SEND_DMA_DBG_CSR_INFO_READ_BUS_ADD_ERR_SMASK					0x1ull
/*
* Table #106 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgCsrData
* This CSR is used to log error information in the event of a CSR parity error. 
* This information is only captured when the corresponding error status bit 
* transitions from a 0 to a 1, if the error status bit was already set the 
* information in this CSR is not updated.
*/
#define WFR_SEND_DMA_DBG_CSR_DATA								(WFR_TXE + 0x000000380018)
#define WFR_SEND_DMA_DBG_CSR_DATA_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_CSR_DATA_DATA_SHIFT							0
#define WFR_SEND_DMA_DBG_CSR_DATA_DATA_MASK							0xFFFFFFFFFFFFFFFFull
#define WFR_SEND_DMA_DBG_CSR_DATA_DATA_SMASK							0xFFFFFFFFFFFFFFFFull
/*
* Table #107 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgReqTrkCor
* This CSR is used to log error information in the event of a PCIe request 
* tracking correctable error. This information is only captured when the 
* corresponding error status bit transitions from a 0 to a 1, if the error 
* status bit was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_REQ_TRK_COR								(WFR_TXE + 0x000000380020)
#define WFR_SEND_DMA_DBG_REQ_TRK_COR_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_REQ_TRK_COR_SYNDROME_SHIFT						8
#define WFR_SEND_DMA_DBG_REQ_TRK_COR_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_REQ_TRK_COR_SYNDROME_SMASK						0xFF00ull
#define WFR_SEND_DMA_DBG_REQ_TRK_COR_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_REQ_TRK_COR_ADDRESS_MASK						0xFFull
#define WFR_SEND_DMA_DBG_REQ_TRK_COR_ADDRESS_SMASK						0xFFull
/*
* Table #108 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgReqTrkUnc
* This CSR is used to log error information in the event of a PCIe request 
* tracking uncorrectable error. This information is only captured when the 
* corresponding error status bit transitions from a 0 to a 1, if the error 
* status bit was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC								(WFR_TXE + 0x000000380028)
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC_SYNDROME_SHIFT						8
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC_SYNDROME_SMASK						0xFF00ull
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC_ADDRESS_MASK						0xFFull
#define WFR_SEND_DMA_DBG_REQ_TRK_UNC_ADDRESS_SMASK						0xFFull
/*
* Table #109 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgWrongDw
* This CSR is used to log error information in the event of a wrong DW error. 
* This information is only captured when the corresponding error status bit for 
* any engine transitions from a 0 to a 1, if the error status bit for any engine 
* was already set the information in this CSR is not updated.
*/
#define WFR_SEND_DMA_DBG_WRONG_DW								(WFR_TXE + 0x000000380030)
#define WFR_SEND_DMA_DBG_WRONG_DW_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_WRONG_DW_DWS_RETURNED_SHIFT						32
#define WFR_SEND_DMA_DBG_WRONG_DW_DWS_RETURNED_MASK						0x3FFull
#define WFR_SEND_DMA_DBG_WRONG_DW_DWS_RETURNED_SMASK						0x3FF00000000ull
#define WFR_SEND_DMA_DBG_WRONG_DW_DWS_LEFT_SHIFT						16
#define WFR_SEND_DMA_DBG_WRONG_DW_DWS_LEFT_MASK							0x3FFull
#define WFR_SEND_DMA_DBG_WRONG_DW_DWS_LEFT_SMASK						0x3FF0000ull
#define WFR_SEND_DMA_DBG_WRONG_DW_TOO_FEW_DWS_SHIFT						1
#define WFR_SEND_DMA_DBG_WRONG_DW_TOO_FEW_DWS_MASK						0x1ull
#define WFR_SEND_DMA_DBG_WRONG_DW_TOO_FEW_DWS_SMASK						0x2ull
#define WFR_SEND_DMA_DBG_WRONG_DW_TOO_MANY_DWS_SHIFT						0
#define WFR_SEND_DMA_DBG_WRONG_DW_TOO_MANY_DWS_MASK						0x1ull
#define WFR_SEND_DMA_DBG_WRONG_DW_TOO_MANY_DWS_SMASK						0x1ull
/*
* Table #110 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgGenMismatch
* This CSR is used to log error information in the event of a generation 
* mismatch error. This information is only captured when the corresponding error 
* status bit for any engine transitions from a 0 to a 1, if the error status bit 
* for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_GEN_MISMATCH								(WFR_TXE + 0x000000380038)
#define WFR_SEND_DMA_DBG_GEN_MISMATCH_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_GEN_MISMATCH_LEN_GEN_GEN_SHIFT						2
#define WFR_SEND_DMA_DBG_GEN_MISMATCH_LEN_GEN_GEN_MASK						0x3ull
#define WFR_SEND_DMA_DBG_GEN_MISMATCH_LEN_GEN_GEN_SMASK						0xCull
#define WFR_SEND_DMA_DBG_GEN_MISMATCH_DESC_GEN_SHIFT						0
#define WFR_SEND_DMA_DBG_GEN_MISMATCH_DESC_GEN_MASK						0x3ull
#define WFR_SEND_DMA_DBG_GEN_MISMATCH_DESC_GEN_SMASK						0x3ull
/*
* Table #111 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgTooLong
* This CSR is used to log error information in the event of a too long error. 
* This information is only captured when the corresponding error status bit for 
* any engine transitions from a 0 to a 1, if the error status bit for any engine 
* was already set the information in this CSR is not updated.
*/
#define WFR_SEND_DMA_DBG_TOO_LONG								(WFR_TXE + 0x000000380040)
#define WFR_SEND_DMA_DBG_TOO_LONG_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_TOO_LONG_BYTES_CONFIGURED_SHIFT					38
#define WFR_SEND_DMA_DBG_TOO_LONG_BYTES_CONFIGURED_MASK						0x1FFFull
#define WFR_SEND_DMA_DBG_TOO_LONG_BYTES_CONFIGURED_SMASK					0x7FFC000000000ull
#define WFR_SEND_DMA_DBG_TOO_LONG_DESC_BYTES_SHIFT						16
#define WFR_SEND_DMA_DBG_TOO_LONG_DESC_BYTES_MASK						0x3FFFull
#define WFR_SEND_DMA_DBG_TOO_LONG_DESC_BYTES_SMASK						0x3FFF0000ull
#define WFR_SEND_DMA_DBG_TOO_LONG_ACCUMLATED_BYTES_SHIFT					0
#define WFR_SEND_DMA_DBG_TOO_LONG_ACCUMLATED_BYTES_MASK						0x3FFFull
#define WFR_SEND_DMA_DBG_TOO_LONG_ACCUMLATED_BYTES_SMASK					0x3FFFull
/*
* Table #112 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgTlBnds
* This CSR is used to log error information in the event of a tail out of bounds 
* error. This information is only captured when the corresponding error status 
* bit for any engine transitions from a 0 to a 1, if the error status bit for 
* any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_TL_BNDS								(WFR_TXE + 0x000000380048)
#define WFR_SEND_DMA_DBG_TL_BNDS_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_TL_BNDS_LENGTH_SHIFT							22
#define WFR_SEND_DMA_DBG_TL_BNDS_LENGTH_MASK							0x3FFull
#define WFR_SEND_DMA_DBG_TL_BNDS_LENGTH_SMASK							0xFFC00000ull
#define WFR_SEND_DMA_DBG_TL_BNDS_TAIL_SHIFT							0
#define WFR_SEND_DMA_DBG_TL_BNDS_TAIL_MASK							0xFFFFull
#define WFR_SEND_DMA_DBG_TL_BNDS_TAIL_SMASK							0xFFFFull
/*
* Table #113 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgFirstDesc
* This CSR is used to log error information in the event of a first descriptor 
* error. This information is only captured when the corresponding error status 
* bit for any engine transitions from a 0 to a 1, if the error status bit for 
* any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_FIRST_DESC								(WFR_TXE + 0x000000380050)
#define WFR_SEND_DMA_DBG_FIRST_DESC_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_FIRST_DESC_FIRST_DESC_CLEARED_SHIFT					1
#define WFR_SEND_DMA_DBG_FIRST_DESC_FIRST_DESC_CLEARED_MASK					0x1ull
#define WFR_SEND_DMA_DBG_FIRST_DESC_FIRST_DESC_CLEARED_SMASK					0x2ull
#define WFR_SEND_DMA_DBG_FIRST_DESC_FIRST_DESC_SET_SHIFT					0
#define WFR_SEND_DMA_DBG_FIRST_DESC_FIRST_DESC_SET_MASK						0x1ull
#define WFR_SEND_DMA_DBG_FIRST_DESC_FIRST_DESC_SET_SMASK					0x1ull
/*
* Table #114 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgMemRead
* This CSR is used to log error information in the event of a memory read error. 
* This information is only captured when the corresponding error status bit for 
* any engine transitions from a 0 to a 1, if the error status bit for any engine 
* was already set the information in this CSR is not updated.
*/
#define WFR_SEND_DMA_DBG_MEM_READ								(WFR_TXE + 0x000000380058)
#define WFR_SEND_DMA_DBG_MEM_READ_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_MEM_READ_DATA_SHIFT							32
#define WFR_SEND_DMA_DBG_MEM_READ_DATA_MASK							0xFFFFFFFFull
#define WFR_SEND_DMA_DBG_MEM_READ_DATA_SMASK							0xFFFFFFFF00000000ull
#define WFR_SEND_DMA_DBG_MEM_READ_PARITY_SHIFT							24
#define WFR_SEND_DMA_DBG_MEM_READ_PARITY_MASK							0xFFull
#define WFR_SEND_DMA_DBG_MEM_READ_PARITY_SMASK							0xFF000000ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_PARITY_MSK_SHIFT						16
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_PARITY_MSK_MASK						0xFFull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_PARITY_MSK_SMASK						0xFF0000ull
#define WFR_SEND_DMA_DBG_MEM_READ_STATUS_SHIFT							8
#define WFR_SEND_DMA_DBG_MEM_READ_STATUS_MASK							0x7ull
#define WFR_SEND_DMA_DBG_MEM_READ_STATUS_SMASK							0x700ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_ASH_PARITY_SHIFT						7
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_ASH_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_ASH_PARITY_SMASK						0x80ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_LAST_PARITY_SHIFT						6
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_LAST_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_LAST_PARITY_SMASK						0x40ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_FIRST_PARITY_SHIFT					5
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_FIRST_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_FIRST_PARITY_SMASK					0x20ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_SBH_PARITY_SHIFT						4
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_SBH_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_SBH_PARITY_SMASK						0x10ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_MF_PARITY_SHIFT						3
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_MF_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_MF_PARITY_SMASK						0x8ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_HDR_PARITY_SHIFT						2
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_HDR_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_HDR_PARITY_SMASK						0x4ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_RSP_PARITY_SHIFT						1
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_RSP_PARITY_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_RSP_PARITY_SMASK						0x2ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_STATUS_SHIFT						0
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_STATUS_MASK						0x1ull
#define WFR_SEND_DMA_DBG_MEM_READ_BAD_STATUS_SMASK						0x1ull
/*
* Table #115 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgLnthMsm
* This CSR is used to log error information in the event of a length mismatch 
* error. This information is only captured when the corresponding error status 
* bit for any engine transitions from a 0 to a 1, if the error status bit for 
* any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_LNTH_MSM								(WFR_TXE + 0x000000380060)
#define WFR_SEND_DMA_DBG_LNTH_MSM_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_LNTH_MSM_PBC_LENGTH_DWS_SHIFT						16
#define WFR_SEND_DMA_DBG_LNTH_MSM_PBC_LENGTH_DWS_MASK						0xFFFull
#define WFR_SEND_DMA_DBG_LNTH_MSM_PBC_LENGTH_DWS_SMASK						0xFFF0000ull
#define WFR_SEND_DMA_DBG_LNTH_MSM_BYTES_READ_SHIFT						0
#define WFR_SEND_DMA_DBG_LNTH_MSM_BYTES_READ_MASK						0x3FFFull
#define WFR_SEND_DMA_DBG_LNTH_MSM_BYTES_READ_SMASK						0x3FFFull
/*
* Table #116 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgHdrSlct
* This CSR is used to log error information in the event of a header select 
* error. This information is only captured when the corresponding error status 
* bit for any engine transitions from a 0 to a 1, if the error status bit for 
* any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_HDR_SLCT								(WFR_TXE + 0x000000380068)
#define WFR_SEND_DMA_DBG_HDR_SLCT_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_HDR_SLCT_HDR_IDX_SHIFT							32
#define WFR_SEND_DMA_DBG_HDR_SLCT_HDR_IDX_MASK							0x1Full
#define WFR_SEND_DMA_DBG_HDR_SLCT_HDR_IDX_SMASK							0x1F00000000ull
#define WFR_SEND_DMA_DBG_HDR_SLCT_HDR_VAL_MSK_SHIFT						0
#define WFR_SEND_DMA_DBG_HDR_SLCT_HDR_VAL_MSK_MASK						0xFFFFFFFFull
#define WFR_SEND_DMA_DBG_HDR_SLCT_HDR_VAL_MSK_SMASK						0xFFFFFFFFull
/*
* Table #117 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgHdrAdd
* This CSR is used to log error information in the event of a header address 
* error. This information is only captured when the corresponding error status 
* bit for any engine transitions from a 0 to a 1, if the error status bit for 
* any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_HDR_ADD								(WFR_TXE + 0x000000380070)
#define WFR_SEND_DMA_DBG_HDR_ADD_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_HDR_ADD_ADDR_SHIFT							0
#define WFR_SEND_DMA_DBG_HDR_ADD_ADDR_MASK							0x3Full
#define WFR_SEND_DMA_DBG_HDR_ADD_ADDR_SMASK							0x3Full
/*
* Table #118 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgHdrLngth
* This CSR is used to log error information in the event of a header length 
* error. This information is only captured when the corresponding error status 
* bit for any engine transitions from a 0 to a 1, if the error status bit for 
* any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_HDR_LNGTH								(WFR_TXE + 0x000000380078)
#define WFR_SEND_DMA_DBG_HDR_LNGTH_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_BYTE_CNT_SHIFT						16
#define WFR_SEND_DMA_DBG_HDR_LNGTH_BYTE_CNT_MASK						0x3FFFull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_BYTE_CNT_SMASK						0x3FFF0000ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_DWS_SHIFT						8
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_DWS_MASK							0xFull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_DWS_SMASK						0xF00ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_MODE_SHIFT						4
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_MODE_MASK						0x7ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_MODE_SMASK						0x70ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_UP_PREPEND_SHIFT						1
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_UP_PREPEND_MASK						0x1ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_UP_PREPEND_SMASK						0x2ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_FILL_SHIFT						0
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_FILL_MASK						0x1ull
#define WFR_SEND_DMA_DBG_HDR_LNGTH_HDR_FILL_SMASK						0x1ull
/*
* Table #119 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgTimeout
* This CSR is used to log error information in the event of a timeout error. 
* This information is only captured when the corresponding error status bit for 
* any engine transitions from a 0 to a 1, if the error status bit for any engine 
* was already set the information in this CSR is not updated.
*/
#define WFR_SEND_DMA_DBG_TIMEOUT								(WFR_TXE + 0x000000380080)
#define WFR_SEND_DMA_DBG_TIMEOUT_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_TIMEOUT_TAG_SHIFT							0
#define WFR_SEND_DMA_DBG_TIMEOUT_TAG_MASK							0xFFull
#define WFR_SEND_DMA_DBG_TIMEOUT_TAG_SMASK							0xFFull
/*
* Table #120 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgDescCor
* This CSR is used to log error information in the event of a descriptor table 
* correctable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_DESC_COR								(WFR_TXE + 0x000000380088)
#define WFR_SEND_DMA_DBG_DESC_COR_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_DESC_COR_RAM_SHIFT							24
#define WFR_SEND_DMA_DBG_DESC_COR_RAM_MASK							0x1ull
#define WFR_SEND_DMA_DBG_DESC_COR_RAM_SMASK							0x1000000ull
#define WFR_SEND_DMA_DBG_DESC_COR_SYNDROME_SHIFT						16
#define WFR_SEND_DMA_DBG_DESC_COR_SYNDROME_MASK							0xFFull
#define WFR_SEND_DMA_DBG_DESC_COR_SYNDROME_SMASK						0xFF0000ull
#define WFR_SEND_DMA_DBG_DESC_COR_WORD_SHIFT							12
#define WFR_SEND_DMA_DBG_DESC_COR_WORD_MASK							0x3ull
#define WFR_SEND_DMA_DBG_DESC_COR_WORD_SMASK							0x3000ull
#define WFR_SEND_DMA_DBG_DESC_COR_ADDRESS_SHIFT							0
#define WFR_SEND_DMA_DBG_DESC_COR_ADDRESS_MASK							0x1FFull
#define WFR_SEND_DMA_DBG_DESC_COR_ADDRESS_SMASK							0x1FFull
/*
* Table #121 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgDescUnc
* This CSR is used to log error information in the event of a descriptor table 
* uncorrectable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_DESC_UNC								(WFR_TXE + 0x000000380090)
#define WFR_SEND_DMA_DBG_DESC_UNC_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_DESC_UNC_RAM_SHIFT							24
#define WFR_SEND_DMA_DBG_DESC_UNC_RAM_MASK							0x1ull
#define WFR_SEND_DMA_DBG_DESC_UNC_RAM_SMASK							0x1000000ull
#define WFR_SEND_DMA_DBG_DESC_UNC_SYNDROME_SHIFT						16
#define WFR_SEND_DMA_DBG_DESC_UNC_SYNDROME_MASK							0xFFull
#define WFR_SEND_DMA_DBG_DESC_UNC_SYNDROME_SMASK						0xFF0000ull
#define WFR_SEND_DMA_DBG_DESC_UNC_WORD_SHIFT							12
#define WFR_SEND_DMA_DBG_DESC_UNC_WORD_MASK							0x3ull
#define WFR_SEND_DMA_DBG_DESC_UNC_WORD_SMASK							0x3000ull
#define WFR_SEND_DMA_DBG_DESC_UNC_ADDRESS_SHIFT							0
#define WFR_SEND_DMA_DBG_DESC_UNC_ADDRESS_MASK							0x1FFull
#define WFR_SEND_DMA_DBG_DESC_UNC_ADDRESS_SMASK							0x1FFull
/*
* Table #122 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgAssemCor
* This CSR is used to log error information in the event of a assembly space 
* correctable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_ASSEM_COR								(WFR_TXE + 0x000000380098)
#define WFR_SEND_DMA_DBG_ASSEM_COR_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_RAM_SHIFT						52
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_RAM_MASK						0xFFull
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_RAM_SMASK						0xFF0000000000000ull
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_RAM_SHIFT						40
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_RAM_MASK						0x1FFull
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_RAM_SMASK						0x1FF0000000000ull
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_SYNDROME_SHIFT						32
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_SYNDROME_SMASK						0xFF00000000ull
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_SYNDROME_SHIFT						24
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_SYNDROME_SMASK						0xFF000000ull
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_ADDRESS_SHIFT						12
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_ADDRESS_MASK						0x7Full
#define WFR_SEND_DMA_DBG_ASSEM_COR_LAST_ADDRESS_SMASK						0x7F000ull
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_ADDRESS_MASK						0x3FFull
#define WFR_SEND_DMA_DBG_ASSEM_COR_FIRST_ADDRESS_SMASK						0x3FFull
/*
* Table #123 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgAssemUnc
* This CSR is used to log error information in the event of a assembly space 
* uncorrectable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_ASSEM_UNC								(WFR_TXE + 0x0000003800A0)
#define WFR_SEND_DMA_DBG_ASSEM_UNC_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_RAM_SHIFT						52
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_RAM_MASK						0xFFull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_RAM_SMASK						0xFF0000000000000ull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_RAM_SHIFT						40
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_RAM_MASK						0x1FFull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_RAM_SMASK						0x1FF0000000000ull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_SYNDROME_SHIFT						32
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_SYNDROME_SMASK						0xFF00000000ull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_SYNDROME_SHIFT						24
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_SYNDROME_SMASK						0xFF000000ull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_ADDRESS_SHIFT						12
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_ADDRESS_MASK						0x7Full
#define WFR_SEND_DMA_DBG_ASSEM_UNC_LAST_ADDRESS_SMASK						0x7F000ull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_ADDRESS_MASK						0x3FFull
#define WFR_SEND_DMA_DBG_ASSEM_UNC_FIRST_ADDRESS_SMASK						0x3FFull
/*
* Table #124 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgPktTrkCor
* This CSR is used to log error information in the event of a packet tracking 
* correctable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_PKT_TRK_COR								(WFR_TXE + 0x0000003800A8)
#define WFR_SEND_DMA_DBG_PKT_TRK_COR_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_PKT_TRK_COR_SYNDROME_SHIFT						8
#define WFR_SEND_DMA_DBG_PKT_TRK_COR_SYNDROME_MASK						0x7Full
#define WFR_SEND_DMA_DBG_PKT_TRK_COR_SYNDROME_SMASK						0x7F00ull
#define WFR_SEND_DMA_DBG_PKT_TRK_COR_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_PKT_TRK_COR_ADDRESS_MASK						0x3Full
#define WFR_SEND_DMA_DBG_PKT_TRK_COR_ADDRESS_SMASK						0x3Full
/*
* Table #125 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgPktTrkUnc
* This CSR is used to log error information in the event of a packet tracking 
* uncorrectable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC								(WFR_TXE + 0x0000003800B0)
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC_SYNDROME_SHIFT						8
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC_SYNDROME_MASK						0x7Full
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC_SYNDROME_SMASK						0x7F00ull
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC_ADDRESS_MASK						0x3Full
#define WFR_SEND_DMA_DBG_PKT_TRK_UNC_ADDRESS_SMASK						0x3Full
/*
* Table #126 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgHdrStrgCor
* This CSR is used to log error information in the event of a header storage 
* correctable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_HDR_STRG_COR								(WFR_TXE + 0x0000003800B8)
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_SYNDROME_SHIFT						24
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_SYNDROME_SMASK						0xFF000000ull
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_WORD_SHIFT						16
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_WORD_MASK							0xFFull
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_WORD_SMASK						0xFF0000ull
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_ADDRESS_MASK						0x1FFull
#define WFR_SEND_DMA_DBG_HDR_STRG_COR_ADDRESS_SMASK						0x1FFull
/*
* Table #127 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgHdrStrgUnc
* This CSR is used to log error information in the event of a header storage 
* uncorrectable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC								(WFR_TXE + 0x0000003800C0)
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_SYNDROME_SHIFT						24
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_SYNDROME_MASK						0xFFull
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_SYNDROME_SMASK						0xFF000000ull
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_WORD_SHIFT						16
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_WORD_MASK							0xFFull
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_WORD_SMASK						0xFF0000ull
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_ADDRESS_SHIFT						0
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_ADDRESS_MASK						0x1FFull
#define WFR_SEND_DMA_DBG_HDR_STRG_UNC_ADDRESS_SMASK						0x1FFull
/*
* Table #128 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgHdrFifoCor
* This CSR is used to log error information in the event of a header FIFO 
* correctable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_HDR_FIFO_COR								(WFR_TXE + 0x0000003800C8)
#define WFR_SEND_DMA_DBG_HDR_FIFO_COR_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_HDR_FIFO_COR_SYNDROME_SHIFT						0
#define WFR_SEND_DMA_DBG_HDR_FIFO_COR_SYNDROME_MASK						0x7Full
#define WFR_SEND_DMA_DBG_HDR_FIFO_COR_SYNDROME_SMASK						0x7Full
/*
* Table #129 of 790_TXE_SDMA_Debug_Registers.xml - SendDmaDbgHdrFifoUnc
* This CSR is used to log error information in the event of a header FIFO 
* uncorrectable error. This information is only captured when the corresponding 
* error status bit for any engine transitions from a 0 to a 1, if the error 
* status bit for any engine was already set the information in this CSR is not 
* updated.
*/
#define WFR_SEND_DMA_DBG_HDR_FIFO_UNC								(WFR_TXE + 0x0000003800D0)
#define WFR_SEND_DMA_DBG_HDR_FIFO_UNC_RESETCSR							0x0000000000000000ull
#define WFR_SEND_DMA_DBG_HDR_FIFO_UNC_SYNDROME_SHIFT						0
#define WFR_SEND_DMA_DBG_HDR_FIFO_UNC_SYNDROME_MASK						0x7Full
#define WFR_SEND_DMA_DBG_HDR_FIFO_UNC_SYNDROME_SMASK						0x7Full
/*
* Table #132 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_DBG_PKT_RESET
* This CSR is used for monitoring current status of the released credits. The 
* released credits and sop is resetting the qw in the bqc memory. The credits 
* are reset using the part packets. Once the credits are reset, the credit data 
* is written to the vl length memory
*/
#define WFR_TXE_PIO_DBG_PKT_RESET								(WFR_TXE + 0x000000400000)
#define WFR_TXE_PIO_DBG_PKT_RESET_RESETCSR							0x0000000000000000ull
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_PART_PKT_LENGTH_SHIFT					15
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_PART_PKT_LENGTH_MASK					0x1Full
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_PART_PKT_LENGTH_SMASK					0xF8000ull
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_PART_PKT_SOP_SHIFT					1
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_PART_PKT_SOP_MASK						0x3FFFull
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_PART_PKT_SOP_SMASK					0x7FFEull
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_LAST_PART_PACKET_SHIFT					0
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_LAST_PART_PACKET_MASK					0x1ull
#define WFR_TXE_PIO_DBG_PKT_RESET_EWC_LAST_PART_PACKET_SMASK					0x1ull
/*
* Table #133 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_DBG_MON_CTXT
* This register is used for monitoring the 1 context out of 160 
* context.
*/
#define WFR_TXE_PIO_DBG_MON_CTXT								(WFR_TXE + 0x000000400008)
#define WFR_TXE_PIO_DBG_MON_CTXT_RESETCSR							0x0000000000000000ull
#define WFR_TXE_PIO_DBG_MON_CTXT_I_TXE_CFG_VISA_MON_CTXT_SHIFT					0
#define WFR_TXE_PIO_DBG_MON_CTXT_I_TXE_CFG_VISA_MON_CTXT_MASK					0xFFull
#define WFR_TXE_PIO_DBG_MON_CTXT_I_TXE_CFG_VISA_MON_CTXT_SMASK					0xFFull
/*
* Table #134 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_HCRAMEM_SBE_ADDR
* This register is used for monitoring the 1 context out of 160 
* context.
*/
#define WFR_TXE_PIO_HCRAMEM_SBE_ADDR								(WFR_TXE + 0x000000400010)
#define WFR_TXE_PIO_HCRAMEM_SBE_ADDR_RESETCSR							0x0000000000000000ull
#define WFR_TXE_PIO_HCRAMEM_SBE_ADDR_HCRA_SBE_ADDR_SHIFT					0
#define WFR_TXE_PIO_HCRAMEM_SBE_ADDR_HCRA_SBE_ADDR_MASK						0xFFull
#define WFR_TXE_PIO_HCRAMEM_SBE_ADDR_HCRA_SBE_ADDR_SMASK					0xFFull
/*
* Table #135 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_VLLENMEM_SBE_ADDR
* This register is used for monitoring the 1 context out of 160 
* context.
*/
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR								(WFR_TXE + 0x000000400018)
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR_RESETCSR							0x0000000000000000ull
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR_BANK1_VLMEM_SBE_ADDR_SHIFT				14
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR_BANK1_VLMEM_SBE_ADDR_MASK					0x3FFFull
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR_BANK1_VLMEM_SBE_ADDR_SMASK				0xFFFC000ull
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR_BANK0_VLMEM_SBE_ADDR_SHIFT				0
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR_BANK0_VLMEM_SBE_ADDR_MASK					0x3FFFull
#define WFR_TXE_PIO_VLLENMEM_SBE_ADDR_BANK0_VLMEM_SBE_ADDR_SMASK				0x3FFFull
/*
* Table #136 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_SCRATCHPAD
* This register is used for monitoring the 1 context out of 160 
* context.
*/
#define WFR_TXE_PIO_SCRATCHPAD									(WFR_TXE + 0x000000400020)
#define WFR_TXE_PIO_SCRATCHPAD_RESETCSR								0x0000000000000000ull
#define WFR_TXE_PIO_SCRATCHPAD_SCRATCHPAD_SHIFT							0
#define WFR_TXE_PIO_SCRATCHPAD_SCRATCHPAD_MASK							0xFFFFFFFFFFFFFFFFull
#define WFR_TXE_PIO_SCRATCHPAD_SCRATCHPAD_SMASK							0xFFFFFFFFFFFFFFFFull
/*
* Table #137 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_DBG_HEADS
* This CSR is used for monitoring various head sop
*/
#define WFR_TXE_PIO_DBG_HEADS									(WFR_TXE + 0x000000400800)
#define WFR_TXE_PIO_DBG_HEADS_RESETCSR								0x0000000000000000ull
#define WFR_TXE_PIO_DBG_HEADS_O_EVICT_HEAD_SOP_SHIFT						42
#define WFR_TXE_PIO_DBG_HEADS_O_EVICT_HEAD_SOP_MASK						0x3FFFull
#define WFR_TXE_PIO_DBG_HEADS_O_EVICT_HEAD_SOP_SMASK						0xFFFC0000000000ull
#define WFR_TXE_PIO_DBG_HEADS_O_LAUNCH_HEAD_SOP_SHIFT						28
#define WFR_TXE_PIO_DBG_HEADS_O_LAUNCH_HEAD_SOP_MASK						0x3FFFull
#define WFR_TXE_PIO_DBG_HEADS_O_LAUNCH_HEAD_SOP_SMASK						0x3FFF0000000ull
#define WFR_TXE_PIO_DBG_HEADS_O_MON_HEAD_SOP_SHIFT						14
#define WFR_TXE_PIO_DBG_HEADS_O_MON_HEAD_SOP_MASK						0x3FFFull
#define WFR_TXE_PIO_DBG_HEADS_O_MON_HEAD_SOP_SMASK						0xFFFC000ull
#define WFR_TXE_PIO_DBG_HEADS_O_VLFF_HEAD_SOP_SHIFT						0
#define WFR_TXE_PIO_DBG_HEADS_O_VLFF_HEAD_SOP_MASK						0x3FFFull
#define WFR_TXE_PIO_DBG_HEADS_O_VLFF_HEAD_SOP_SMASK						0x3FFFull
/*
* Table #138 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_DBG_PKT_MON_SM
* his CSR is used for Error status of various per context state machine and fifo 
* of the transmit engine. This are all address only, No flops required to be 
* implemented in the reg.
*/
#define WFR_TXE_PIO_DBG_PKT_MON_SM								(WFR_TXE + 0x000000401000)
#define WFR_TXE_PIO_DBG_PKT_MON_SM_RESETCSR							0x0000000000000000ull
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_PART_PKT_LENGTH_SHIFT				15
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_PART_PKT_LENGTH_MASK				0x1Full
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_PART_PKT_LENGTH_SMASK				0xF8000ull
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_PART_PKT_SOP_SHIFT					1
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_PART_PKT_SOP_MASK					0x3FFFull
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_PART_PKT_SOP_SMASK					0x7FFEull
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_LAST_PART_PACKET_SHIFT				0
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_LAST_PART_PACKET_MASK				0x1ull
#define WFR_TXE_PIO_DBG_PKT_MON_SM_CTXTC_MON_LAST_PART_PACKET_SMASK				0x1ull
/*
* Table #139 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_DBG_BQC_MEM
* his CSR is used for Error status of various per context state machine and fifo 
* of the transmit engine. This are all address only, No flops required to be 
* implemented in the reg.
*/
#define WFR_TXE_PIO_DBG_BQC_MEM									(WFR_TXE + 0x000000402000)
#define WFR_TXE_PIO_DBG_BQC_MEM_RESETCSR							0x0000000000000000ull
#define WFR_TXE_PIO_DBG_BQC_MEM_BLOCK_QW_COUNT_SHIFT						0
#define WFR_TXE_PIO_DBG_BQC_MEM_BLOCK_QW_COUNT_MASK						0xFFFFFFFFFFFFFFFFull
#define WFR_TXE_PIO_DBG_BQC_MEM_BLOCK_QW_COUNT_SMASK						0xFFFFFFFFFFFFFFFFull
/*
* Table #140 of 800_TXE_PIO_Debug_Registers.xml - TXE_PIO_DBG_VL_MEM
* This CSR is used for Error status of reading vl length memory 
* data.
*/
#define WFR_TXE_PIO_DBG_VL_MEM									(WFR_TXE + 0x000000420000)
#define WFR_TXE_PIO_DBG_VL_MEM_RESETCSR								0x0000000000000000ull
#define WFR_TXE_PIO_DBG_VL_MEM_EVICTION_FLAG_SHIFT						17
#define WFR_TXE_PIO_DBG_VL_MEM_EVICTION_FLAG_MASK						0x1ull
#define WFR_TXE_PIO_DBG_VL_MEM_EVICTION_FLAG_SMASK						0x20000ull
#define WFR_TXE_PIO_DBG_VL_MEM_PKT_VL_SHIFT							13
#define WFR_TXE_PIO_DBG_VL_MEM_PKT_VL_MASK							0xFull
#define WFR_TXE_PIO_DBG_VL_MEM_PKT_VL_SMASK							0x1E000ull
#define WFR_TXE_PIO_DBG_VL_MEM_PKT_LENGTH_SHIFT							1
#define WFR_TXE_PIO_DBG_VL_MEM_PKT_LENGTH_MASK							0xFFFull
#define WFR_TXE_PIO_DBG_VL_MEM_PKT_LENGTH_SMASK							0x1FFEull
#define WFR_TXE_PIO_DBG_VL_MEM_SOP_FLAG_SHIFT							0
#define WFR_TXE_PIO_DBG_VL_MEM_SOP_FLAG_MASK							0x1ull
#define WFR_TXE_PIO_DBG_VL_MEM_SOP_FLAG_SMASK							0x1ull
/*
* Table #143 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_0_MEM
* This CSR is used for reading the Launch FIFO for VL0.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM								(WFR_TXE + 0x00000048C000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_0_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #144 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_1_MEM
* This CSR is used for reading the Launch FIFO for VL1
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM								(WFR_TXE + 0x00000048D000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_1_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #145 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_2_MEM
* This CSR is used for reading the Launch FIFO for VL2.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM								(WFR_TXE + 0x00000048E000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_2_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #146 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_3_MEM
* This CSR is used for reading the Launch FIFO for VL3.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM								(WFR_TXE + 0x00000048F000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_3_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #147 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_4_MEM
* This CSR is used for reading the Launch FIFO for VL4.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM								(WFR_TXE + 0x000000490000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_4_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #148 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_5_MEM
* This CSR is used for reading the Launch FIFO for VL5.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM								(WFR_TXE + 0x000000491000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_5_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #149 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_6_MEM
* This CSR is used for reading the Launch FIFO for VL6.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM								(WFR_TXE + 0x000000492000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_6_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #150 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_7_MEM
* This CSR is used for reading the Launch FIFO for VL7.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM								(WFR_TXE + 0x000000493000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_REQUESTOR_SHIFT						15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_REQUESTOR_SMASK						0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_7_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #151 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_15_MEM
* This CSR is used for reading the Launch FIFO for VL15.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM							(WFR_TXE + 0x000000494000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_PACKET_LENGTH_SHIFT					23
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_PACKET_LENGTH_MASK					0xFFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_PACKET_LENGTH_SMASK					0x7FF800000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_REQUESTOR_SHIFT					15
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_REQUESTOR_MASK						0xFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_REQUESTOR_SMASK					0x7F8000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_START_PACKET_POINTER_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_START_PACKET_POINTER_MASK				0x7FFFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_MEM_START_PACKET_POINTER_SMASK				0x7FFFull
/*
* Table #152 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_STATUS
* This CSR is used for observing the status of the Launch FIFO for VL0 to 
* VL7.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS							(WFR_TXE + 0x000000495000)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_LASTREADADDRESS_SHIFT					14
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_LASTREADADDRESS_MASK					0x1FFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_LASTREADADDRESS_SMASK					0x7FC000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OUNDERFLOW_SHIFT					13
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OUNDERFLOW_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OUNDERFLOW_SMASK					0x2000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OOVERFLOW_SHIFT					12
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OOVERFLOW_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OOVERFLOW_SMASK					0x1000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OEMPTY_SHIFT					11
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OEMPTY_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIF_OEMPTY_SMASK					0x800ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIFO_FULL_SHIFT					10
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIFO_FULL_MASK						0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_FIFO_FULL_SMASK					0x400ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_LAUNCH_FIF_OOCCUPANCY_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_LAUNCH_FIF_OOCCUPANCY_MASK				0x3FFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_STATUS_LAUNCH_FIF_OOCCUPANCY_SMASK				0x3FFull
/*
* Table #153 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_LAFIFO_15_STATUS
* This CSR is used for observing the status of the Launch FIFO for 
* VL15.
*/
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS							(WFR_TXE + 0x000000495040)
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_LASTREADADDRESS_SHIFT				14
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_LASTREADADDRESS_MASK				0xFull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_LASTREADADDRESS_SMASK				0x3C000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OUNDERFLOW_SHIFT				13
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OUNDERFLOW_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OUNDERFLOW_SMASK				0x2000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OOVERFLOW_SHIFT					12
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OOVERFLOW_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OOVERFLOW_SMASK					0x1000ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OEMPTY_SHIFT					11
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OEMPTY_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIF_OEMPTY_SMASK					0x800ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIFO_FULL_SHIFT					10
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIFO_FULL_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_FIFO_FULL_SMASK					0x400ull
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_LAUNCH_FIF_OOCCUPANCY_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_LAUNCH_FIF_OOCCUPANCY_MASK				0x1Full
#define WFR_TXE_LAUNCH_DBG_LAFIFO_15_STATUS_LAUNCH_FIF_OOCCUPANCY_SMASK				0x1Full
/*
* Table #154 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_EGFIFO_STATUS
* This CSR is used for observing the status of the Egress FIFO.
*/
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS							(WFR_TXE + 0x000000496000)
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS_FIF_OUNDERFLOW_SHIFT					9
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS_FIF_OUNDERFLOW_MASK					0x1ull
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS_FIF_OUNDERFLOW_SMASK					0x200ull
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS_EGRESS_FIF_OOCCUPANCY_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS_EGRESS_FIF_OOCCUPANCY_MASK				0x1FFull
#define WFR_TXE_LAUNCH_DBG_EGFIFO_STATUS_EGRESS_FIF_OOCCUPANCY_SMASK				0x1FFull
/*
* Table #155 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_EGRESS_DCFIFO_OCCUPANCY
* This CSR is used for observing the status of the Egress FIFO.
*/
#define WFR_TXE_LAUNCH_DBG_EGRESS_DCFIFO_OCCUPANCY						(WFR_TXE + 0x000000496008)
#define WFR_TXE_LAUNCH_DBG_EGRESS_DCFIFO_OCCUPANCY_RESETCSR					0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_EGRESS_DCFIFO_OCCUPANCY_EGRESS_DCFIF_OOCCUPANCY_SHIFT		0
#define WFR_TXE_LAUNCH_DBG_EGRESS_DCFIFO_OCCUPANCY_EGRESS_DCFIF_OOCCUPANCY_MASK			0x1Full
#define WFR_TXE_LAUNCH_DBG_EGRESS_DCFIFO_OCCUPANCY_EGRESS_DCFIF_OOCCUPANCY_SMASK		0x1Full
/*
* Table #156 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_EGRESS_INTGCHK_ERR_ADDR
* This CSR is used for observing the status of the Address of the Tx 
* 
*/
#define WFR_TXE_LAUNCH_DBG_EGRESS_INTGCHK_ERR_ADDR						(WFR_TXE + 0x000000497000)
#define WFR_TXE_LAUNCH_DBG_EGRESS_INTGCHK_ERR_ADDR_RESETCSR					0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_EGRESS_INTGCHK_ERR_ADDR_INTEGRITY_CHECK_MEMORY_ERROR_ADDRESS_SHIFT	0
#define WFR_TXE_LAUNCH_DBG_EGRESS_INTGCHK_ERR_ADDR_INTEGRITY_CHECK_MEMORY_ERROR_ADDRESS_MASK	0x7FFull
#define WFR_TXE_LAUNCH_DBG_EGRESS_INTGCHK_ERR_ADDR_INTEGRITY_CHECK_MEMORY_ERROR_ADDRESS_SMASK	0x7FFull
/*
* Table #157 of 810_TXE_Launch_Debug_Registers.xml - TXE_LAUNCH_DBG_EGRESS_SCRATCHPAD
* This CSR is used for observing the status of the Address of the Tx 
* 
*/
#define WFR_TXE_LAUNCH_DBG_EGRESS_SCRATCHPAD							(WFR_TXE + 0x000000498000)
#define WFR_TXE_LAUNCH_DBG_EGRESS_SCRATCHPAD_RESETCSR						0x0000000000000000ull
#define WFR_TXE_LAUNCH_DBG_EGRESS_SCRATCHPAD_SCRATCH_PADBITS_SHIFT				0
#define WFR_TXE_LAUNCH_DBG_EGRESS_SCRATCHPAD_SCRATCH_PADBITS_MASK				0xFFFFFFFFFFFFFFFFull
#define WFR_TXE_LAUNCH_DBG_EGRESS_SCRATCHPAD_SCRATCH_PADBITS_SMASK				0xFFFFFFFFFFFFFFFFull
/*
* Table #160 of 820_TXE_Send_Buffer_Debug_Registers.xml - TXE_PIO_SEND_BUFFER
* This is read only memory for PIO Send Buffer..
*/
#define WFR_TXE_PIO_SEND_BUFFER									(WFR_TXE + 0x000000500000)
#define WFR_TXE_PIO_SEND_BUFFER_RESETCSR							0x0000000000000000ull
#define WFR_TXE_PIO_SEND_BUFFER_DATA_SHIFT							0
#define WFR_TXE_PIO_SEND_BUFFER_DATA_MASK							0xFFFFFFFFFFFFFFFFull
#define WFR_TXE_PIO_SEND_BUFFER_DATA_SMASK							0xFFFFFFFFFFFFFFFFull
/*
* Table #163 of 830_TXE_Debug_Registers.xml - SendDbgCsrInfo
* This CSR is used to log error information in the event of a CSR parity error. 
* This information is only captured when the corresponding error status bit 
* transitions from a 0 to a 1, if the error status bit was already set the 
* information in this CSR is not updated.
*/
#define WFR_SEND_DBG_CSR_INFO									(WFR_TXE + 0x0000004C0000)
#define WFR_SEND_DBG_CSR_INFO_RESETCSR								0x0000000000000000ull
#define WFR_SEND_DBG_CSR_INFO_DATA_PARITY_SHIFT							32
#define WFR_SEND_DBG_CSR_INFO_DATA_PARITY_MASK							0x3ull
#define WFR_SEND_DBG_CSR_INFO_DATA_PARITY_SMASK							0x300000000ull
#define WFR_SEND_DBG_CSR_INFO_ADDRESS_PARITY_SHIFT						30
#define WFR_SEND_DBG_CSR_INFO_ADDRESS_PARITY_MASK						0x1ull
#define WFR_SEND_DBG_CSR_INFO_ADDRESS_PARITY_SMASK						0x40000000ull
#define WFR_SEND_DBG_CSR_INFO_ADDRESS_SHIFT							4
#define WFR_SEND_DBG_CSR_INFO_ADDRESS_MASK							0x3FFFFFFull
#define WFR_SEND_DBG_CSR_INFO_ADDRESS_SMASK							0x3FFFFFF0ull
#define WFR_SEND_DBG_CSR_INFO_DATA_ERR_SHIFT							3
#define WFR_SEND_DBG_CSR_INFO_DATA_ERR_MASK							0x1ull
#define WFR_SEND_DBG_CSR_INFO_DATA_ERR_SMASK							0x8ull
#define WFR_SEND_DBG_CSR_INFO_WRITE_BUS_DATA_ERR_SHIFT						2
#define WFR_SEND_DBG_CSR_INFO_WRITE_BUS_DATA_ERR_MASK						0x1ull
#define WFR_SEND_DBG_CSR_INFO_WRITE_BUS_DATA_ERR_SMASK						0x4ull
#define WFR_SEND_DBG_CSR_INFO_WRITE_BUS_ADD_ERR_SHIFT						1
#define WFR_SEND_DBG_CSR_INFO_WRITE_BUS_ADD_ERR_MASK						0x1ull
#define WFR_SEND_DBG_CSR_INFO_WRITE_BUS_ADD_ERR_SMASK						0x2ull
#define WFR_SEND_DBG_CSR_INFO_READ_BUS_ADD_ERR_SHIFT						0
#define WFR_SEND_DBG_CSR_INFO_READ_BUS_ADD_ERR_MASK						0x1ull
#define WFR_SEND_DBG_CSR_INFO_READ_BUS_ADD_ERR_SMASK						0x1ull
/*
* Table #164 of 830_TXE_Debug_Registers.xml - SendDbgCsrData
* This CSR is used to log error information in the event of a CSR parity error. 
* This information is only captured when the corresponding error status bit 
* transitions from a 0 to a 1, if the error status bit was already set the 
* information in this CSR is not updated.
*/
#define WFR_SEND_DBG_CSR_DATA									(WFR_TXE + 0x0000004C0008)
#define WFR_SEND_DBG_CSR_DATA_RESETCSR								0x0000000000000000ull
#define WFR_SEND_DBG_CSR_DATA_DATA_SHIFT							0
#define WFR_SEND_DBG_CSR_DATA_DATA_MASK								0xFFFFFFFFFFFFFFFFull
#define WFR_SEND_DBG_CSR_DATA_DATA_SMASK							0xFFFFFFFFFFFFFFFFull
/*
* Table #165 of 830_TXE_Debug_Registers.xml - TxeDbgReadMiss
...
*/
#define WFR_TXE_DBG_READ_MISS									(WFR_TXE + 0x0000004C0010)
#define WFR_TXE_DBG_READ_MISS_RESETCSR								0x0000000000000000ull
#define WFR_TXE_DBG_READ_MISS_ADDRESS_SHIFT							0
#define WFR_TXE_DBG_READ_MISS_ADDRESS_MASK							0x3FFFFFFull
#define WFR_TXE_DBG_READ_MISS_ADDRESS_SMASK							0x3FFFFFFull
/*
* Table #166 of 830_TXE_Debug_Registers.xml - TxeDbgWriteMiss
* This CSR is used to log error information in the event of a TXE configuration 
* bus write miss error. This information is only captured when the corresponding 
* error status bit transitions from a 0 to a 1, if the error status bit was 
* already set the information in this CSR is not updated
*/
#define WFR_TXE_DBG_WRITE_MISS									(WFR_TXE + 0x0000004C0018)
#define WFR_TXE_DBG_WRITE_MISS_RESETCSR								0x0000000000000000ull
#define WFR_TXE_DBG_WRITE_MISS_ADDRESS_SHIFT							0
#define WFR_TXE_DBG_WRITE_MISS_ADDRESS_MASK							0x3FFFFFFull
#define WFR_TXE_DBG_WRITE_MISS_ADDRESS_SMASK							0x3FFFFFFull
