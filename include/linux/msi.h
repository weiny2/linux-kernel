...
#define first_platform_msi_group(dev)		\
	list_first_entry(dev_to_platform_msi_group_list((dev)), struct platform_msi_group_entry, group_list)
#define platform_msi_current_entry_list(dev)	\
	(&((list_last_entry(dev_to_platform_msi_group_list((dev)), struct platform_msi_group_entry, group_list))->entry_list))
#define first_msi_entry_current_group(dev)	\
	(((dev)->is_platform_msi) ? (list_first_entry(platform_msi_current_entry_list((dev)), struct msi_desc, list)) : (list_first_entry(dev_to_msi_list((dev)), struct msi_desc, list)))
#define first_msi_entry_current(dev)		\
	list_first_entry(platform_msi_current_entry_list((dev)), struct msi_desc, list)
#define for_each_msi_entry_current_group(desc, dev)	\
	for ((desc) = (((dev)->is_platform_msi) ? (first_msi_entry_current((dev))) : (first_msi_entry((dev))));						\
	     (((dev)->is_platform_msi) ? (&(desc)->list != platform_msi_current_entry_list((dev))) : (&(desc)->list != (dev_to_msi_list((dev)))));	\
	     ((desc) = list_next_entry((desc), list)))
...
#define for_each_platform_msi_entry_in_group_safe(desc, tmp, platform_msi_group, tmp_platform_msi_group, group, dev)			\
...
void msi_domain_free_irqs_group(struct irq_domain *domain, struct device *dev, unsigned int group);
