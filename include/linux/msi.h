...
#define first_platform_msi_groupi_entry(dev)	\
...
#define first_msi_entry_current_group(dev)     \
	(((dev)->is_platform_msi) ?			\
	(list_first_entry(platform_msi_current_group_entry_list((dev)), struct msi_desc, list)) :	\
	(list_first_entry(dev_to_msi_list((dev)), struct msi_desc, list)))
#define for_each_msi_entry_current_group(desc, dev)	\
	for ((desc) = (((dev)->is_platform_msi) ?	\
		(first_msi_entry_current_group((dev))) : (first_msi_entry((dev))));	\
	     (((dev)->is_platform_msi) ? (&(desc)->list != platform_msi_current_group_entry_list((dev))) :	\
