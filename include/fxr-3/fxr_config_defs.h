...
#define FXR_RX_CI_FAST						(FXR_TOP_MAP + 0x000001000000)
#define FXR_TX_CI						(FXR_TOP_MAP + 0x000004000000)
#define FXR_TX_OTR						(FXR_TOP_MAP + 0x000005000000)
#define FXR_TX_DMA						(FXR_TOP_MAP + 0x000006000000)
#define FXR_RX_CI						(FXR_TOP_MAP + 0x000008000000)
#define FXR_RX_HP						(FXR_TOP_MAP + 0x000008800000)
#define FXR_RX_E2E						(FXR_TOP_MAP + 0x000009000000)
#define FXR_RX_DMA						(FXR_TOP_MAP + 0x000009800000)
#define FXR_RX_HIARB					(FXR_TOP_MAP + 0x00000A000000)
#define FXR_HIFIS						(FXR_TOP_MAP + 0x00000C000000)
#define FXR_LOCA						(FXR_TOP_MAP + 0x00000C800000)
#define FXR_PCIM						(FXR_TOP_MAP + 0x00000D000000)
#define FXR_PMON						(FXR_TOP_MAP + 0x00000D400000)
#define FXR_SMA						(FXR_TOP_MAP + 0x00000D800000)
#define FXR_LM						(FXR_TOP_MAP + 0x00000DC00000)
#define FXR_FC						(FXR_TOP_MAP + 0x00000E000000)
#define FXR_MNH						(FXR_TOP_MAP + 0x00000E200000)
#define FXR_AT						(FXR_TOP_MAP + 0x000010000000)
#define FXR_VNIC_WRAP					(FXR_TOP_MAP + 0x000014000000)
#ifndef FXR_CONFIG
#define FXR_CONFIG						0x000000000000
#endif
