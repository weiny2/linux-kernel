...
union rx_k {
        struct {
                uint64_t        previous               : 16;        /* [15:0] Points to the previous list entru on the list */
                uint64_t        reserved_31_16         : 16;        /* [31:16] Reserved */
...
union PCB {
        struct {
        struct {
                uint64_t        portals_base           : 45;        /* [44:0] Base address of Portals state allocated for Portal Table Entries, Counting Events (CTs), Event Queue (EQ) descriptors, and Triggered Operation storage in application memory. */
                uint64_t        reserved_46_45         : 2;        /* [46:45] Unused */
                uint64_t        base_pa                : 1;        /* [47:47] Indicates whether the base address is a virtual address (0) or physical address (1). */
                uint64_t        reserved_62_48         : 15;        /* [62:48] Reserved */
                uint64_t        v                      : 1;        /* [63:63] Indicates whether the PCB entry is valid (1) or not (0). */
        };
        struct {
                uint64_t        le_me_base             : 45;        /* [108:64] Base address of an array allocated in host memory to hold LEs and MEs. */
                uint64_t        reserved_110_109       : 2;        /* [110:109] Unused */
                uint64_t        le_me_pa               : 1;        /* [111:111] Indicates whether the LE/ME base address is a virtual address (0) or physical address (1). */
                uint64_t        le_me_size             : 16;        /* [127:112] Indicates the size of the LE/ME region in number of entries */
        };
        struct {
                uint64_t        unex_base              : 45;        /* [172:128] Base address of an array allocated in host memory to hold Unexpected Headers. */
                uint64_t        reserved_174_173       : 2;        /* [174:173] Unused */
                uint64_t        unex_pa                : 1;        /* [175:175] Indicates whether the Unexpected Header base address is a virtual address (0) or physical address (1). */
                uint64_t        unex_size              : 16;        /* [191:176] Indicates the size of the Unexpected Header region in number of entries */
        };
        struct {
                uint64_t        unex_free_head         : 16;        /* [207:192] Head of the Unexpected Header free list for this process. */
                uint64_t        trig_op_size           : 16;        /* [223:208] Indicates the size of the Triggered Operation array in entries. */
                uint64_t        reserved_255_224       : 32;        /* [255:224] Unused */
        };
        } __attribute__ ((__packed__));
        uint64_t val[4];
};
...
union opb_pending_ack {
        ...
        struct {
                ...
                uint64_t        reserved_279_216       : 64;        /* [279:216] Reserved */
        };
        } __attribute__ ((__packed__));
        uint64_t val[5];
};
...
union rmessage_flit0 {
        struct {
                union                tx_cq_a1               a;        /* [63:0]  */
                union                tx_cq_b1_omb           b;        /* [127:64]  */
                union                tx_cq_c_omb            c;        /* [191:128]  */
                union                tx_cq_d                d;        /* [255:192]  */
        } __attribute__ ((__packed__));
        uint64_t val[4];
};
...
/*
* Structure from Table titled: Rendezvous Message Flit 1 Type: (Struct - rmessage_flit1_t) - 256 bits
*                  from File : 140_OutstandingRequest_and_Reliability.xml
*/
union rmessage_flit1 {
        struct {
                union                tx_cq_e1               e;        /* [63:0]  */
                union                tx_cq_f                f;        /* [127:64]  */
                                ptl_match_bits_t       mb;        /* [191:128]  */
                                ptl_hdr_data_t         hd;        /* [255:192]  */
        } __attribute__ ((__packed__));
        uint64_t val[4];
};

/*
* Structure from Table titled: Rendezvous Message Flit 2 Type: (Struct - rmessage_flit2_t) - 256 bits
*                  from File : 140_OutstandingRequest_and_Reliability.xml
*/
union rmessage_flit2 {
        struct {
                union                tx_cq_i                i;        /* [63:0]  */
                union                tx_cq_l                l;        /* [127:64]  */
        struct {
