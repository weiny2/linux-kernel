...
enum ptl_op_response {
                         ...
                         PTL_ACK_REFUSED = 1,           /* Portals ACK was refused by the target process. The stateful response is needed to convey to the initiator side implementation that a PTL_EVENT_ACK should not be delivered for this operation. This allows the initiator to free resources that might be reserved for the purpose. */
...
#define                  PTL_ACK_REFUSED   1            /* Portals ACK was refused by the target process. The stateful response is needed to convey to the initiator side implementation that a PTL_EVENT_ACK should not be delivered for this operation. This allows the initiator to free resources that might be reserved for the purpose. */
