...
// Creator:    pvesvslx                                                        
// Time:       Tuesday Sep 16, 2014 [12:29:57 am]                              
//                                                                             
...
//             /p/slx/pvesv/fxr_autogen/fxr fxr_tx_ci.rdl                      
//                                                                             
// Sources:    /tmp/pvesvslx/nebulon_run/28430/fxr_tx_ci.rdlh                  
//             /tmp/pvesvslx/nebulon_run/28430/lib_udp.rdl                     
//             /tmp/pvesvslx/nebulon_run/28430/fxr_tx_ci.rdl                   
...
typedef volatile union {
    struct {
        ...
        uint64_t  RETRANS_DISABLE      :   1;    //  Disables E2E protocol packet
                                                 // retransmission
        ...
        uint64_t  DLID_BASE            :  16;    //  DLID relocation table base
                                                 ...
                                                 // granularity. After shifting,
                                                 // it is added to the DLID
                                                 // specified in the command. The
                                                 // sum is used to index the DLID
                                                 // relocation table. Not used for
                                                 // Physical DLIDs.
...
typedef struct {
    ...
    TX_CQ_TAIL_t               TX_CQ_TAIL[256];  // offset 16'h4800, width 64
    TX_CQ_HEAD_UPDATE_CNTRL_t  TX_CQ_HEAD_UPDATE_CNTRL; // offset 16'h5000, width 64
    TX_SL0_TO_TC_t             TX_SL0_TO_TC;     // offset 16'h5008, width 64
    TX_SL1_TO_TC_t             TX_SL1_TO_TC;     // offset 16'h5010, width 64
    TX_SL2_TO_TC_t             TX_SL2_TO_TC;     // offset 16'h5018, width 64
    TX_SL3_TO_TC_t             TX_SL3_TO_TC;     // offset 16'h5020, width 64
    TX_SL4_TO_TC_t             TX_SL4_TO_TC;     // offset 16'h5028, width 64
    TX_SL5_TO_TC_t             TX_SL5_TO_TC;     // offset 16'h5030, width 64
    TX_SL6_TO_TC_t             TX_SL6_TO_TC;     // offset 16'h5038, width 64
    TX_SL7_TO_TC_t             TX_SL7_TO_TC;     // offset 16'h5040, width 64
    TX_CQ_DRAIN_t              TX_CQ_DRAIN;      // offset 16'h5048, width 64
    TX_CQ_RESET_t              TX_CQ_RESET;      // offset 16'h5050, width 64
    TX_CQ_TO_LIMIT_t           TX_CQ_TO_LIMIT;   // offset 16'h5058, width 64
    TX_DLID_GRANULARITY_t      TX_DLID_GRANULARITY; // offset 16'h5060, width 64
    TXCI_CQ_ERROR_GENERAL_t    TXCI_CQ_ERROR_GENERAL; // offset 16'h5068, width 64
    TXCI_CSR_MBE_t             TXCI_CSR_MBE;     // offset 16'h5070, width 64
    TXCI_CQ_ERROR_MBE_t        TXCI_CQ_ERROR_MBE; // offset 16'h5078, width 64
    TXCI_ST_ERROR_MBE_t        TXCI_ST_ERROR_MBE; // offset 16'h5080, width 64
    TXCI_DLID_ERROR_MBE_t      TXCI_DLID_ERROR_MBE; // offset 16'h5088, width 64
...
} fxr_tx_ci_csrs_t;                              // size:  24'h380000
