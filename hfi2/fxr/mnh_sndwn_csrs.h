...
// SNP_DWNSTRM_CFG_REINIT_PAUSE desc:
typedef union {
    struct {
        uint64_t              RX_MODE  :  2; // 0:no pause 1: reinit pause at 1 before align 2: reinit pause at 2 after lane test, before deskew, kill ready_for_deskew 3: reinit pause at 3 after deskew, kill 'framed' signal Clearing these should allow the reinit to proceed to completion or to the next pause location. After setting this register SNP_DWNSTRM_CFG_FORCE_RECOVER_SEQUENCE should be used to trigger the reinit.
        uint64_t           Unused_3_2  :  2; // Unused
        uint64_t              TX_MODE  :  1; // Use on gen2 HFI for OPIO re-center. Switch side of link must have CFG_REINIT_AS_SLAVE set. This will not activate until a neg edge of LTP mode occurs. After setting this register use SNP_DWNSTRM_CFG_FORCE_RECOVER_SEQUENCE to trigger the reinit. Poll STS_LINK_PAUSE_ACTIVE to make sure it is safe to start the OPIO re-center. After completion clearing this will release the pause. Link timer is still active so release must occur prior to expiration.
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_REINIT_PAUSE_t;

// SNP_DWNSTRM_CFG_REINIT_AS_SLAVE desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_REINIT_AS_SLAVE_t;

// SNP_DWNSTRM_CFG_FORCE_RECOVER_SEQUENCE desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_FORCE_RECOVER_SEQUENCE_t;
...
typedef union {
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_LOOPBACK_t;

// SNP_DWNSTRM_CFG_INCOMPLT_RND_TRIP_DISABLE desc:
typedef union {
    struct {
        uint64_t                  VAL  :  1; // 
        uint64_t          Unused_63_1  : 63; // Unused
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_INCOMPLT_RND_TRIP_DISABLE_t;

// SNP_DWNSTRM_CFG_RND_TRIP_MAX desc:
typedef union {
    struct {
        uint64_t                  VAL  : 16; // 
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_RND_TRIP_MAX_t;
...
// SNP_DWNSTRM_CFG_LN_DEGRADE desc:
typedef union {
    struct {
...
// SNP_DWNSTRM_CFG_LINK_KILL_EN desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_LINK_KILL_EN_t;

// SNP_DWNSTRM_CFG_ALLOW_LINK_UP desc:
typedef union {
    struct {
        uint64_t                  VAL  :  1; // 
        uint64_t          Unused_63_1  : 63; // Unused
    ...
    uint64_t val;
} SNP_DWNSTRM_CFG_ALLOW_LINK_UP_t;
...
// SNP_DWNSTRM_ERR_INFO_SBE_CNT desc:
typedef union {
    struct {
        uint64_t         INPUT_BUFFER  :  8; // Number of Single Bit Errors that have occurred in input buffer RAM. Does not roll. Cleared with SNP_DWNSTRM_DBG_ERRINJ_ECC_CLR_ECC_ERR_CNTS.
        uint64_t       REPLAY_BUFFER0  :  8; // Number of Single Bit Errors that have occurred in replay RAM0. Does not roll. Cleared with SNP_DWNSTRM_DBG_ERRINJ_ECC_CLR_ECC_ERR_CNTS
        uint64_t       REPLAY_BUFFER1  :  8; // Number of Single Bit Errors that have occurred in replay RAM1. Does not roll. Cleared with SNP_DWNSTRM_DBG_ERRINJ_ECC_CLR_ECC_ERR_CNTS
        uint64_t   REPLAY_BUFFER_SIDE  :  8; // Number of Single Bit Errors that have occurred in replay side data RAM. Does not roll. Cleared with SNP_DWNSTRM_DBG_ERRINJ_ECC_CLR_ECC_ERR_CNTS
        uint64_t         Unused_63_32  : 32; // Unused
    } field;
    uint64_t val;
} SNP_DWNSTRM_ERR_INFO_SBE_CNT_t;
...
// SNP_DWNSTRM_PRF_RX_FLIT_CNT desc:
typedef union {
    struct {
        uint64_t                  VAL  : 52; // 
        uint64_t         Unused_63_52  : 12; // Unused
    ...
    uint64_t val;
} SNP_DWNSTRM_PRF_RX_FLIT_CNT_t;

// SNP_DWNSTRM_PRF_CLK_CNTR desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_DWNSTRM_PRF_CLK_CNTR_t;

// SNP_DWNSTRM_STS_LINK_PAUSE_ACTIVE desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_DWNSTRM_STS_LINK_PAUSE_ACTIVE_t;

// SNP_DWNSTRM_STS_LINK_TRANSFER_ACTIVE desc:
typedef union {
    struct {
        uint64_t                  VAL  :  1; // 
        uint64_t          Unused_63_1  : 63; // Unused
    ...
    uint64_t val;
} SNP_DWNSTRM_STS_LINK_TRANSFER_ACTIVE_t;

// SNP_DWNSTRM_STS_LN_DEGRADE desc:
typedef union {
    struct {
    ...
    uint64_t val;
} SNP_DWNSTRM_STS_LN_DEGRADE_t;

// SNP_DWNSTRM_STS_TX_LTP_MODE desc:
typedef union {
    struct {
...
// SNP_DWNSTRM_STS_RX_CRC_MODE desc:
typedef union {
    struct {
        uint64_t                  VAL  :  2; // 
        uint64_t          Unused_63_2  : 62; // Unused
