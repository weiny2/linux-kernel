...
*  /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/i_csrs.pl -C -R -ST fxr_loca -o /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/fxr /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml/300_Memory_Map.xml /nfs/sc/disks/slx_0108/pvesv/fxr_autogen/repo_xml/342_Memory_Map_LOCA.xml
*------------------------------------------------------------------------------
*/
...
#define FXR_LOCA_CFG_PIPE2_RESETCSR				0x0000000000608100ull
...
#define FXR_LOCA_CFG_ITI_RESETCSR				0x0009003C0010000Full
...
/*
* Table #56 of fxr_top - LOCA_PMON_AR_LOWER
* Performance Monitor Address Range Lower control registers. These four 
* registers define the lower address range for the #%%#pm_addr_range0#%%# 
* through #%%#pm_addr_range3#%%# PMON counters. 
*/
...
/*
* Table #57 of fxr_top - LOCA_PMON_AR_UPPER
* Performance Monitor Address Range Upper control registers. These four 
* registers define the upper address ranges for the #%%#pm_addr_range0#%%# 
* through #%%#pm_addr_range3#%%# PMON counters. 
*/
...
/*
* Table #58 of fxr_top - LOCA_PMON_CFG
...
/*
* Table #59 of fxr_top - LOCA_PMON_CONTROL
...
/*
* Table #60 of fxr_top - LOCA_PMON_FREEZE_TIME
...
/*
* Table #61 of fxr_top - LOCA_PMON_ENABLE_TIME
* This is the local time at which the performance monitor counter array was 
...
/*
* Table #62 of fxr_top - LOCA_PMON_LOCAL_TIME
...
/*
* Table #63 of fxr_top - LOCA_PMON_INFO
...
#define FXR_LOCA_PMON_INFO_MAX_ITOMWR_LATENCY_SHIFT		40
#define FXR_LOCA_PMON_INFO_MAX_ITOMWR_LATENCY_MASK		0xFFFFFull
#define FXR_LOCA_PMON_INFO_MAX_ITOMWR_LATENCY_SMASK		0xFFFFF0000000000ull
...
/*
* Table #64 of fxr_top - LOCA_PMON_INFO1
* This INFO register records the maximum latency values measured from sampled 
* IDI transactions
*/
...
/*
* Table #65 of fxr_top - LOCA_PMON_INFO2
* This INFO register records the maximum latency values measured from sampled 
* IDI transactions
*/
...
/*
* Table #66 of fxr_top - LOCA_PMON_CNTR
...
/*
* Table #68 of fxr_top - LOCA_DBG_PCAM_ADDR
...
/*
* Table #69 of fxr_top - LOCA_DBG_PCAM_DATA
...
/*
* Table #70 of fxr_top - LOCA_DBG_MRU
...
/*
* Table #71 of fxr_top - LOCA_DBG_PROQ_FID_STATE
...
/*
* Table #72 of fxr_top - LOCA_DBG_PROQ_CMPLT
...
/*
* Table #73 of fxr_top - LOCA_DBG_PROQ_GLOBAL
...
/*
* Table #74 of fxr_top - LOCA_DBG_PROQ_CONQVAL
...
/*
* Table #75 of fxr_top - LOCA_DBG_IMI_ORB0
* Register access to the 256 IMI ORB entries. One CSR per entry. ORB State0 bits 
* are presented here. ORB State1 bits are described in #%%#Section 26.16.4.69, 
...
/*
* Table #76 of fxr_top - LOCA_DBG_IMI_ORB1
* Register access to the 256 IMI ORB entries. One CSR per entry. ORB State0 bits 
* are presented here. ORB State0 bits are described in #%%#Section 26.16.4.68, 
...
/*
* Table #77 of fxr_top - LOCA_DBG_IMI_ORBVAL
...
/*
* Table #78 of fxr_top - LOCA_DBG_IMI_ORBHOLD
...
/*
* Table #79 of fxr_top - LOCA_DBG_IMI_USB_GOVAL
...
/*
* Table #80 of fxr_top - LOCA_DBG_IMI_DPBVAL
...
/*
* Table #81 of fxr_top - LOCA_DBG_IMI_DRBVAL0
...
/*
* Table #82 of fxr_top - LOCA_DBG_IMI_DRBVAL1
...
/*
* Table #83 of fxr_top - LOCA_DBG_CONQ_TAILVAL
...
/*
* Table #84 of fxr_top - LOCA_DBG_CONQ_PSRRPLY
...
/*
* Table #85 of fxr_top - LOCA_DBG_CONQ_HEADER0
* Register access to the 256 ConQ Request Header0. One CSR per entry. Header0 
* bits are presented here. Header1 bits are described in #%%#Section 26.16.4.79, 
* 'ConQ Header1 Debug'
*/
...
/*
* Table #86 of fxr_top - LOCA_DBG_CONQ_HEADER1
* Register access to the 256 ConQ Request Header1. One CSR per entry. Header1 
* bits are presented here. Header0 bits are described in #%%#Section 26.16.4.78, 
* 'ConQ Header0 Debug' 
*/
...
/*
* Table #87 of fxr_top - LOCA_DBG_CONQ_LINKS
...
/*
* Table #88 of fxr_top - LOCA_DBG_DCD
...
/*
* Table #89 of fxr_top - LOCA_DBG_DCACHE
...
enum loca_perf_counter {
                  pm_wrifill_sbe = 126,         /* WriteFill Buffer SBE. */
                   pm_dcache_sbe = 125,         /* DataCache SBE. */
                pm_adm_sl_db_sbe = 124,         /* ADM ShortLoop Delay Buffer SBE. */
                pm_adm_re_db_sbe = 123,         /* ADM RE Delay Buffer SBE. */
               pm_adm_paf_db_sbe = 122,         /* ADM PAF Delay Buffer SBE. */
               pm_adm_hdr_db_sbe = 121,         /* ADM Header Delay Buffer SBE. . */
               pm_adm_cas_db_sbe = 120,         /* ADM Compare & Swap Delay Buffer SBE. */
                     pm_pcam_sbe = 119,         /* PCAM data SBE. */
                pm_mru_table_sbe = 118,         /* MRU Table SBE. */
              pm_imi_orb_sch_sbe = 117,         /* IDI Master ORB SCH SBE. */
              pm_imi_orb_rsp_sbe = 116,         /* IDI Master ORB RSP SBE. */
              pm_imi_orb_cnf_sbe = 115,         /* IDI Master ORB CNF SBE. */
                 pm_c2u_data_sbe = 114,         /* C2U DPB Data SBE. */
                   pm_c2u_wp_sbe = 113,         /* C2U DPB WritePull header SBE. */
                  pm_c2u_snp_sbe = 112,         /* C2U DPB Snoop header SBE. */
                  pm_c2u_nqb_sbe = 111,         /* C2U New Request (NQB) SBE. */
                  pm_c2u_eqb_sbe = 110,         /* C2U Eviction Request (EQB) SBE. */
                   pm_u2c_wp_sbe = 109,         /* U2C WritePull (USB) SBE. */
                  pm_u2c_dir_sbe = 108,         /* U2C L1DIR (detected in IMI) SBE. */
                  pm_u2c_poi_sbe = 107,         /* U2C Poison and ECC valid bit queue SBE. */
                 pm_u2c_data_sbe = 106,         /* U2C Data SBE. */
                   pm_iti_wp_sbe = 105,         /* IDI Target WP (UQB) SBE. */
                 pm_conq_hdr_sbe = 104,         /* ConQ header SBE. */
                  pm_proq_hl_sbe = 103,         /* PROQ hold queue SBE. */
                   pm_proq_f_sbe = 102,         /* PROQ Flow tail pointer queue SBE. */
                   pm_proq_g_sbe = 101,         /* PROQ global tail pointer queue SBE. */
                pm_hifis_hdr_sbe = 100,         /* HIFIS Header SBE. */
                pm_conq_tail_sbe = 99,          /* ConQ Tail pointer SBE. */
                 pm_dcd_bank_sbe = 98,          /* Data Cache Directory Bank SBE. */
                  pm_dcache_read = 97,          /* DCache reads. */
                 pm_dcache_write = 96,          /* DCache writes. */
                 pm_idi_u2c_data = 95,          /* IDI U2C Data Flit. */
                  pm_idi_u2c_rsp = 94,          /* IDI U2C Response Flit. */
                  pm_idi_u2c_req = 93,          /* IDI U2C Request Flit. */
                 pm_idi_c2u_data = 92,          /* IDI C2U Data Flit. */
                  pm_idi_c2u_rsp = 91,          /* IDI C2U Response Flit. */
                  pm_idi_c2u_req = 90,          /* IDI C2U Request Flit. */
           pm_no_c2u_req_credits = 89,          /* Clock cycles with No C2U Request Credits. */
          pm_no_c2u_data_credits = 88,          /* Clock cycles with No C2U Data Credits. */
           pm_no_c2u_rsp_credits = 87,          /* Clock cycles with No C2U Data Credits. */
                  pm_addr_range0 = 86,          /* Address Range 0 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
                  pm_addr_range1 = 85,          /* Address Range 1 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
                  pm_addr_range2 = 84,          /* Address Range 2 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
                  pm_addr_range3 = 83,          /* Address Range 3 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
...
#define           pm_wrifill_sbe   126          /* WriteFill Buffer SBE. */
#define            pm_dcache_sbe   125          /* DataCache SBE. */
#define         pm_adm_sl_db_sbe   124          /* ADM ShortLoop Delay Buffer SBE. */
#define         pm_adm_re_db_sbe   123          /* ADM RE Delay Buffer SBE. */
#define        pm_adm_paf_db_sbe   122          /* ADM PAF Delay Buffer SBE. */
#define        pm_adm_hdr_db_sbe   121          /* ADM Header Delay Buffer SBE. . */
#define        pm_adm_cas_db_sbe   120          /* ADM Compare & Swap Delay Buffer SBE. */
#define              pm_pcam_sbe   119          /* PCAM data SBE. */
#define         pm_mru_table_sbe   118          /* MRU Table SBE. */
#define       pm_imi_orb_sch_sbe   117          /* IDI Master ORB SCH SBE. */
#define       pm_imi_orb_rsp_sbe   116          /* IDI Master ORB RSP SBE. */
#define       pm_imi_orb_cnf_sbe   115          /* IDI Master ORB CNF SBE. */
#define          pm_c2u_data_sbe   114          /* C2U DPB Data SBE. */
#define            pm_c2u_wp_sbe   113          /* C2U DPB WritePull header SBE. */
#define           pm_c2u_snp_sbe   112          /* C2U DPB Snoop header SBE. */
#define           pm_c2u_nqb_sbe   111          /* C2U New Request (NQB) SBE. */
#define           pm_c2u_eqb_sbe   110          /* C2U Eviction Request (EQB) SBE. */
#define            pm_u2c_wp_sbe   109          /* U2C WritePull (USB) SBE. */
#define           pm_u2c_dir_sbe   108          /* U2C L1DIR (detected in IMI) SBE. */
#define           pm_u2c_poi_sbe   107          /* U2C Poison and ECC valid bit queue SBE. */
#define          pm_u2c_data_sbe   106          /* U2C Data SBE. */
#define            pm_iti_wp_sbe   105          /* IDI Target WP (UQB) SBE. */
#define          pm_conq_hdr_sbe   104          /* ConQ header SBE. */
#define           pm_proq_hl_sbe   103          /* PROQ hold queue SBE. */
#define            pm_proq_f_sbe   102          /* PROQ Flow tail pointer queue SBE. */
#define            pm_proq_g_sbe   101          /* PROQ global tail pointer queue SBE. */
#define         pm_hifis_hdr_sbe   100          /* HIFIS Header SBE. */
#define         pm_conq_tail_sbe   99           /* ConQ Tail pointer SBE. */
#define          pm_dcd_bank_sbe   98           /* Data Cache Directory Bank SBE. */
#define           pm_dcache_read   97           /* DCache reads. */
#define          pm_dcache_write   96           /* DCache writes. */
#define          pm_idi_u2c_data   95           /* IDI U2C Data Flit. */
#define           pm_idi_u2c_rsp   94           /* IDI U2C Response Flit. */
#define           pm_idi_u2c_req   93           /* IDI U2C Request Flit. */
#define          pm_idi_c2u_data   92           /* IDI C2U Data Flit. */
#define           pm_idi_c2u_rsp   91           /* IDI C2U Response Flit. */
#define           pm_idi_c2u_req   90           /* IDI C2U Request Flit. */
#define    pm_no_c2u_req_credits   89           /* Clock cycles with No C2U Request Credits. */
#define   pm_no_c2u_data_credits   88           /* Clock cycles with No C2U Data Credits. */
#define    pm_no_c2u_rsp_credits   87           /* Clock cycles with No C2U Data Credits. */
#define           pm_addr_range0   86           /* Address Range 0 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
#define           pm_addr_range1   85           /* Address Range 1 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
#define           pm_addr_range2   84           /* Address Range 2 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
#define           pm_addr_range3   83           /* Address Range 3 request count. Enabled by #%%#upper_addr_range#%%# and #%%#lower_addr_range#%%#. */
