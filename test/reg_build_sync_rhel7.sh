...
psm=/nfs/sc/disks/fabric_work/$USER/wfr/weekly-reg/wfr-psm7
diags=/nfs/sc/disks/fabric_work/$USER/wfr/weekly-reg/wfr-diagtools-sw7
...
rpmbuild --define 'require_kver 3.12.18-wfr+' -ta hfidiags-$diags_drop.tar.gz | tee .diags.noship
if [ $? -ne 0 ]; then
