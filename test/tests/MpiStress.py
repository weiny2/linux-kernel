...
def main():
    ...
    RegLib.test_log(0, "Test: MpiStress.py started")
    ...
    if arg_str == "":
        arg_str = "-L 1 -M 1 -w 2 -z"
    print "Mpi Stress arg string is ", arg_str
    ...
    RegLib.test_log(0, "Starting MPI Stress benchmark " + benchmark)
